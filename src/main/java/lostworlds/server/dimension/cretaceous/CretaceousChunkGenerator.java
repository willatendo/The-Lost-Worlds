...
public class CretaceousChunkGenerator extends NoiseBasedChunkGenerator {
	public static final Codec<CretaceousChunkGenerator> CODEC = RecordCodecBuilder.create((p_188643_) -> {
		...
		}))).apply(p_188643_, p_188643_.stable(CretaceousChunkGenerator::new));
	});

	public CretaceousChunkGenerator(Registry<StructureSet> structures, Registry<NormalNoise.NoiseParameters> noises, BiomeSource source, long seed, Holder<NoiseGeneratorSettings> settings) {
	...
	public ChunkGenerator withSeed(long seed) {
		return new CretaceousChunkGenerator(this.structureSets, this.noises, biomeSource.withSeed(WorldSeedHolder.getSeed()), WorldSeedHolder.getSeed(), this.settings);
	}
}

...
import lostworlds.server.trades.MultiItemForDifferentTrade;
...
public class CommonSetup {
	public static void fillTradeData() {
		...
		VillagerTrades.ItemListing[] archaeology3 = new VillagerTrades.ItemListing[] { new MultiItemForDifferentTrade(ImmutableList.of(LostWorldsItems.GOLD_BRUSH.get(), LostWorldsItems.IRON_BRUSH.get(), LostWorldsItems.LEATHER_BRUSH.get()), ImmutableList.of(1, 1, 1), ImmutableList.of(32, 16, 4), 1, 36) };
		...
		VillagerTrades.ItemListing[] paleontology4 = new VillagerTrades.ItemListing[] { new MultiItemForDifferentTrade(ImmutableList.of(LostWorldsItems.DIAMOND_BRUSH.get(), LostWorldsItems.GOLD_BRUSH.get(), LostWorldsItems.IRON_BRUSH.get(), LostWorldsItems.LEATHER_BRUSH.get()), ImmutableList.of(1, 1, 1, 1), ImmutableList.of(64, 32, 16, 4), 1, 26) };
		...
		VillagerTrades.ItemListing[] paleontology5 = new VillagerTrades.ItemListing[] { new VillagerTrades.ItemsForEmeralds(LostWorldsItems.CONTRACEPTIVES.get(), 12, 5, 20), new MultiItemForEmeraldsTrade(dnaForSale, 1, 1, 1, 200) };

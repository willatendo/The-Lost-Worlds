...
public class WoodList {
	...
	public WoodList register(String id, MaterialColor colour, MaterialColor logSideColour, WoodType type, ModBoatType boatType, ITag.INamedTag<Block> blockTags, INamedTag<Item> itemTags) {
		for (WoodTypes types : this.typesToMake) {
			...
			if (types == WoodTypes.WOOD) {
				BlockEntry<RotatedPillarBlock> wood = this.registrate.rotatedWoodBlock(id + "_" + types.toString().toLowerCase(), id + "_log", RotatedPillarBlock::new).properties(properties -> properties.of(Material.WOOD, colour).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)).tag(blockTags).recipe((block, provider) -> ShapedRecipeBuilder.shaped(block.get(), 3).group("bark").pattern("##").pattern("##").define('#', this.blocks.get(0).get().get()).unlockedBy("has_log", provider.hasItem(this.blocks.get(0).get().get())).save(provider)).register();
				this.blocks.add(() -> wood);
			}

			if (types == WoodTypes.STRIPPED_WOOD) {
				BlockEntry<RotatedPillarBlock> strippedWood = this.registrate.rotatedWoodBlock("stripped_" + id + "_wood", "stripped_" + id + "_log", RotatedPillarBlock::new).properties(properties -> properties.of(Material.WOOD, colour).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)).tag(blockTags).recipe((block, provider) -> ShapedRecipeBuilder.shaped(block.get(), 3).group("bark").pattern("##").pattern("##").define('#', this.blocks.get(1).get().get()).unlockedBy("has_log", provider.hasItem(this.blocks.get(1).get().get())).save(provider)).register();
			...
			if (types == WoodTypes.STAIRS) {
				BlockEntry<StairsBlock> stairs = this.registrate.stairBlock(id + "_" + types.toString().toLowerCase(), id + "_planks", properties -> new StairsBlock(() -> this.blocks.get(6).get().get().defaultBlockState(), properties)).properties(properties -> properties.of(Material.WOOD, colour).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)).tag(BlockTags.WOODEN_STAIRS).recipe((block, provider) -> provider.stairs(DataIngredient.items(this.blocks.get(6).get().get()), () -> block.get(), "wooden_stairs", false)).register();
				this.blocks.add(() -> stairs);
			}

			if (types == WoodTypes.SLAB) {
				BlockEntry<SlabBlock> slab = this.registrate.slabBlock(id + "_" + types.toString().toLowerCase(), id + "_planks", SlabBlock::new).properties(properties -> properties.of(Material.WOOD, colour).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)).tag(BlockTags.WOODEN_SLABS).recipe((block, provider) -> provider.slab(DataIngredient.items(this.blocks.get(6).get().get()), () -> block.get(), "wooden_slab", false)).register();
				this.blocks.add(() -> slab);
			}

			if (types == WoodTypes.FENCE) {
				BlockEntry<FenceBlock> fence = this.registrate.fenceBlock(id + "_" + types.toString().toLowerCase(), id + "_planks", FenceBlock::new).properties(properties -> properties.of(Material.WOOD, colour).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)).tag(BlockTags.WOODEN_FENCES).recipe((block, provider) -> provider.fence(DataIngredient.items(this.blocks.get(6).get().get()), () -> block.get(), "wooden_fence")).register();
				this.blocks.add(() -> fence);
			}

			if (types == WoodTypes.FENCE_GATE) {
				BlockEntry<FenceGateBlock> fence = this.registrate.fenceGateBlock(id + "_" + types.toString().toLowerCase(), id + "_planks", FenceGateBlock::new).properties(properties -> properties.of(Material.WOOD, colour).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)).tag(BlockTags.FENCE_GATES).recipe((block, provider) -> provider.fenceGate(DataIngredient.items(this.blocks.get(6).get().get()), () -> block.get(), "wooden_fence_gate")).register();
				this.blocks.add(() -> fence);
			}

			if (types == WoodTypes.PRESSURE_PLATE) {
				BlockEntry<PressurePlateBlock> pressurePlate = this.registrate.pressurePlateBlock(id + "_" + types.toString().toLowerCase(), id + "_planks", properties -> new PressurePlateBlock(Sensitivity.EVERYTHING, properties)).properties(properties -> properties.of(Material.WOOD, colour).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)).tag(BlockTags.WOODEN_PRESSURE_PLATES).recipe((block, provider) -> ShapedRecipeBuilder.shaped(block.get()).group("wooden_pressure_plate").pattern("##").define('#', this.blocks.get(6).get().get()).unlockedBy("has_planks", provider.hasItem(this.blocks.get(6).get().get())).save(provider)).register();
				this.blocks.add(() -> pressurePlate);
			}

			if (types == WoodTypes.BUTTON) {
				BlockEntry<WoodButtonBlock> button = this.registrate.buttonBlock(id + "_" + types.toString().toLowerCase(), id + "_planks", WoodButtonBlock::new).properties(properties -> properties.of(Material.WOOD, colour).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)).tag(BlockTags.WOODEN_BUTTONS).recipe((block, provider) -> ShapelessRecipeBuilder.shapeless(block.get()).group("wooden_button").requires(this.blocks.get(6).get().get()).unlockedBy("has_planks", provider.hasItem(this.blocks.get(6).get().get())).save(provider)).register();
				this.blocks.add(() -> button);
			}

			if (types == WoodTypes.TRAPDOOR) {
				BlockEntry<TrapDoorBlock> trapdoor = this.registrate.trapdoorBlock(id + "_" + types.toString().toLowerCase(), TrapDoorBlock::new).properties(properties -> properties.of(Material.WOOD, colour).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)).tag(BlockTags.WOODEN_TRAPDOORS).recipe((block, provider) -> provider.trapDoor(DataIngredient.items(this.blocks.get(6).get()), () -> block.get(), "wooden_trapdoor")).register();
			...
			if (types == WoodTypes.SIGN) {
				...
				this.registrate.item(id + "_" + types.toString().toLowerCase(), properties -> new SignItem(properties, standing.get(), wall.get())).properties((properties) -> properties.stacksTo(16)).recipe((item, provider) -> ShapedRecipeBuilder.shaped(item.get(), 3).group("sign").pattern("###").pattern("###").pattern(" $ ").define('#', this.blocks.get(6).get().get()).define('$', Items.STICK).unlockedBy("has_planks", provider.hasItem(this.blocks.get(6).get().get())).save(provider)).register();
				LostWorldsBlocks.registerSignBlock(() -> standing);
				LostWorldsBlocks.registerSignBlock(() -> wall);
			}

			if (types == WoodTypes.BOAT) {
				ItemEntry<ModBoatItem> boat = this.registrate.item(id + "_" + types.toString().toLowerCase(), properties -> new ModBoatItem(boatType, properties)).properties(properties -> properties.stacksTo(1)).recipe((item, provider) -> ShapedRecipeBuilder.shaped(item.get()).group("boat").pattern("# #").pattern("###").define('#', this.blocks.get(6).get().get()).unlockedBy("in_water", provider.enteredBlock(Blocks.WATER)).save(provider)).register();
				this.items.add(() -> boat);
			}
		}
		return this;
	...
	public Supplier<BlockEntry<? extends Block>> getBlock(int block) {

...
public class LargePlasteredFossilizedEggBlock extends Block {
	...
	public LargePlasteredFossilizedEggBlock(BlockBehaviour.Properties properties) {
		super(properties);
	...
	public InteractionResult use(BlockState state, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult result) {
		if (entity.isCrouching()) {
			world.setBlockAndUpdate(pos, LostWorldsBlocks.LARGE_FOSSILISED_EGG.getDefaultState().setValue(EGGS, state.getValue(EGGS)));

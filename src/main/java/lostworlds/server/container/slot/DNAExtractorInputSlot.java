...
public class DNAExtractorInputSlot extends Slot {
	...
	public boolean mayPlace(ItemStack stack) {
		return stack.getItem().is(LostWorldsTags.ModItemTags.SOFT_TISSUE) || stack.getItem() instanceof AmberItem || stack.getItem().is(LostWorldsTags.ModItemTags.BLOOD_VILES);
	}
}

...
public class PaleontologyTableRecipeBuilder {
	...
	public PaleontologyTableRecipeBuilder(IItemProvider output, int count) {
		this.result = output.asItem();
		this.count = count;
	}

	public static PaleontologyTableRecipeBuilder shaped(IItemProvider output) {
		return shaped(output, 1);
	}

	public static PaleontologyTableRecipeBuilder shaped(IItemProvider output, int count) {
		return new PaleontologyTableRecipeBuilder(output, count);
	}

	public PaleontologyTableRecipeBuilder define(Character character, ITag<Item> tag) {
		return this.define(character, Ingredient.of(tag));
	}

	public PaleontologyTableRecipeBuilder define(Character character, IItemProvider item) {
	...
	public PaleontologyTableRecipeBuilder unlockedBy(String has, ICriterionInstance criteria) {

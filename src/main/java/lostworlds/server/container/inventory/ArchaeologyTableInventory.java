...
public class ArchaeologyTableInventory implements Container, StackedContentsCompatible {
	private final NonNullList<ItemStack> items;
	private final int width;
	private final int height;
	private final AbstractContainerMenu menu;

	public ArchaeologyTableInventory(AbstractContainerMenu container, int width, int height) {

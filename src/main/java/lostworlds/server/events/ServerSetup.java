...
public class ServerSetup {
	...
	static class ModVillagerTrades {
		public static void fillTradeData() {
			...
			VillagerTrades.ITrade[] paleontology2 = new VillagerTrades.ITrade[] { new VillagerTrades.EmeraldForItemsTrade(LostWorldsBlocks.MEDIUM_PLASTERED_FOSSILISED_EGG.get(), 6, 4, 10), new VillagerTrades.ItemsForEmeraldsTrade(LostWorldsItems.FIELD_GUIDE.get(), 25, 1, 20), new VillagerTrades.ItemsForEmeraldsTrade(LostWorldsItems.WET_PAPER.get(), 3, 5, 12), new VillagerTrades.EmeraldForMapTrade(4, LostWorldsStructures.SURFACE_FOSSIL, MapDecoration.Type.RED_MARKER, 1, 42), new VillagerTrades.EmeraldForMapTrade(4, LostWorldsStructures.SUBTERRANEAN_FOSSIL, MapDecoration.Type.BANNER_RED, 1, 42) };
	...
	static class VanillaMaps {
		...
		public static void addToMaps(final FMLCommonSetupEvent event) {
			addToStrippingMap(LostWorldsBlocks.ARAUCARIA.getBlock(17).get(), LostWorldsBlocks.ARAUCARIA.getBlock(18).get());
			addToStrippingMap(LostWorldsBlocks.CALAMITES.getBlock(17).get(), LostWorldsBlocks.CALAMITES.getBlock(18).get());
			addToStrippingMap(LostWorldsBlocks.CONIFER.getBlock(17).get(), LostWorldsBlocks.CONIFER.getBlock(18).get());
			addToStrippingMap(LostWorldsBlocks.CYPRESS.getBlock(17).get(), LostWorldsBlocks.CYPRESS.getBlock(18).get());
			addToStrippingMap(LostWorldsBlocks.GINKGO.getBlock(17).get(), LostWorldsBlocks.GINKGO.getBlock(18).get());
			addToStrippingMap(LostWorldsBlocks.SEQUOIA.getBlock(17).get(), LostWorldsBlocks.SEQUOIA.getBlock(18).get());
			addToStrippingMap(LostWorldsBlocks.ARAUCARIA.getBlock(0).get(), LostWorldsBlocks.ARAUCARIA.getBlock(1).get());
			addToStrippingMap(LostWorldsBlocks.ARAUCARIA.getBlock(2).get(), LostWorldsBlocks.ARAUCARIA.getBlock(3).get());
			addToStrippingMap(LostWorldsBlocks.CALAMITES.getBlock(0).get(), LostWorldsBlocks.CALAMITES.getBlock(1).get());
			addToStrippingMap(LostWorldsBlocks.CALAMITES.getBlock(2).get(), LostWorldsBlocks.CALAMITES.getBlock(3).get());
			addToStrippingMap(LostWorldsBlocks.CONIFER.getBlock(0).get(), LostWorldsBlocks.CONIFER.getBlock(1).get());
			addToStrippingMap(LostWorldsBlocks.CONIFER.getBlock(2).get(), LostWorldsBlocks.CONIFER.getBlock(3).get());
			addToStrippingMap(LostWorldsBlocks.CYPRESS.getBlock(0).get(), LostWorldsBlocks.CYPRESS.getBlock(1).get());
			addToStrippingMap(LostWorldsBlocks.CYPRESS.getBlock(2).get(), LostWorldsBlocks.CYPRESS.getBlock(3).get());
			addToStrippingMap(LostWorldsBlocks.GINKGO.getBlock(0).get(), LostWorldsBlocks.GINKGO.getBlock(1).get());
			addToStrippingMap(LostWorldsBlocks.GINKGO.getBlock(2).get(), LostWorldsBlocks.GINKGO.getBlock(3).get());
			addToStrippingMap(LostWorldsBlocks.SCORCHED.getBlock(0).get(), LostWorldsBlocks.SCORCHED.getBlock(1).get());
			addToStrippingMap(LostWorldsBlocks.SCORCHED.getBlock(2).get(), LostWorldsBlocks.SCORCHED.getBlock(3).get());
			addToStrippingMap(LostWorldsBlocks.SEQUOIA.getBlock(0).get(), LostWorldsBlocks.SEQUOIA.getBlock(1).get());
			addToStrippingMap(LostWorldsBlocks.SEQUOIA.getBlock(2).get(), LostWorldsBlocks.CYPRESS.getBlock(3).get());
			addToTillingMap(LostWorldsBlocks.MOSSY_SOIL);
			addToFlatteningMap(LostWorldsBlocks.MOSSY_SOIL);
			addToFlammables(LostWorldsBlocks.ARAUCARIA.getBlock(9).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.ARAUCARIA.getBlock(10).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.ARAUCARIA.getBlock(5).get(), 30, 60);
			addToFlammables(LostWorldsBlocks.ARAUCARIA.getBlock(0).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.ARAUCARIA.getBlock(6).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.ARAUCARIA.getBlock(8).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.ARAUCARIA.getBlock(7).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.ARAUCARIA.getBlock(2).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.ARAUCARIA.getBlock(1).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.ARAUCARIA.getBlock(3).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.CALAMITES.getBlock(9).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CALAMITES.getBlock(10).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CALAMITES.getBlock(5).get(), 30, 60);
			addToFlammables(LostWorldsBlocks.CALAMITES.getBlock(0).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.CALAMITES.getBlock(6).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CALAMITES.getBlock(8).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CALAMITES.getBlock(7).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CALAMITES.getBlock(2).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.CALAMITES.getBlock(1).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.CALAMITES.getBlock(3).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.CONIFER.getBlock(9).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CONIFER.getBlock(10).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CONIFER.getBlock(5).get(), 30, 60);
			addToFlammables(LostWorldsBlocks.CONIFER.getBlock(0).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.CONIFER.getBlock(6).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CONIFER.getBlock(8).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CONIFER.getBlock(7).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CONIFER.getBlock(2).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.CONIFER.getBlock(1).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.CONIFER.getBlock(3).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.CYPRESS.getBlock(9).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CYPRESS.getBlock(10).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CYPRESS.getBlock(5).get(), 30, 60);
			addToFlammables(LostWorldsBlocks.CYPRESS.getBlock(0).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.CYPRESS.getBlock(6).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CYPRESS.getBlock(8).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CYPRESS.getBlock(7).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.CYPRESS.getBlock(2).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.CYPRESS.getBlock(1).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.CYPRESS.getBlock(3).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.GINKGO.getBlock(9).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.GINKGO.getBlock(10).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.GINKGO.getBlock(5).get(), 30, 60);
			addToFlammables(LostWorldsBlocks.GINKGO.getBlock(0).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.GINKGO.getBlock(6).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.GINKGO.getBlock(8).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.GINKGO.getBlock(7).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.GINKGO.getBlock(2).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.GINKGO.getBlock(1).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.GINKGO.getBlock(3).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.SCORCHED.getBlock(7).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.SCORCHED.getBlock(8).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.SCORCHED.getBlock(0).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.SCORCHED.getBlock(4).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.SCORCHED.getBlock(6).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.SCORCHED.getBlock(5).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.SCORCHED.getBlock(2).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.SCORCHED.getBlock(1).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.SCORCHED.getBlock(3).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.SEQUOIA.getBlock(9).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.SEQUOIA.getBlock(10).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.SEQUOIA.getBlock(5).get(), 30, 60);
			addToFlammables(LostWorldsBlocks.SEQUOIA.getBlock(0).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.SEQUOIA.getBlock(6).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.SEQUOIA.getBlock(8).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.SEQUOIA.getBlock(7).get(), 5, 20);
			addToFlammables(LostWorldsBlocks.SEQUOIA.getBlock(2).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.SEQUOIA.getBlock(1).get(), 5, 5);
			addToFlammables(LostWorldsBlocks.SEQUOIA.getBlock(3).get(), 5, 5);

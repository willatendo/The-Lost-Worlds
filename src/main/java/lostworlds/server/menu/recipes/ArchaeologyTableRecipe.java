...
public class ArchaeologyTableRecipe implements Recipe<ArchaeologyTableInventory>, IShapedRecipe<ArchaeologyTableInventory> {
	...
	@Override
	public boolean matches(ArchaeologyTableInventory inv, Level world) {
	...
	public boolean matches(ArchaeologyTableInventory inv, int width, int height, boolean b) {

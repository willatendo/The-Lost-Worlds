...
public class PlacedOreFeatures {
	...
	public static final RegistryObject<PlacedFeature> JURASSIC_COAL_ORE_UPPER = register("jurassic_coal_ore_upper", OreFeatures.JURASSIC_COAL_ORE, commonOrePlacement(30, HeightRangePlacement.uniform(VerticalAnchor.absolute(136), VerticalAnchor.top())));
	public static final RegistryObject<PlacedFeature> JURASSIC_COAL_ORE_LOWER = register("jurassic_coal_ore_lower", OreFeatures.JURASSIC_COAL_ORE_BURIED, commonOrePlacement(20, HeightRangePlacement.triangle(VerticalAnchor.absolute(0), VerticalAnchor.absolute(192))));
	public static final RegistryObject<PlacedFeature> JURASSIC_IRON_ORE_UPPER = register("jurassic_iron_ore_upper", OreFeatures.JURASSIC_IRON_ORE, commonOrePlacement(90, HeightRangePlacement.triangle(VerticalAnchor.absolute(80), VerticalAnchor.absolute(384))));
	public static final RegistryObject<PlacedFeature> JURASSIC_IRON_ORE_MIDDLE = register("jurassic_iron_ore_middle", OreFeatures.JURASSIC_IRON_ORE, commonOrePlacement(10, HeightRangePlacement.triangle(VerticalAnchor.absolute(-24), VerticalAnchor.absolute(56))));
	public static final RegistryObject<PlacedFeature> JURASSIC_IRON_ORE_SMALL = register("jurassic_iron_ore_small", OreFeatures.JURASSIC_IRON_ORE_SMALL, commonOrePlacement(10, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(72))));
	public static final RegistryObject<PlacedFeature> JURASSIC_GOLD_ORE_EXTRA = register("jurassic_gold_ore_extra", OreFeatures.JURASSIC_GOLD_ORE, commonOrePlacement(50, HeightRangePlacement.uniform(VerticalAnchor.absolute(32), VerticalAnchor.absolute(256))));
	public static final RegistryObject<PlacedFeature> JURASSIC_GOLD_ORE = register("jurassic_gold_ore", OreFeatures.JURASSIC_GOLD_ORE_BURIED, commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(32))));
	public static final RegistryObject<PlacedFeature> JURASSIC_GOLD_ORE_LOWER = register("jurassic_gold_ore_lower", OreFeatures.JURASSIC_GOLD_ORE_BURIED, orePlacement(CountPlacement.of(UniformInt.of(0, 1)), HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(-48))));
	public static final RegistryObject<PlacedFeature> JURASSIC_REDSTONE_ORE = register("jurassic_redstone_ore", OreFeatures.JURASSIC_REDSTONE_ORE, commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(15))));
	public static final RegistryObject<PlacedFeature> JURASSIC_REDSTONE_ORE_LOWER = register("jurassic_redstone_ore_lower", OreFeatures.JURASSIC_REDSTONE_ORE, commonOrePlacement(8, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-32), VerticalAnchor.aboveBottom(32))));
	public static final RegistryObject<PlacedFeature> JURASSIC_DIAMOND_ORE = register("jurassic_diamond_ore", OreFeatures.JURASSIC_DIAMOND_ORE_SMALL, commonOrePlacement(7, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
	public static final RegistryObject<PlacedFeature> JURASSIC_DIAMOND_ORE_LARGE = register("jurassic_diamond_ore_large", OreFeatures.JURASSIC_DIAMOND_ORE_LARGE, rareOrePlacement(9, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
	public static final RegistryObject<PlacedFeature> JURASSIC_DIAMOND_ORE_BURIED = register("jurassic_diamond_ore_buried", OreFeatures.JURASSIC_DIAMOND_ORE_BURIED, commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
	public static final RegistryObject<PlacedFeature> JURASSIC_LAPIS_ORE = register("jurassic_lapis_ore", OreFeatures.JURASSIC_LAPIS_ORE, commonOrePlacement(2, HeightRangePlacement.triangle(VerticalAnchor.absolute(-32), VerticalAnchor.absolute(32))));
	public static final RegistryObject<PlacedFeature> JURASSIC_LAPIS_ORE_BURIED = register("jurassic_lapis_ore_buried", OreFeatures.JURASSIC_LAPIS_ORE_BURIED, commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(64))));
	public static final RegistryObject<PlacedFeature> JURASSIC_EMERALD_ORE = register("jurassic_emerald_ore", OreFeatures.JURASSIC_EMERALD_ORE, commonOrePlacement(100, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(480))));
	public static final RegistryObject<PlacedFeature> JURASSIC_COPPER_ORE = register("jurassic_copper_ore", OreFeatures.JURASSIC_COPPER_ORE_SMALL, commonOrePlacement(16, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(112))));
	public static final RegistryObject<PlacedFeature> JURASSIC_COPPER_ORE_LARGE = register("jurassic_copper_ore_large", OreFeatures.JURASSIC_COPPER_ORE_LARGE, commonOrePlacement(16, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(112))));
	...
	public static final RegistryObject<PlacedFeature> CRETACEOUS_COAL_ORE_UPPER = register("cretaceous_coal_ore_upper", OreFeatures.CRETACEOUS_COAL_ORE, commonOrePlacement(30, HeightRangePlacement.uniform(VerticalAnchor.absolute(136), VerticalAnchor.top())));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_COAL_ORE_LOWER = register("cretaceous_coal_ore_lower", OreFeatures.CRETACEOUS_COAL_ORE_BURIED, commonOrePlacement(20, HeightRangePlacement.triangle(VerticalAnchor.absolute(0), VerticalAnchor.absolute(192))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_IRON_ORE_UPPER = register("cretaceous_iron_ore_upper", OreFeatures.CRETACEOUS_IRON_ORE, commonOrePlacement(90, HeightRangePlacement.triangle(VerticalAnchor.absolute(80), VerticalAnchor.absolute(384))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_IRON_ORE_MIDDLE = register("cretaceous_iron_ore_middle", OreFeatures.CRETACEOUS_IRON_ORE, commonOrePlacement(10, HeightRangePlacement.triangle(VerticalAnchor.absolute(-24), VerticalAnchor.absolute(56))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_IRON_ORE_SMALL = register("cretaceous_iron_ore_small", OreFeatures.CRETACEOUS_IRON_ORE_SMALL, commonOrePlacement(10, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(72))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_GOLD_ORE_EXTRA = register("cretaceous_gold_ore_extra", OreFeatures.CRETACEOUS_GOLD_ORE, commonOrePlacement(50, HeightRangePlacement.uniform(VerticalAnchor.absolute(32), VerticalAnchor.absolute(256))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_GOLD_ORE = register("cretaceous_gold_ore", OreFeatures.CRETACEOUS_GOLD_ORE_BURIED, commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(32))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_GOLD_ORE_LOWER = register("cretaceous_gold_ore_lower", OreFeatures.CRETACEOUS_GOLD_ORE_BURIED, orePlacement(CountPlacement.of(UniformInt.of(0, 1)), HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(-48))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_REDSTONE_ORE = register("cretaceous_redstone_ore", OreFeatures.CRETACEOUS_REDSTONE_ORE, commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(15))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_REDSTONE_ORE_LOWER = register("cretaceous_redstone_ore_lower", OreFeatures.CRETACEOUS_REDSTONE_ORE, commonOrePlacement(8, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-32), VerticalAnchor.aboveBottom(32))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_DIAMOND_ORE = register("cretaceous_diamond_ore", OreFeatures.CRETACEOUS_DIAMOND_ORE_SMALL, commonOrePlacement(7, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_DIAMOND_ORE_LARGE = register("cretaceous_diamond_ore_large", OreFeatures.CRETACEOUS_DIAMOND_ORE_LARGE, rareOrePlacement(9, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_DIAMOND_ORE_BURIED = register("cretaceous_diamond_ore_buried", OreFeatures.CRETACEOUS_DIAMOND_ORE_BURIED, commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_LAPIS_ORE = register("cretaceous_lapis_ore", OreFeatures.CRETACEOUS_LAPIS_ORE, commonOrePlacement(2, HeightRangePlacement.triangle(VerticalAnchor.absolute(-32), VerticalAnchor.absolute(32))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_LAPIS_ORE_BURIED = register("cretaceous_lapis_ore_buried", OreFeatures.CRETACEOUS_LAPIS_ORE_BURIED, commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(64))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_EMERALD_ORE = register("cretaceous_emerald_ore", OreFeatures.CRETACEOUS_EMERALD_ORE, commonOrePlacement(100, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(480))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_COPPER_ORE = register("cretaceous_copper_ore", OreFeatures.CRETACEOUS_COPPER_ORE_SMALL, commonOrePlacement(16, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(112))));
	public static final RegistryObject<PlacedFeature> CRETACEOUS_COPPER_ORE_LARGE = register("cretaceous_copper_ore_large", OreFeatures.CRETACEOUS_COPPER_ORE_LARGE, commonOrePlacement(16, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(112))));

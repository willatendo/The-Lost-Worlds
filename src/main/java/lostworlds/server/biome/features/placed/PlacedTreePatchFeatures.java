...
public class PlacedTreePatchFeatures {
	...
	public static final Holder<PlacedFeature> CONIFER_TREES = register("calamities_trees", TreePatchFeatures.CALAMITES_TREES, VegetationPlacements.treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
	public static final Holder<PlacedFeature> SCANT_CONIFER_TREES = register("scant_calamities_trees", TreePatchFeatures.CALAMITES_TREES, VegetationPlacements.treePlacement(PlacementUtils.countExtra(5, 0.1F, 1)));
	public static final Holder<PlacedFeature> SPARSE_CONIFER_TREES = register("sparse_calamities_trees", TreePatchFeatures.CALAMITES_TREES, VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));

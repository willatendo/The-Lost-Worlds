...
public class PlacedTreePatchFeatures {
	...
	public static final RegistryObject<PlacedFeature> SPARSE_BABY_SEQUOIA_TREES = register("sparse_baby_sequoia_trees", TreePatchFeatures.BABY_SEQUOIA_TREES, VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
	public static final RegistryObject<PlacedFeature> SPARSE_SEQUOIA_TREES = register("sparse_sequoia_trees", TreePatchFeatures.SEQUOIA_TREES, VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));

...
public class PlacedTreePatchFeatures {
	...
	public static final Holder<PlacedFeature> FULL_CALAMITES_TREES = register("full_calamites_trees", TreePatchFeatures.CALAMITES_TREES, VegetationPlacements.treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
	public static final Holder<PlacedFeature> FULL_CONIFER_TREES = register("full_conifer_trees", TreePatchFeatures.CONIFER_TREES, VegetationPlacements.treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
	...
	public static final Holder<PlacedFeature> FULL_GINKGO_TREES = register("full_ginkgo_trees", TreePatchFeatures.GINKGO_TREES, VegetationPlacements.treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
	...
	public static final Holder<PlacedFeature> FULL_ARAUCARIA_TREES = register("full_araucaria_trees", TreePatchFeatures.ARAUCARIA_TREES, VegetationPlacements.treePlacement(PlacementUtils.countExtra(15, 0.1F, 1)));

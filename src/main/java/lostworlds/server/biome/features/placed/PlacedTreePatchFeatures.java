...
public class PlacedTreePatchFeatures {
	...
	public static final Holder<PlacedFeature> ARAUCARIA_TREES = register("araucaria_trees", TreePatchFeatures.ARAUCARIA_TREES, VegetationPlacements.treePlacement(PlacementUtils.countExtra(15, 0.1F, 1)));

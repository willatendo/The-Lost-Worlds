...
public class TreeFeatures {
	...
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> CALAMITIES_TREE = register("calamties_tree", Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(LostWorldsBlocks.CALAMITES.getBlock(WoodTypes.LOG).get().get()), new StraightTrunkPlacer(15, 2, 1), BlockStateProvider.simple(LostWorldsBlocks.CALAMITES.getBlock(WoodTypes.LEAVES).get().get()), new SpruceFoliagePlacer(UniformInt.of(2, 1), UniformInt.of(0, 2), UniformInt.of(1, 1)), new TwoLayersFeatureSize(2, 0, 2))).ignoreVines().build());
	public static final Holder<ConfiguredFeature<RandomFeatureConfiguration, ?>> CALAMITIES_TREES = register("calamities_trees", Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(PlacedTreeFeatures.CALAMITIES_TREE, 0.33333334F)), PlacedTreeFeatures.CALAMITIES_TREE));

...
public class OreFeatures {
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> PETRIFIED_ARAUCARIA = register("petrified_araucaria", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.ARAUCARIA.getBlock(WoodTypes.PETRIFIED_LOG).get().getDefaultState(), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PETRIFIED_CALAMITES = register("petrified_calamties", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.CALAMITES.getBlock(WoodTypes.PETRIFIED_LOG).get().getDefaultState(), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PETRIFIED_CONIFER = register("petrified_conifer", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.CONIFER.getBlock(WoodTypes.PETRIFIED_LOG).get().getDefaultState(), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PETRIFIED_CYPRESS = register("petrified_cypress", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.CYPRESS.getBlock(WoodTypes.PETRIFIED_LOG).get().getDefaultState(), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PETRIFIED_GINKGO = register("petrified_ginkgo", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.GINKGO.getBlock(WoodTypes.PETRIFIED_LOG).get().getDefaultState(), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PETRIFIED_SEQUOIA = register("petrified_sequoia", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.SEQUOIA.getBlock(WoodTypes.PETRIFIED_LOG).get().getDefaultState(), 1));
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_AMBER_ORE = register("overworld_amber_ore", Feature.ORE, new OreConfiguration(AMBER_ORE_TARGET_LIST, LostWorldsConfig.COMMON_CONFIG.amberVeinSize.get(), 0.3F));

	public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_PLANT_FOSSIL_ALETHOPTERIS = register("overworld_plant_fossil_alethopteris", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.PLANT_FOSSIL.getDefaultState().setValue(PlantFossilBlock.ERA, TimeEras.MODERN_MINECRAFT).setValue(PlantFossilBlock.POTENTIAL_PLANT, Plants.ALETHOPTERIS).setValue(PlantFossilBlock.DAMAGE, Damage.NONE), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_PLANT_FOSSIL_BRAZILEA = register("overworld_plant_fossil_brazilea", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.PLANT_FOSSIL.getDefaultState().setValue(PlantFossilBlock.ERA, TimeEras.MODERN_MINECRAFT).setValue(PlantFossilBlock.POTENTIAL_PLANT, Plants.BRAZILEA).setValue(PlantFossilBlock.DAMAGE, Damage.NONE), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_PLANT_FOSSIL_CALAMITES_SUCKOWII = register("overworld_plant_fossil_calamites_suckowii", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.PLANT_FOSSIL.getDefaultState().setValue(PlantFossilBlock.ERA, TimeEras.MODERN_MINECRAFT).setValue(PlantFossilBlock.POTENTIAL_PLANT, Plants.CALAMITES_SUCKOWII).setValue(PlantFossilBlock.DAMAGE, Damage.NONE), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_PLANT_FOSSIL_CEPHALOTAXUS = register("overworld_plant_fossil_cephalotaxus", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.PLANT_FOSSIL.getDefaultState().setValue(PlantFossilBlock.ERA, TimeEras.MODERN_MINECRAFT).setValue(PlantFossilBlock.POTENTIAL_PLANT, Plants.CEPHALOTAXUS).setValue(PlantFossilBlock.DAMAGE, Damage.NONE), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_PLANT_FOSSIL_DILLHOFFIA = register("overworld_plant_fossil_dillhoffia", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.PLANT_FOSSIL.getDefaultState().setValue(PlantFossilBlock.ERA, TimeEras.MODERN_MINECRAFT).setValue(PlantFossilBlock.POTENTIAL_PLANT, Plants.DILLHOFFIA).setValue(PlantFossilBlock.DAMAGE, Damage.NONE), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_PLANT_FOSSIL_DUISBERGIA = register("overworld_plant_fossil_duisbergia", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.PLANT_FOSSIL.getDefaultState().setValue(PlantFossilBlock.ERA, TimeEras.MODERN_MINECRAFT).setValue(PlantFossilBlock.POTENTIAL_PLANT, Plants.DUISBERGIA).setValue(PlantFossilBlock.DAMAGE, Damage.NONE), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_PLANT_FOSSIL_OSMUNDA = register("overworld_plant_fossil_osmunda", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.PLANT_FOSSIL.getDefaultState().setValue(PlantFossilBlock.ERA, TimeEras.MODERN_MINECRAFT).setValue(PlantFossilBlock.POTENTIAL_PLANT, Plants.OSMUNDA).setValue(PlantFossilBlock.DAMAGE, Damage.NONE), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_PLANT_FOSSIL_WILLIAMSONIA = register("overworld_plant_fossil_williamsonia", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.PLANT_FOSSIL.getDefaultState().setValue(PlantFossilBlock.ERA, TimeEras.MODERN_MINECRAFT).setValue(PlantFossilBlock.POTENTIAL_PLANT, Plants.WILLIAMSONIA).setValue(PlantFossilBlock.DAMAGE, Damage.NONE), 1));;
	public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_PLANT_FOSSIL_ZAMITES = register("overworld_plant_fossil_zamites", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.PLANT_FOSSIL.getDefaultState().setValue(PlantFossilBlock.ERA, TimeEras.MODERN_MINECRAFT).setValue(PlantFossilBlock.POTENTIAL_PLANT, Plants.ZAMITES).setValue(PlantFossilBlock.DAMAGE, Damage.NONE), 1));

	public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_TINY_NEST = register("overworld_tiny_nest", Feature.ORE, new OreConfiguration(DIRT, LostWorldsBlocks.SOFT_DIRT.getDefaultState().setValue(SoftDirtBlock.EGG, Egg.TINY), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_SMALL_NEST = register("overworld_small_nest", Feature.ORE, new OreConfiguration(DIRT, LostWorldsBlocks.SOFT_DIRT.getDefaultState().setValue(SoftDirtBlock.EGG, Egg.SMALL), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_MEDIUM_NEST = register("overworld_medium_nest", Feature.ORE, new OreConfiguration(DIRT, LostWorldsBlocks.SOFT_DIRT.getDefaultState().setValue(SoftDirtBlock.EGG, Egg.MEDIUM), 1));
	public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_LARGE_NEST = register("overworld_large_nest", Feature.ORE, new OreConfiguration(DIRT, LostWorldsBlocks.SOFT_DIRT.getDefaultState().setValue(SoftDirtBlock.EGG, Egg.LARGE), 1));

	// Permian
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_MAGMA_ORE = register("permian_magma_ore", Feature.ORE, new OreConfiguration(PERMIAN_STONE, Blocks.MAGMA_BLOCK.defaultBlockState(), 33));
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_COAL_ORE = register("permian_coal_ore", Feature.ORE, new OreConfiguration(PERMIAN_COAL_ORE_TARGET_LIST, 17));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_COAL_ORE_BURIED = register("permian_coal_ore_buried", Feature.ORE, new OreConfiguration(PERMIAN_COAL_ORE_TARGET_LIST, 17, 0.5F));
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_IRON_ORE = register("permian_iron_ore", Feature.ORE, new OreConfiguration(PERMIAN_IRON_ORE_TARGET_LIST, 9));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_IRON_ORE_SMALL = register("permian_iron_ore_small", Feature.ORE, new OreConfiguration(PERMIAN_IRON_ORE_TARGET_LIST, 4));
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_GOLD_ORE = register("permian_gold_ore", Feature.ORE, new OreConfiguration(PERMIAN_GOLD_ORE_TARGET_LIST, 9));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_GOLD_ORE_BURIED = register("permian_gold_ore_buried", Feature.ORE, new OreConfiguration(PERMIAN_GOLD_ORE_TARGET_LIST, 9, 0.5F));
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_REDSTONE_ORE = register("permian_redstone_ore", Feature.ORE, new OreConfiguration(PERMIAN_REDSTONE_ORE_TARGET_LIST, 8));
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_DIAMOND_ORE_SMALL = register("permian_diamond_ore_small", Feature.ORE, new OreConfiguration(PERMIAN_DIAMOND_ORE_TARGET_LIST, 4, 0.5F));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_DIAMOND_ORE_LARGE = register("permian_diamond_ore_large", Feature.ORE, new OreConfiguration(PERMIAN_DIAMOND_ORE_TARGET_LIST, 12, 0.7F));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_DIAMOND_ORE_BURIED = register("permian_diamond_ore_buried", Feature.ORE, new OreConfiguration(PERMIAN_DIAMOND_ORE_TARGET_LIST, 8, 1.0F));
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_LAPIS_ORE = register("permian_lapis_ore", Feature.ORE, new OreConfiguration(PERMIAN_LAPIS_ORE_TARGET_LIST, 7));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_LAPIS_ORE_BURIED = register("permian_lapis_ore_buried", Feature.ORE, new OreConfiguration(PERMIAN_LAPIS_ORE_TARGET_LIST, 7, 1.0F));
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_EMERALD_ORE = register("permian_emerald_ore", Feature.ORE, new OreConfiguration(PERMIAN_EMERALD_ORE_TARGET_LIST, 3));
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_COPPER_ORE_SMALL = register("permian_copper_ore_small", Feature.ORE, new OreConfiguration(PERMIAN_COPPER_ORE_TARGET_LIST, 10));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_COPPER_ORE_LARGE = register("permian_copper_ore_large", Feature.ORE, new OreConfiguration(PERMIAN_COPPER_ORE_TARGET_LIST, 20));

	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_DIRT_ORE = register("permian_dirt_ore", Feature.ORE, new OreConfiguration(PERMIAN_STONE, Blocks.DIRT.defaultBlockState(), 33));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_GRAVEL_ORE = register("permian_gravel_ore", Feature.ORE, new OreConfiguration(PERMIAN_STONE, Blocks.GRAVEL.defaultBlockState(), 33));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_LATERLITE_ORE = register("permian_laterlite_ore", Feature.ORE, new OreConfiguration(PERMIAN_STONE, LostWorldsBlocks.LATERLITE.getDefaultState(), 33));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_RAW_MARBLE_ORE = register("permian_raw_marble_ore", Feature.ORE, new OreConfiguration(PERMIAN_STONE, LostWorldsBlocks.RAW_MARBLE.getDefaultState(), 33));
	public static final RegistryObject<ConfiguredFeature<?, ?>> PERMIAN_LIMESTONE_ORE = register("permian_limestone_ore", Feature.ORE, new OreConfiguration(PERMIAN_STONE, LostWorldsBlocks.LIMESTONE.getDefaultState(), 33));
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> JURASSIC_LATERLITE_ORE = register("jurassic_laterlite_ore", Feature.ORE, new OreConfiguration(JURASSIC_STONE, LostWorldsBlocks.LATERLITE.getDefaultState(), 33));
	public static final RegistryObject<ConfiguredFeature<?, ?>> JURASSIC_RAW_MARBLE_ORE = register("jurassic_raw_marble_ore", Feature.ORE, new OreConfiguration(JURASSIC_STONE, LostWorldsBlocks.RAW_MARBLE.getDefaultState(), 33));
	public static final RegistryObject<ConfiguredFeature<?, ?>> JURASSIC_LIMESTONE_ORE = register("jurassic_limestone_ore", Feature.ORE, new OreConfiguration(JURASSIC_STONE, LostWorldsBlocks.LIMESTONE.getDefaultState(), 33));
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> CRETACEOUS_LATERLITE_ORE = register("cretaceous_laterlite_ore", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.LATERLITE.getDefaultState(), 33));
	public static final RegistryObject<ConfiguredFeature<?, ?>> CRETACEOUS_RAW_MARBLE_ORE = register("cretaceous_raw_marble_ore", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.RAW_MARBLE.getDefaultState(), 33));
	public static final RegistryObject<ConfiguredFeature<?, ?>> CRETACEOUS_LIMESTONE_ORE = register("cretaceous_limestone_ore", Feature.ORE, new OreConfiguration(STONE, LostWorldsBlocks.LIMESTONE.getDefaultState(), 33));

	// Mixed Era
	public static final RegistryObject<ConfiguredFeature<?, ?>> BASALT_DIAMOND_ORE = register("basalt_diamond_ore", Feature.ORE, new OreConfiguration(BASALT, LostWorldsBlocks.BASALT_DIAMOND_ORE.getDefaultState(), 10));

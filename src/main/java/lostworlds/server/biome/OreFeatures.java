...
public class OreFeatures {
	...
	public static final Supplier<ConfiguredFeature<?, ?>> PERMIAN_COAL_ORE = () -> register("permian_coal_ore", Feature.ORE.configured(new OreFeatureConfig(ModBlockFillerTypes.PERMIAN_STONE.get(), LostWorldsBlocks.PERMIAN_COAL_ORE.defaultBlockState(), 17)).range(128).squared().count(20));
	public static final Supplier<ConfiguredFeature<?, ?>> PERMIAN_IRON_ORE = () -> register("permian_iron_ore", Feature.ORE.configured(new OreFeatureConfig(ModBlockFillerTypes.PERMIAN_STONE.get(), LostWorldsBlocks.PERMIAN_IRON_ORE.defaultBlockState(), 9)).range(64).squared().count(20));
	public static final Supplier<ConfiguredFeature<?, ?>> PERMIAN_GOLD_ORE = () -> register("permian_gold_ore", Feature.ORE.configured(new OreFeatureConfig(ModBlockFillerTypes.PERMIAN_STONE.get(), LostWorldsBlocks.PERMIAN_GOLD_ORE.defaultBlockState(), 9)).range(32).squared().count(2));
	public static final Supplier<ConfiguredFeature<?, ?>> PERMIAN_REDSTONE_ORE = () -> register("permian_redstone_ore", Feature.ORE.configured(new OreFeatureConfig(ModBlockFillerTypes.PERMIAN_STONE.get(), LostWorldsBlocks.PERMIAN_REDSTONE_ORE.defaultBlockState(), 8)).range(16).squared().count(8));
	public static final Supplier<ConfiguredFeature<?, ?>> PERMIAN_DIAMOND_ORE = () -> register("permian_diamond_ore", Feature.ORE.configured(new OreFeatureConfig(ModBlockFillerTypes.PERMIAN_STONE.get(), LostWorldsBlocks.PERMIAN_DIAMOND_ORE.defaultBlockState(), 8)).range(16).squared());
	public static final Supplier<ConfiguredFeature<?, ?>> PERMIAN_LAPIS_ORE = () -> register("permian_lapis_ore", Feature.ORE.configured(new OreFeatureConfig(ModBlockFillerTypes.PERMIAN_STONE.get(), LostWorldsBlocks.PERMIAN_LAPIS_ORE.defaultBlockState(), 7)).decorated(Placement.DEPTH_AVERAGE.configured(new DepthAverageConfig(16, 16))).squared());
	public static final Supplier<ConfiguredFeature<?, ?>> PERMIAN_EMERALD_ORE = () -> register("permian_emerald_ore", Feature.EMERALD_ORE.configured(new ReplaceBlockConfig(LostWorldsBlocks.PERMIAN_STONE.getDefaultState(), LostWorldsBlocks.PERMIAN_EMERALD_ORE.defaultBlockState())).decorated(Placement.EMERALD_ORE.configured(IPlacementConfig.NONE)));
	public static final Supplier<ConfiguredFeature<?, ?>> PERMIAN_COPPER_ORE = () -> register("permian_copper_ore", Feature.ORE.configured(new OreFeatureConfig(ModBlockFillerTypes.PERMIAN_STONE.get(), LostWorldsBlocks.PERMIAN_COPPER_ORE.defaultBlockState(), LostWorldsConfig.SERVER_CONFIG.copperVeinSize.get())).range(LostWorldsConfig.SERVER_CONFIG.copperRange.get()).squared().count(LostWorldsConfig.SERVER_CONFIG.copperCountPerChunk.get()));

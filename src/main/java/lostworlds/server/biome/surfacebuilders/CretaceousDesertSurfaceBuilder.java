...
public class CretaceousDesertSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
	public CretaceousDesertSurfaceBuilder(Codec<SurfaceBuilderConfig> codec) {
		super(codec);
	}

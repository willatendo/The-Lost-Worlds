...
public class CretaceousRedDesertSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
	public CretaceousRedDesertSurfaceBuilder(Codec<SurfaceBuilderConfig> codec) {
		super(codec);
	}

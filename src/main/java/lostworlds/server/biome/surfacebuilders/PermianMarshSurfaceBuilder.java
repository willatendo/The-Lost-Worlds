...
public class PermianMarshSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderBaseConfiguration> {
	public PermianMarshSurfaceBuilder(Codec<SurfaceBuilderBaseConfiguration> codec) {
		super(codec);
	}

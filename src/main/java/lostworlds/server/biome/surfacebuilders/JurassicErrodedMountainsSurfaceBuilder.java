...
public class JurassicErrodedMountainsSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderBaseConfiguration> {
	public JurassicErrodedMountainsSurfaceBuilder(Codec<SurfaceBuilderBaseConfiguration> codec) {
		super(codec);
	}

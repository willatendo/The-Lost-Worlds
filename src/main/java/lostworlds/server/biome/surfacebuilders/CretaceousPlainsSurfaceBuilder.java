...
public class CretaceousPlainsSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderBaseConfiguration> {
	public CretaceousPlainsSurfaceBuilder(Codec<SurfaceBuilderBaseConfiguration> codec) {
		super(codec);
	}

...
public class LostWorldsBiomes {
	...
	public static final RegistryObject<Biome> PERMIAN_DRIPSTONE_CAVES = register("permian_dripstone_caves", PermianBiomes::permianDripstoneCaves);

	public static final RegistryObject<Biome> PERMIAN_GROVE = register("permian_grove", PermianBiomes::permianGrove);
	public static final RegistryObject<Biome> PERMIAN_SNOWY_SLOPES = register("permian_snowy_slopes", PermianBiomes::permianSnowySlopes);
	public static final RegistryObject<Biome> PERMIAN_FROZEN_PEAKS = register("permian_frozen_peaks", PermianBiomes::permianFrozenPeaks);
	public static final RegistryObject<Biome> PERMIAN_JAGGED_PEAKS = register("permian_jagged_peaks", PermianBiomes::permianJaggedPeaks);
	public static final RegistryObject<Biome> PERMIAN_STONY_PEAKS = register("permian_stony_peaks", PermianBiomes::permianStonyPeaks);
	...
	public static RegistryObject<Biome> register(String id, Supplier<Biome> biome) {

...
public class JurassicPlains extends ModBiome {
	public static final BiomeGenerationSettings.Builder GENERATION = genSettings(LostWorldsSurfaceBuilders.NAKED_JURASSIC_PLAINS, ModSurfaceBuilderConfigs.COARSE_DIRT.get());

...
public class JurassicDesert extends ModBiome {
	public static final BiomeGenerationSettings.Builder GENERATION = genSettings(LostWorldsSurfaceBuilders.NAKED_JURASSIC_DESERT, ModSurfaceBuilderConfigs.ROCKY_SOIL_CONFIG.get());

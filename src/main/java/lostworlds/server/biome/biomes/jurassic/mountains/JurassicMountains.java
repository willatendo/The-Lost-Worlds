...
public class JurassicMountains extends TyrannoBiome {
	public static final BiomeGenerationSettings.Builder GENERATION = genSettings(LostWorldsSurfaceBuilders.NAKED_JURASSIC_MOUNTAINS, ModSurfaceBuilders.JURASSIC_STONE_CONFIG);

...
public class JurassicSwampBiome extends ModBiome {
	@Override
	...
	public BiomeGenerationSettings generation() {
		...
		generation.surfaceBuilder(() -> LostWorldsSurfaceBuilders.NAKED_JURASSIC_SWAMP.configured(ModSurfaceBuilderConfigs.MUD_CONFIG.get()));

...
public class JurassicPlainsBiome extends ModBiome {
	private float depth;
	private float scale;

	public JurassicPlainsBiome(float depth, float scale) {
		this.depth = depth;
		this.scale = scale;
	}

	public JurassicPlainsBiome() {
		this(0.125F, 0.05F);
	}
	...
	public BiomeGenerationSettings generation() {
		...
		generation.surfaceBuilder(() -> LostWorldsSurfaceBuilders.NAKED_JURASSIC_PLAINS.configured(ModSurfaceBuilderConfigs.COARSE_DIRT.get()));

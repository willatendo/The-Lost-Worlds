...
public class CretaceousRedDesert extends ModBiome {
	public static final BiomeGenerationSettings.Builder GENERATION = genSettings(LostWorldsSurfaceBuilders.NAKED_CRETACEOUS_RED_DESERT, ModSurfaceBuilders.RED_TERRACOTTA_CONFIG);

...
public class CretaceousRiverBiome extends ModBiome {
	@Override
	public Biome getBiome() {
		return this.biome(Precipitation.RAIN, BiomeCategory.RIVER, -0.5F, 0.0F, 0.8F, 0.7F, this.ambience(), this.generation(), this.spawn()).build();
	}

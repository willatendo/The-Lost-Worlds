...
public class CretaceousErrodedMountains extends ModBiome {
	public static final BiomeGenerationSettings.Builder GENERATION = genSettings(LostWorldsSurfaceBuilders.NAKED_CRETACEOUS_ERRODED_MOUNTAINS, ModSurfaceBuilderConfigs.COBBLESTONE_CONFIG.get());

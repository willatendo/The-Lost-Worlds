...
public class CretaceousAraucariaForestBiome extends ModBiome {
	@Override
	public Biome getBiome() {
		return this.biome(Precipitation.RAIN, BiomeCategory.FOREST, 0.8F, 0.7F, this.ambience(), this.generation(), this.spawn()).build();
	}

...
public class CretaceousAraucariaForest extends ModBiome {
	public static final BiomeGenerationSettings.Builder GENERATION = genSettings(LostWorldsSurfaceBuilders.NAKED_CRETACEOUS_FOREST, ModSurfaceBuilderConfigs.COARSE_DIRT.get());

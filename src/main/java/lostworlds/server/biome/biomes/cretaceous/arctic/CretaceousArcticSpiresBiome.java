...
public class CretaceousArcticSpiresBiome extends ModBiome {
	@Override
	public Biome getBiome() {
		return this.biome(Precipitation.SNOW, BiomeCategory.PLAINS, 0.125F, 0.05F, 0.5F, 0.0F, this.ambience(), this.generation(), this.spawn()).build();
	}

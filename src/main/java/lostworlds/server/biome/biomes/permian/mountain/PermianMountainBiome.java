...
public class PermianMountainBiome extends ModBiome {
	@Override
	public Biome getBiome() {
		return this.biome(Precipitation.RAIN, BiomeCategory.EXTREME_HILLS, 1.0F, 0.5F, 0.8F, 0.7F, this.ambience(), this.generation(), this.spawn()).build();
	}

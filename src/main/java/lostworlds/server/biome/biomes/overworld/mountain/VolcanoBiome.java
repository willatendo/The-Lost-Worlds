package lostworlds.server.biome.biomes.overworld.mountain;
...
public class VolcanoBiome extends ModBiome {
	...
	public Biome getBiome() {
		return this.biome(Precipitation.NONE, BiomeCategory.PLAINS, 1.0F, 0.5F, 0.0F, 2.5F, this.ambience(), this.generation(), this.spawn()).build();
	}

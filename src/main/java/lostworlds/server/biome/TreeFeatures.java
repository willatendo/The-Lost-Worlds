...
public class TreeFeatures {
	public static final Supplier<ConfiguredFeature<BaseTreeFeatureConfig, ?>> ARCTIC_CONIFER_TREE = () -> register("arctic_conifer_tree", LostWorldsFeatures.FROZEN_TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.CONIFER.getBlock(0).get())), new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.CONIFER.getBlock(5).get())), new SpruceFoliagePlacer(FeatureSpread.of(2, 1), FeatureSpread.of(0, 2), FeatureSpread.of(1, 1)), new StraightTrunkPlacer(5, 2, 1), new TwoLayerFeature(2, 0, 2))).ignoreVines().build()));
	...
	public static final Supplier<ConfiguredFeature<BaseTreeFeatureConfig, ?>> FROZEN_TREE = () -> register("frozen_tree", LostWorldsFeatures.FROZEN_TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.CONIFER.getBlock(0).get())), new SimpleBlockStateProvider(Blocks.SNOW_BLOCK.defaultBlockState()), new SpruceFoliagePlacer(FeatureSpread.of(2, 1), FeatureSpread.of(0, 2), FeatureSpread.of(1, 1)), new StraightTrunkPlacer(5, 2, 1), new TwoLayerFeature(2, 0, 2))).ignoreVines().build()));
	...
	public static final Supplier<ConfiguredFeature<BaseTreeFeatureConfig, ?>> CALAMITIES_TREE = () -> register("calamties_tree", Feature.TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.CALAMITES.getBlock(0).get())), new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.CALAMITES.getBlock(5).get())), new SpruceFoliagePlacer(FeatureSpread.of(2, 1), FeatureSpread.of(0, 2), FeatureSpread.of(1, 1)), new StraightTrunkPlacer(15, 2, 1), new TwoLayerFeature(2, 0, 2))).ignoreVines().build()));
	...
	public static final Supplier<ConfiguredFeature<BaseTreeFeatureConfig, ?>> CONIFER_TREE = () -> register("conifer_tree", Feature.TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.CONIFER.getBlock(0).get())), new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.CONIFER.getBlock(5).get())), new SpruceFoliagePlacer(FeatureSpread.of(2, 1), FeatureSpread.of(0, 2), FeatureSpread.of(1, 1)), new StraightTrunkPlacer(5, 2, 1), new TwoLayerFeature(2, 0, 2))).ignoreVines().build()));
	...
	public static final Supplier<ConfiguredFeature<BaseTreeFeatureConfig, ?>> CYPRESS_TREE = () -> register("cypress_tree", Feature.TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.CYPRESS.getBlock(0).get())), new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.CYPRESS.getBlock(5).get())), new DarkOakFoliagePlacer(FeatureSpread.fixed(1), FeatureSpread.fixed(0)), new ForkyTrunkPlacer(6, 2, 1), new ThreeLayerFeature(1, 1, 0, 1, 2, OptionalInt.empty()))).maxWaterDepth(3).decorators(ImmutableList.of(TrunkVineTreeDecorator.INSTANCE, LeaveVineTreeDecorator.INSTANCE)).ignoreVines().build()));
	...
	public static final Supplier<ConfiguredFeature<BaseTreeFeatureConfig, ?>> BABY_SEQUOIA_TREE = () -> register("baby_sequoia_tree", Feature.TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.SEQUOIA.getBlock(0).get())), new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.SEQUOIA.getBlock(5).get())), new SpruceFoliagePlacer(FeatureSpread.of(2, 1), FeatureSpread.of(0, 2), FeatureSpread.of(1, 1)), new StraightTrunkPlacer(10, 2, 4), new TwoLayerFeature(1, 1, 2))).build()));
	...
	public static final Supplier<ConfiguredFeature<BaseTreeFeatureConfig, ?>> SEQUOIA_TREE = () -> register("sequoia_tree", Feature.TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.SEQUOIA.getBlock(0).get())), new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.SEQUOIA.getBlock(5).get())), new MegaPineFoliagePlacer(FeatureSpread.fixed(0), FeatureSpread.fixed(0), FeatureSpread.of(13, 4)), new GiantTrunkPlacer(32, 2, 14), new TwoLayerFeature(1, 1, 2))).build()));
	...
	public static final Supplier<ConfiguredFeature<BaseTreeFeatureConfig, ?>> ARAUCARIA_TREE = () -> register("araucaria_tree", Feature.TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.ARAUCARIA.getBlock(0).get())), new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.ARAUCARIA.getBlock(5).get())), new SpruceFoliagePlacer(FeatureSpread.of(2, 1), FeatureSpread.of(0, 2), FeatureSpread.of(1, 1)), new StraightTrunkPlacer(5, 2, 1), new TwoLayerFeature(2, 0, 2))).ignoreVines().build()));
	...
	public static final Supplier<ConfiguredFeature<BaseTreeFeatureConfig, ?>> SCORCHED_TREE = () -> register("scorched_tree", Feature.TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(getStateWhenCan(LostWorldsBlocks.SCORCHED.getBlock(0).get())), new SimpleBlockStateProvider(Blocks.AIR.defaultBlockState()), new JungleFoliagePlacer(FeatureSpread.fixed(2), FeatureSpread.fixed(0), 2), new StraightTrunkPlacer(3, 11, 0), new TwoLayerFeature(0, 0, 0, OptionalInt.of(4)))).ignoreVines().heightmap(Heightmap.Type.MOTION_BLOCKING).build()));

...
public class BiomeKeys {
	...
	public static final RegistryKey<Biome> JURASSIC_REDWOODS_FOREST_HILLS = register("jurassic_redwoods_forest_hills");

	public static final RegistryKey<Biome> JURASSIC_PLAINS = register("jurassic_plains");
	public static final RegistryKey<Biome> JURASSIC_PLAINS_HILLS = register("jurassic_plains_hills");
	...
	public static final RegistryKey<Biome> JURASSIC_DESERT_HILLS = register("jurassic_desert_hills");
	...
	private static RegistryKey<Biome> register(String id) {
		return RegistryKey.create(Registry.BIOME_REGISTRY, new ResourceLocation(LostWorldsUtils.ID, id));
	}
}

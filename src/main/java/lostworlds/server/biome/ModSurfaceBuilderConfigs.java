...
public class ModSurfaceBuilderConfigs {
	...
	public static final Supplier<SurfaceBuilderConfig> JURASSIC_STONE_CONFIG = () -> new SurfaceBuilderConfig(LostWorldsBlocks.JURASSIC_STONE.getDefaultState(), LostWorldsBlocks.JURASSIC_STONE.getDefaultState(), LostWorldsBlocks.JURASSIC_STONE.getDefaultState());
	public static final Supplier<SurfaceBuilderConfig> JURASSIC_COBBLESTONE_CONFIG = () -> new SurfaceBuilderConfig(LostWorldsBlocks.JURASSIC_COBBLESTONE.getDefaultState(), LostWorldsBlocks.JURASSIC_COBBLESTONE.getDefaultState(), LostWorldsBlocks.JURASSIC_COBBLESTONE.getDefaultState());

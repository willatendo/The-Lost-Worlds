...
public class ModSurfaceBuilderConfigs {
	public static final Supplier<SurfaceBuilderConfig> PERMIAN_SAND_CONFIG = () -> new SurfaceBuilderConfig(LostWorldsBlocks.PERMIAN_SAND.defaultBlockState(), LostWorldsBlocks.PERMIAN_SAND.defaultBlockState(), LostWorldsBlocks.PERMIAN_SAND.defaultBlockState());
	...
	public static final Supplier<SurfaceBuilderConfig> ROCKY_SOIL_CONFIG = () -> new SurfaceBuilderConfig(LostWorldsBlocks.ROCKY_SOIL.defaultBlockState(), LostWorldsBlocks.ROCKY_SOIL.defaultBlockState(), LostWorldsBlocks.ROCKY_SOIL.defaultBlockState());
	...
	public static final Supplier<SurfaceBuilderConfig> PERMIAN_STONE_CONFIG = () -> new SurfaceBuilderConfig(LostWorldsBlocks.PERMIAN_STONE.defaultBlockState(), LostWorldsBlocks.PERMIAN_STONE.defaultBlockState(), LostWorldsBlocks.PERMIAN_STONE.defaultBlockState());
	...
	public static final Supplier<SurfaceBuilderConfig> VOLCANIC_ASH_CONFIG = () -> new SurfaceBuilderConfig(LostWorldsBlocks.VOLCANIC_ASH.defaultBlockState(), LostWorldsBlocks.VOLCANIC_ASH.defaultBlockState(), LostWorldsBlocks.VOLCANIC_ASH.defaultBlockState());

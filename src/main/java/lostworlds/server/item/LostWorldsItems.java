...
public class LostWorldsItems {
	...
	public static final ItemEntry<BrushItem> LEATHER_BRUSH = REGISTRATE.item("leather_brush", properties -> new BrushItem(ModItemTier.LEATHER, properties)).tag(LostWorldsTags.ModItemTags.BRUSHES).recipe((item, provider) -> ShapedRecipeBuilder.shaped(item.get()).pattern("###").pattern("$$$").pattern(" $ ").define('#', Items.STRING).define('$', Items.STICK).unlockedBy("has_item", provider.hasItem(Items.STRING)).save(provider)).register(),
			...
			GOLD_BRUSH = REGISTRATE.item("gold_brush", properties -> new BrushItem(ModItemTier.GOLD, properties)).tag(LostWorldsTags.ModItemTags.BRUSHES).recipe((item, provider) -> ShapedRecipeBuilder.shaped(item.get()).pattern("###").pattern("$$$").pattern(" $ ").define('#', Items.STRING).define('$', Items.GOLD_INGOT).unlockedBy("has_item", provider.hasItem(Items.STRING)).save(provider)).register(),
			DIAMOND_BRUSH = REGISTRATE.item("diamond_brush", properties -> new BrushItem(ModItemTier.DIAMOND, properties)).tag(LostWorldsTags.ModItemTags.BRUSHES).recipe((item, provider) -> ShapedRecipeBuilder.shaped(item.get()).pattern("###").pattern("$$$").pattern(" $ ").define('#', Items.STRING).define('$', Items.DIAMOND).unlockedBy("has_item", provider.hasItem(Items.STRING)).save(provider)).register(),
			NETHERITE_BRUSH = REGISTRATE.item("netherite_brush", properties -> new BrushItem(ModItemTier.NETHERITE, properties)).tag(LostWorldsTags.ModItemTags.BRUSHES).recipe((item, provider) -> SmithingRecipeBuilder.smithing(Ingredient.of(LostWorldsItems.DIAMOND_BRUSH.get()), Ingredient.of(Items.NETHERITE_INGOT), item.get()).unlocks("has_item", provider.hasItem(Items.NETHERITE_INGOT)).save(provider, LostWorldsUtils.rL("netherite_brush"))).register();
	public static final ItemEntry<CrystalScarabGemBrushItem> CRYSTAL_SCARAB_BRUSH = REGISTRATE.item("crystal_scarab_brush", properties -> new CrystalScarabGemBrushItem(properties)).tag(LostWorldsTags.ModItemTags.BRUSHES).recipe((item, provider) -> SmithingRecipeBuilder.smithing(Ingredient.of(LostWorldsItems.NETHERITE_BRUSH.get()), Ingredient.of(LostWorldsItems.CHARGED_CRYSTAL_SCARAB_GEM.get()), item.get()).unlocks("has_item", provider.hasItem(LostWorldsItems.CHARGED_CRYSTAL_SCARAB_GEM.get())).save(provider, LostWorldsUtils.rL("crystal_scarab_brush"))).register();
	...
	static {
		for (DinoTypes dinos : DinoTypes.values()) {
			if (dinos != DinoTypes.NAUTILUS && dinos != DinoTypes.PALAEONISCUM && dinos != DinoTypes.ANOMALOCARIS) {
				...
				ItemEntry<FossilItem> plasteredLegBones = REGISTRATE.item("plastered_" + dinos.name().toLowerCase() + "_leg_bones", properties -> new FossilItem(properties, () -> dinos.getLegBones(), true)).model(textured("plastered_fossil")).tag(LostWorldsTags.ModItemTags.CREATURE_ITEMS, LostWorldsTags.ModItemTags.PLASTERED_FOSSILS).register();
				dinos.setPlasteredLegBonesItem(() -> plasteredLegBones.get());
				ItemEntry<FossilItem> plasteredArmBones = REGISTRATE.item("plastered_" + dinos.name().toLowerCase() + "_arm_bones", properties -> new FossilItem(properties, () -> dinos.getArmBones(), true)).model(textured("plastered_fossil")).tag(LostWorldsTags.ModItemTags.CREATURE_ITEMS, LostWorldsTags.ModItemTags.PLASTERED_FOSSILS).register();
				dinos.setPlasteredArmBonesItem(() -> plasteredArmBones.get());
				ItemEntry<FossilItem> plasteredTail = REGISTRATE.item("plastered_" + dinos.name().toLowerCase() + "_tail", properties -> new FossilItem(properties, () -> dinos.getTail(), true)).model(textured("plastered_fossil")).tag(LostWorldsTags.ModItemTags.CREATURE_ITEMS, LostWorldsTags.ModItemTags.PLASTERED_FOSSILS).register();
				dinos.setPlasteredTailItem(() -> plasteredTail.get());
				ItemEntry<FossilItem> plasteredSkull = REGISTRATE.item("plastered_" + dinos.name().toLowerCase() + "_skull", properties -> new FossilItem(properties, () -> dinos.getSkull(), true)).model(textured("plastered_fossil")).tag(LostWorldsTags.ModItemTags.CREATURE_ITEMS, LostWorldsTags.ModItemTags.PLASTERED_FOSSILS).register();
			...
			if (dinos == DinoTypes.ANOMALOCARIS) {
				...
				ItemEntry<FossilItem> exoskeleton = REGISTRATE.item(dinos.name().toLowerCase() + "_exoskeleton", properties -> new FossilItem(properties, () -> dinos.getExoskeleton(), false)).tag(LostWorldsTags.ModItemTags.CREATURE_ITEMS, LostWorldsTags.ModItemTags.SKELETONS, dinos.getFossilTag()).register();
			...
			if (dinos == DinoTypes.PALAEONISCUM) {
				...
				ItemEntry<FossilItem> body = REGISTRATE.item(dinos.name().toLowerCase() + "_body", properties -> new FossilItem(properties, () -> dinos.getBody(), false)).tag(LostWorldsTags.ModItemTags.CREATURE_ITEMS, LostWorldsTags.ModItemTags.SKELETONS, dinos.getFossilTag()).register();
		...
		for (Plants plants : Plants.values()) {
			...
			ItemEntry<Item> softTissue = REGISTRATE.item(plants.toString().toLowerCase() + "_soft_tissue", Item::new).tag(LostWorldsTags.ModItemTags.SOFT_TISSUE).model(textured("plant_soft_tissue")).tag(LostWorldsTags.ModItemTags.SOFT_TISSUE).register();

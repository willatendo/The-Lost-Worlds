...
public class LostWorldsItems {
	...
	public static final ItemEntry<BrushItem> LEATHER_BRUSH = REGISTRATE.item("leather_brush", properties -> new BrushItem(ModItemTier.LEATHER, properties)).tag(LostWorldsTags.ModItemTags.BRUSHES.tag).recipe((item, provider) -> ShapedRecipeBuilder.shaped(item.get()).pattern("###").pattern("$$$").pattern(" $ ").define('#', Items.STRING).define('$', Items.STICK).unlockedBy("has_item", provider.hasItem(Items.STRING)).save(provider)).register(),
			...
			GOLD_BRUSH = REGISTRATE.item("gold_brush", properties -> new BrushItem(ModItemTier.GOLD, properties)).tag(LostWorldsTags.ModItemTags.BRUSHES.tag).recipe((item, provider) -> ShapedRecipeBuilder.shaped(item.get()).pattern("###").pattern("$$$").pattern(" $ ").define('#', Items.STRING).define('$', Items.GOLD_INGOT).unlockedBy("has_item", provider.hasItem(Items.STRING)).save(provider)).register(),
			DIAMOND_BRUSH = REGISTRATE.item("diamond_brush", properties -> new BrushItem(ModItemTier.DIAMOND, properties)).tag(LostWorldsTags.ModItemTags.BRUSHES.tag).recipe((item, provider) -> ShapedRecipeBuilder.shaped(item.get()).pattern("###").pattern("$$$").pattern(" $ ").define('#', Items.STRING).define('$', Items.DIAMOND).unlockedBy("has_item", provider.hasItem(Items.STRING)).save(provider)).register(),
			NETHERITE_BRUSH = REGISTRATE.item("netherite_brush", properties -> new BrushItem(ModItemTier.NETHERITE, properties)).tag(LostWorldsTags.ModItemTags.BRUSHES.tag).recipe((item, provider) -> SmithingRecipeBuilder.smithing(Ingredient.of(LostWorldsItems.DIAMOND_BRUSH.get()), Ingredient.of(Items.NETHERITE_INGOT), item.get()).unlocks("has_item", provider.hasItem(Items.NETHERITE_INGOT)).save(provider, LostWorldsUtils.rL("netherite_brush"))).register();

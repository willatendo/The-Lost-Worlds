package lostworlds.server.entity.semiaquatic.pleistocene;
...
public class Toyotamaphimeia extends CarnivoreSemiAquaticMob implements NeutralMob, SpeciesTagModelAndTextureable {
	private static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(Toyotamaphimeia.class, EntityDataSerializers.INT);
	...
	public Toyotamaphimeia(EntityType<? extends CarnivoreSemiAquaticMob> entity, Level world) {
		super(entity, world);
	}

	@Override
	public TagKey<SpeciesType> getTagToUse() {
		return LostWorldsTags.ModSpeciesTypeTags.TOYOTAMAPHIMEIA;
	}
	...
	public static Builder createAttributes() {
		return Monster.createMonsterAttributes().add(Attributes.MOVEMENT_SPEED, (double) 0.35F).add(Attributes.MAX_HEALTH, LostWorldsConfig.COMMON_CONFIG.toyotamaphimeiaHeath.get()).add(Attributes.ATTACK_DAMAGE, LostWorldsConfig.COMMON_CONFIG.toyotamaphimeiaAttackDamage.get());
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(6, new TerrestrialLayEggGoal(this, 1.0D, AncientCreatures.RHINESUCHUS));

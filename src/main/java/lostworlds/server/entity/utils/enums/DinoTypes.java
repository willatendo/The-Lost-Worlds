...
public enum DinoTypes implements IStringSerializable {
	...
	DILOPHOSAURUS(6, "dilophosaurus", LostWorldsEntities.DILOPHOSAURUS, LostWorldsTags.ModItemTags.DILOPHOSAURUS_FOSSILS, true, false, true, Size.LARGE, CreatureDiet.CARNIVORE, 0xc49838, 0xc49838, 0xc75539, 5, 7, 0.5F, 0.76F),
	DIMETRODON(7, "dimetrodon", LostWorldsEntities.DIMETRODON, LostWorldsTags.ModItemTags.DIMETRODON_FOSSILS, true, false, true, Size.MEDIUM, CreatureDiet.CARNIVORE, 0x81644c, 0x81644c, 0xcba755, 5, 7, 0.5F, 0.76F),
	EDAPHOSAURUS(8, "edaphosaurus", LostWorldsEntities.EDAPHOSAURUS, LostWorldsTags.ModItemTags.EDAPHOSAURUS_FOSSILS, true, false, true, Size.MEDIUM, CreatureDiet.HERBIVORE, 0x57614e, 0x57614e, 0xdf9046, 5, 7, 0.5F, 0.76F),
	EORAPTOR(9, "eoraptor", LostWorldsEntities.EORAPTOR, LostWorldsTags.ModItemTags.EORAPTOR_FOSSILS, true, true, true, Size.TINY, CreatureDiet.CARNIVORE, 0x523c3e, 0x523c3e, 0x824b78, 1, 3, 0.1F, 0.35F),
	FUKUIVENATOR(10, "fukuivenator", LostWorldsEntities.FUKUIVENATOR, LostWorldsTags.ModItemTags.FUKUIVENATOR_FOSSILS, true, true, true, Size.SMALL, CreatureDiet.CARNIVORE, 0x52526f, 0x52526f, 0x5757959, 4, 5, 0.3F, 0.35F),
	GIGANOTOSAURUS(11, "giganotosaurus", LostWorldsEntities.GIGANOTOSAURUS, LostWorldsTags.ModItemTags.GIGANOTOSAURUS_FOSSILS, true, false, true, Size.LARGE, CreatureDiet.CARNIVORE, 0x9f6b41, 0x9f6b41, 0x943c24, 9, 12, 0.5F, 0.8F),
	GORGONOPS(12, "gorgonops", LostWorldsEntities.GORGONOPS, LostWorldsTags.ModItemTags.GORGONOPS_FOSSILS, true, false, false, Size.SMALL, CreatureDiet.CARNIVORE, 0x443619, 0x443619, 0x3b3e2d, 3, 5, 0.3F, 0.46F),
	GREAT_AUK(13, "great_auk", LostWorldsEntities.GREAT_AUK, LostWorldsTags.ModItemTags.GREAT_AUK_FOSSILS, true, true, false, Size.SMALL, CreatureDiet.PISCIVORE, 0x000000, 0x000000, 0xFFFFFF, 3, 5, 0.3F, 0.46F),
	KENTROSAURUS(14, "kentrosaurus", LostWorldsEntities.KENTROSAURUS, LostWorldsTags.ModItemTags.KENTROSAURUS_FOSSILS, true, false, true, Size.MEDIUM, CreatureDiet.HERBIVORE, 0xd99760, 0xd99760, 0x612c00, 3, 6, 0.4F, 0.66F),
	LIAONINGOSAURUS(15, "liaoningosaurus", LostWorldsEntities.LIAONINGOSAURUS, LostWorldsTags.ModItemTags.LIAONINGOSAURUS_FOSSILS, true, false, true, Size.MEDIUM, CreatureDiet.HERBIVORE, 0x712d0d, 0x712d0d, 0x7c8237, 4, 7, 0.45F, 0.68F),
	NAUTILUS(16, "nautilus", LostWorldsEntities.NAUTILUS, LostWorldsTags.ModItemTags.NAUTILUS_FOSSILS, false, false, false, Size.SMALL, CreatureDiet.NONE, 0xd4ccc3, 0xd4ccc3, 0xca7548, 2, 5, 0.3F, 0.5F),
	OPHTHALMOSAURUS(17, "ophthalmosaurus", LostWorldsEntities.OPHTHALMOSAURUS, LostWorldsTags.ModItemTags.OPHTHALMOSAURUS_FOSSILS, false, false, false, Size.MEDIUM, CreatureDiet.PISCIVORE, 0x858794, 0x858794, 0x0e131b, 4, 7, 0.4F, 0.6F),
	OSTROMIA(18, "ostromia", LostWorldsEntities.OSTROMIA, LostWorldsTags.ModItemTags.OSTROMIA_FOSSILS, true, true, true, Size.SMALL, CreatureDiet.CARNIVORE, 0x47a373, 0x47a373, 0x2c4d86, 2, 4, 0.2F, 0.3F),
	OURANOSAURUS(19, "ouranosaurus", LostWorldsEntities.OURANOSAURUS, LostWorldsTags.ModItemTags.OURANOSAURUS_FOSSILS, true, false, true, Size.MEDIUM, CreatureDiet.HERBIVORE, 0x999554, 0x999554, 0x90bdb4, 7, 10, 0.5F, 0.76F),
	PALAEONISCUM(20, "palaeoniscum", LostWorldsEntities.PALAEONISCUM, LostWorldsTags.ModItemTags.PALAEONISCUM_FOSSILS, false, false, false, Size.TINY, CreatureDiet.NONE, 0x72797a, 0x72797a, 0x2f3a3d, 2, 5, 0.3F, 0.5F),
	PROCOMPSOGNATHUS(21, "procompsognathus", LostWorldsEntities.PROCOMPSOGNATHUS, LostWorldsTags.ModItemTags.PROCOMPSOGNATHUS_FOSSILS, true, true, true, Size.TINY, CreatureDiet.CARNIVORE, 0x445a2f, 0x445a2f, 0x404727, 1, 2, 0.1F, 0.2F),
	PROTOSUCHUS(22, "protosuchus", LostWorldsEntities.PROTOSUCHUS, LostWorldsTags.ModItemTags.PROTOSUCHUS_FOSSILS, true, false, true, Size.SMALL, CreatureDiet.CARNIVORE, 0x8e2317, 0x8e2317, 0xb0492e, 3, 5, 0.3F, 0.54F),
	PSITTACOSAURUS(23, "psittacosaurus", LostWorldsEntities.PSITTACOSAURUS, LostWorldsTags.ModItemTags.PSITTACOSAURUS_FOSSILS, true, false, true, Size.SMALL, CreatureDiet.HERBIVORE, 0x4c2c21, 0x4c2c21, 0x938639, 3, 5, 0.3F, 0.54F),
	RHINESUCHUS(24, "rhinesuchus", LostWorldsEntities.RHINESUCHUS, LostWorldsTags.ModItemTags.RHINESUCHUS_FOSSILS, false, false, false, Size.SMALL, CreatureDiet.CARNIVORE, 0x576b54, 0x576b54, 0xaf944a, 3, 5, 0.3F, 0.54F),
	SUCHOMIMUS(25, "suchomimus", LostWorldsEntities.SUCHOMIMUS, LostWorldsTags.ModItemTags.SUCHOMIMUS_FOSSILS, true, false, true, Size.MEDIUM, CreatureDiet.CARNIVORE, 0x57737b, 0x57737b, 0xcd9528, 5, 7, 0.5F, 0.64F),
	TETRACERATOPS(26, "tetraceratops", LostWorldsEntities.TETRACERATOPS, LostWorldsTags.ModItemTags.TETRACERATOPS_FOSSILS, true, false, true, Size.SMALL, CreatureDiet.HERBIVORE, 0x623015, 0x623015, 0x21369b, 3, 5, 0.3F, 0.54F),
	TYRANNOSAURUS(27, "tyrannosaurus", LostWorldsEntities.TYRANNOSAURUS, LostWorldsTags.ModItemTags.TYRANNOSAURUS_FOSSILS, true, false, true, Size.LARGE, CreatureDiet.CARNIVORE, 0x889a55, 0x889a55, 0x973229, 8, 11, 0.5F, 0.8F),
	UTAHRAPTOR(28, "utahraptor", LostWorldsEntities.UTAHRAPTOR, LostWorldsTags.ModItemTags.UTAHRAPTOR_FOSSILS, true, true, true, Size.MEDIUM, CreatureDiet.CARNIVORE, 0x503524, 0x503524, 0x635f5e, 5, 7, 0.5F, 0.64F),
	ZEPHYROSAURUS(29, "zephyrosaurus", LostWorldsEntities.ZEPHYROSAURUS, LostWorldsTags.ModItemTags.ZEPHYROSAURUS_FOSSILS, true, true, true, Size.SMALL, CreatureDiet.HERBIVORE, 0x577476, 0x577476, 0x9ba3a3, 3, 5, 0.3F, 0.54F),;
	...
	private DinoTypes(int internalId, String id, EntityType entity, ITag.INamedTag<Item> fossilTag, boolean eggLaying, boolean feathered, boolean createHide, Size eggSize, CreatureDiet diet, int eggSetColour, int primaryColour, int secondaryColour, int rawNutrition, int cookedNutrition, float rawSaturation, float cookedSaturation) {
		this.id = id;

...
public class SleepyRandomStrollGoal extends Goal {
	...
	public SleepyRandomStrollGoal(EggLayingMob entity, double speedModifier) {
		this(entity, speedModifier, 120);
	}

	public SleepyRandomStrollGoal(EggLayingMob entity, double speedModifier, int interval) {
		this(entity, speedModifier, interval, true);
	}

	public SleepyRandomStrollGoal(EggLayingMob entity, double speedModifier, int interval, boolean checkNoActionTime) {
		this.entity = entity;

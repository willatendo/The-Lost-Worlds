...
public abstract class BasicFishLikeMob extends PathfinderMob {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(BasicFishLikeMob.class, EntityDataSerializers.BOOLEAN);

	public BasicFishLikeMob(EntityType<? extends PathfinderMob> entity, Level world) {
		super(entity, world);

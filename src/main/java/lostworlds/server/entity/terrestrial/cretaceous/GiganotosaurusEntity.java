...
public class GiganotosaurusEntity extends CarnivoreEntity implements NeutralMob {
	private static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(GiganotosaurusEntity.class, EntityDataSerializers.INT);
	...
	public GiganotosaurusEntity(EntityType<? extends GiganotosaurusEntity> entity, Level world) {
		super(entity, world);
	}

...
public class ThanosEntity extends CarnivoreEntity implements NeutralMob {
	private static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(ThanosEntity.class, EntityDataSerializers.INT);
	...
	public ThanosEntity(EntityType<? extends ThanosEntity> entity, Level world) {
		super(entity, world);
	}

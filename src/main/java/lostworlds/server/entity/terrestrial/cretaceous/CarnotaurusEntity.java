...
public class CarnotaurusEntity extends CarnivoreEntity implements NeutralMob {
	private static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(CarnotaurusEntity.class, EntityDataSerializers.INT);
	...
	public CarnotaurusEntity(EntityType<? extends CarnotaurusEntity> entity, Level world) {
		super(entity, world);
	}

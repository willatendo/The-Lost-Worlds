...
public class OuranosaurusEntity extends EggLayingEntity implements NeutralMob {
	private static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(OuranosaurusEntity.class, EntityDataSerializers.INT);
	...
	public OuranosaurusEntity(EntityType<? extends OuranosaurusEntity> entity, Level world) {
		super(entity, world);
	}

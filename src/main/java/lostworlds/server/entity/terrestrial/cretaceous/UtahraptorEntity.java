...
public class UtahraptorEntity extends CarnivoreEntity implements NeutralMob {
	private static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(UtahraptorEntity.class, EntityDataSerializers.INT);
	...
	public UtahraptorEntity(EntityType<? extends UtahraptorEntity> entity, Level world) {
		super(entity, world);
	}
	...
	public static Builder createAttributes() {
		return Monster.createMonsterAttributes().add(Attributes.MOVEMENT_SPEED, (double) 0.35F).add(Attributes.MAX_HEALTH, LostWorldsConfig.COMMON_CONFIG.utahraptorHeath.get()).add(Attributes.ATTACK_DAMAGE, LostWorldsConfig.COMMON_CONFIG.utahraptorAttackDamage.get());
	}

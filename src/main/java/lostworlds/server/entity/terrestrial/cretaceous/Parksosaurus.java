...
public class Parksosaurus extends EggLayingMob implements SpeciesTagModelAndTextureable {
	private static final Ingredient FOOD_ITEMS = FoodLists.HERBIVORE;
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);

	public Parksosaurus(EntityType<? extends Parksosaurus> entity, Level world) {
		super(entity, world);
	}

	@Override
	public TagKey<SpeciesType> getTagToUse() {
		return LostWorldsTags.ModSpeciesTypeTags.PARKSOSAURUS;
	}

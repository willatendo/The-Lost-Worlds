...
public class ParksosaurusEntity extends EggLayingEntity {
	private static final Ingredient FOOD_ITEMS = FoodLists.HERBIVORE;
	private AnimationFactory factory = new AnimationFactory(this);

	public ParksosaurusEntity(EntityType<? extends ParksosaurusEntity> entity, Level world) {
		super(entity, world);
	}
	...
	public static Builder createAttributes() {
		return Monster.createMonsterAttributes().add(Attributes.MOVEMENT_SPEED, (double) 0.35F).add(Attributes.MAX_HEALTH, LostWorldsConfig.COMMON_CONFIG.parksosaurusHeath.get());
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(5, new SleepyAvoidEntityGoal<>(this, FukuivenatorEntity.class, 8.0F, 1.6D, 1.4D, EntitySelector.NO_SPECTATORS::test));
		...
		this.goalSelector.addGoal(5, new SleepyAvoidEntityGoal<>(this, ThanosEntity.class, 8.0F, 1.6D, 1.4D, EntitySelector.NO_SPECTATORS::test));

...
public class ParksosaurusEntity extends EggLayingEntity {
	...
	public ParksosaurusEntity(EntityType<? extends ParksosaurusEntity> entity, World world) {
		super(entity, world);
	}
	...
	public static MutableAttribute createAttributes() {
		return MonsterEntity.createMonsterAttributes().add(Attributes.MOVEMENT_SPEED, (double) 0.35F).add(Attributes.MAX_HEALTH, LostWorldsConfig.COMMON_CONFIG.parksosaurusHeath.get());
	}

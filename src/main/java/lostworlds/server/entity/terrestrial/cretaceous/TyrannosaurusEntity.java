...
public class TyrannosaurusEntity extends CarnivoreEntity implements NeutralMob {
	private static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(TyrannosaurusEntity.class, EntityDataSerializers.INT);
	...
	public TyrannosaurusEntity(EntityType<? extends TyrannosaurusEntity> entity, Level world) {
		super(entity, world);
	}

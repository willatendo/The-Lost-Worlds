...
public class SuchomimusEntity extends CarnivoreEntity implements NeutralMob {
	private static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(SuchomimusEntity.class, EntityDataSerializers.INT);
	...
	public SuchomimusEntity(EntityType<? extends SuchomimusEntity> entity, Level world) {
		super(entity, world);
	}

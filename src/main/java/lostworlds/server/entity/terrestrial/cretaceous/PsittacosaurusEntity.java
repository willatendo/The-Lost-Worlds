...
public class PsittacosaurusEntity extends EggLayingEntity {
	...
	public PsittacosaurusEntity(EntityType<? extends PsittacosaurusEntity> entity, Level world) {
		super(entity, world);
	}
	...
	public static Builder createAttributes() {
		return Monster.createMonsterAttributes().add(Attributes.MOVEMENT_SPEED, (double) 0.35F).add(Attributes.MAX_HEALTH, LostWorldsConfig.COMMON_CONFIG.psittacosaurusHeath.get());
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(6, new TerrestrialLayEggGoal(this, 1.0D, DinoTypes.PSITTACOSAURUS));
	...
	public AgableMob getBreedOffspring(ServerLevel world, AgableMob entity) {
		return LostWorldsEntities.PSITTACOSAURUS.create(world);
	}
}

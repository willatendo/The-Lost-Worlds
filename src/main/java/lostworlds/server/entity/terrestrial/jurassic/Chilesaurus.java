...
public class Chilesaurus extends EggLayingMob implements SpeciesTagModelAndTextureable {
	private static final Ingredient FOOD_ITEMS = FoodLists.HERBIVORE;
	private AnimationFactory factory = new AnimationFactory(this);

	public Chilesaurus(EntityType<? extends Chilesaurus> entity, Level world) {
		super(entity, world);
	}

	@Override
	public TagKey<SpeciesType> getTagToUse() {
		return LostWorldsTags.ModSpeciesTypeTags.CHILESAURUS;
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(5, new SleepyAvoidEntityGoal<>(this, Cryolophosaurus.class, 8.0F, 1.6D, 1.4D, EntitySelector.NO_SPECTATORS::test));
		this.goalSelector.addGoal(5, new SleepyAvoidEntityGoal<>(this, Dilophosaurus.class, 8.0F, 1.6D, 1.4D, EntitySelector.NO_SPECTATORS::test));
		...
		this.goalSelector.addGoal(6, new TerrestrialLayEggGoal(this, 1.0D, AncientCreatures.CHILESAURUS));

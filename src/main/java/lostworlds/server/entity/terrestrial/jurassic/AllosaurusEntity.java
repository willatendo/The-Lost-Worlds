...
public class AllosaurusEntity extends CarnivoreEntity implements NeutralMob {
	private static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(AllosaurusEntity.class, EntityDataSerializers.INT);
	...
	public AllosaurusEntity(EntityType<? extends AllosaurusEntity> entity, Level world) {
		super(entity, world);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(1, new ReasonedAttackableTargetGoal<>(this, AllosaurusEntity.class, this::isHungry));
		this.targetSelector.addGoal(3, new ReasonedAttackableTargetGoal<>(this, AllosaurusEntity.class, this::isAngryAt));
		this.targetSelector.addGoal(1, new ReasonedAttackableTargetGoal<>(this, KentrosaurusEntity.class, this::isHungry));
		this.targetSelector.addGoal(3, new ReasonedAttackableTargetGoal<>(this, KentrosaurusEntity.class, this::isAngryAt));

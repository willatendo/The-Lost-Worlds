...
public class Eustreptospondylus extends Carnivore implements NeutralMob, SpeciesTagModelAndTextureable {
	...
	public TagKey<SpeciesType> getTagToUse() {
		return LostWorldsTags.ModSpeciesTypeTags.EUSTREPTOSPONDYLUS;
	}

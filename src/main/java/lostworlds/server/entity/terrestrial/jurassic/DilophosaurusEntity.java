...
public class DilophosaurusEntity extends CarnivoreEntity implements NeutralMob {
	private static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(DilophosaurusEntity.class, EntityDataSerializers.INT);
	...
	public DilophosaurusEntity(EntityType<? extends DilophosaurusEntity> entity, Level world) {
		super(entity, world);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(1, new ReasonedAttackableTargetGoal<>(this, CryolophosaurusEntity.class, this::isHungry));

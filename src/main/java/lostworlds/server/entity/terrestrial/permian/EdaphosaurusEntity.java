...
public class EdaphosaurusEntity extends EggLayingEntity {
	private static final Ingredient FOOD_ITEMS = FoodLists.HERBIVORE;
	private AnimationFactory factory = new AnimationFactory(this);

	public EdaphosaurusEntity(EntityType<? extends EdaphosaurusEntity> entity, World world) {
		super(entity, world);
	}
	...
	public static AttributeModifierMap createAttributes() {
		return MonsterEntity.createMonsterAttributes().add(Attributes.MOVEMENT_SPEED, (double) 0.2F).add(Attributes.MAX_HEALTH, LostWorldsConfig.COMMON_CONFIG.edaphosaurusHeath.get()).build();
	}

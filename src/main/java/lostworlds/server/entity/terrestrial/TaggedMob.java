...
public abstract class TaggedMob extends PrehistoricMob {
	...
	protected static final EntityDataAccessor<Optional<UUID>> DATA_OWNERUUID_ID = SynchedEntityData.defineId(TaggedMob.class, EntityDataSerializers.OPTIONAL_UUID);

	public TaggedMob(EntityType<? extends TaggedMob> entity, Level world) {
		super(entity, world);
	}

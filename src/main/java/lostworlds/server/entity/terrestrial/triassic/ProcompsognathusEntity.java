...
public class ProcompsognathusEntity extends CarnivoreEntity implements NeutralMob {
	private static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(ProcompsognathusEntity.class, EntityDataSerializers.INT);
	...
	public ProcompsognathusEntity(EntityType<? extends ProcompsognathusEntity> entity, Level world) {
		super(entity, world);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(1, new ReasonedAttackableTargetGoal<>(this, ProcompsognathusEntity.class, this::isHungry));
		this.targetSelector.addGoal(1, new ReasonedAttackableTargetGoal<>(this, ProcompsognathusEntity.class, this::isAngryAt));

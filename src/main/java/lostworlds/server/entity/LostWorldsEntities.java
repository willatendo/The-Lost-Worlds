...
public class LostWorldsEntities {
	...
	public static final EntityEntry<Cryptoclidus> CRYPTOCLIDUS = REGISTRATE.entity("cryptoclidus", Cryptoclidus::new, MobCategory.CREATURE).properties(properties -> properties.sized(1.0F, 0.75F)).renderer(() -> CryptoclidusRenderer::new).defaultSpawnEgg(0x3f5d5a, 0xaad1d1).attributes(() -> Cryptoclidus.createAttributes()).spawnPlacement(Type.IN_WATER, Types.OCEAN_FLOOR, Cryptoclidus::canDolphinLikeSpawn).loot(dinosaurDrop(AncientCreatures.CRYOLOPHOSAURUS, 1, 4)).register();

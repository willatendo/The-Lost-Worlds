...
import lostworlds.client.entity.render.CryptoclidusRenderer;
...
import lostworlds.client.entity.render.MesosaurusRenderer;
...
import lostworlds.client.entity.render.ToyotamaphimeiaRenderer;
...
public class LostWorldsEntities {
	...
	public static final EntityEntry<ChargedCrystalScarabGemItemEntity> CHARGED_CRYSTAL_SCARAB_GEM_ITEM = REGISTRATE.<ChargedCrystalScarabGemItemEntity>entity("charged_crystal_scarab_gem_item", ChargedCrystalScarabGemItemEntity::new, MobCategory.MISC).properties(properties -> properties.sized(0.5F, 0.5F)).renderer(() -> ItemEntityRenderer::new).register();
	public static final EntityEntry<CrystalScarabGemItemEntity> CRYSTAL_SCARAB_GEM_ITEM = REGISTRATE.<CrystalScarabGemItemEntity>entity("crystal_scarab_gem_item", CrystalScarabGemItemEntity::new, MobCategory.MISC).properties(properties -> properties.sized(0.5F, 0.5F)).renderer(() -> ItemEntityRenderer::new).register();
	...
	private static <T extends LivingEntity> NonNullBiConsumer<RegistrateEntityLootTables, EntityType<T>> dinosaurDrop(AncientCreatures type, int min, int max) {
		return (provider, entity) -> {
			...
			if (AncientCreatures.feathered().contains(type)) {
			...
			if (AncientCreatures.createHide().contains(type)) {
			...
			if (type == AncientCreatures.PALAEONISCUM) {

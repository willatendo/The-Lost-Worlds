...
public class LostWorldsEntities {
	...
	public static final EntityEntry<ModBoatEntity> MOD_BOAT = REGISTRATE.<ModBoatEntity>entity("mod_boat", ModBoatEntity::new, MobCategory.MISC).properties(properties -> properties.sized(1.375F, 0.5625F)).renderer(() -> ModBoatRenderer::new).register();
	public static final EntityEntry<ChargedCrystalScarabGemItemEntity> CHARGED_CRYSTAL_SCARAB_GEM_ITEM = REGISTRATE.<ChargedCrystalScarabGemItemEntity>entity("charged_crystal_scarab_gem_item", ChargedCrystalScarabGemItemEntity::new, MobCategory.MISC).properties(properties -> properties.sized(0.5F, 0.5F)).renderer(() -> manager -> new ItemEntityRenderer(manager, Minecraft.getInstance().getItemRenderer())).register();
	public static final EntityEntry<CrystalScarabGemItemEntity> CRYSTAL_SCARAB_GEM_ITEM = REGISTRATE.<CrystalScarabGemItemEntity>entity("crystal_scarab_gem_item", CrystalScarabGemItemEntity::new, MobCategory.MISC).properties(properties -> properties.sized(0.5F, 0.5F)).renderer(() -> manager -> new ItemEntityRenderer(manager, Minecraft.getInstance().getItemRenderer())).register();

	public static final EntityEntry<AllosaurusEntity> ALLOSAURUS = REGISTRATE.entity("allosaurus", AllosaurusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(2.0F, 1.5F)).renderer(() -> AllosaurusRenderer::new).defaultSpawnEgg(0x9f9f5a, 0xd68812).attributes(() -> AllosaurusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.ALLOSAURUS, 2, 7)).register();
	public static final EntityEntry<AnomalocarisEntity> ANOMALOCARIS = REGISTRATE.entity("anomalocaris", AnomalocarisEntity::new, MobCategory.WATER_CREATURE).properties(properties -> properties.sized(1.0F, 1.0F)).renderer(() -> AnomalocarisRenderer::new).defaultSpawnEgg(0xb94f33, 0x631312).attributes(() -> AnomalocarisEntity.createAttributes()).spawnPlacement(Type.IN_WATER, Types.OCEAN_FLOOR, AnomalocarisEntity::canFishLikeSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.ANOMALOCARIS, 0, 2)).register();
	public static final EntityEntry<CarnotaurusEntity> CARNOTAURUS = REGISTRATE.entity("carnotaurus", CarnotaurusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(2.0F, 1.5F)).renderer(() -> CarnotaurusRenderer::new).defaultSpawnEgg(0x605645, 0xb5a187).attributes(() -> CarnotaurusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.CARNOTAURUS, 1, 5)).register();
	public static final EntityEntry<ChilesaurusEntity> CHILESAURUS = REGISTRATE.entity("chilesaurus", ChilesaurusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(1.0F, 1.0F)).renderer(() -> ChilesaurusRenderer::new).defaultSpawnEgg(0xb08533, 0x283c3f).attributes(() -> ChilesaurusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.CHILESAURUS, 1, 3)).register();
	public static final EntityEntry<CryolophosaurusEntity> CRYOLOPHOSAURUS = REGISTRATE.entity("cryolophosaurus", CryolophosaurusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(1.0F, 0.75F)).renderer(() -> CryolophosaurusRenderer::new).defaultSpawnEgg(0xab5a14, 0x1a2c5f).attributes(() -> CryolophosaurusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.CRYOLOPHOSAURUS, 1, 4)).register();
	...
	public static final EntityEntry<DilophosaurusEntity> DILOPHOSAURUS = REGISTRATE.entity("dilophosaurus", DilophosaurusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(1.5F, 1.5F)).renderer(() -> DilophosaurusRenderer::new).defaultSpawnEgg(0xc49838, 0xc75539).attributes(() -> DilophosaurusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.DILOPHOSAURUS, 1, 5)).register();
	public static final EntityEntry<DimetrodonEntity> DIMETRODON = REGISTRATE.entity("dimetrodon", DimetrodonEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(1.5F, 1.5F)).renderer(() -> DimetrodonRenderer::new).defaultSpawnEgg(0x81644c, 0xcba755).attributes(() -> DimetrodonEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.DIMETRODON, 1, 4)).register();
	public static final EntityEntry<EdaphosaurusEntity> EDAPHOSAURUS = REGISTRATE.entity("edaphosaurus", EdaphosaurusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(1.0F, 1.0F)).renderer(() -> EdaphosaurusRenderer::new).defaultSpawnEgg(0x57614e, 0xdf9046).attributes(() -> EdaphosaurusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.EDAPHOSAURUS, 1, 4)).register();
	public static final EntityEntry<EoraptorEntity> EORAPTOR = REGISTRATE.entity("eoraptor", EoraptorEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(0.5F, 0.5F)).renderer(() -> EoraptorRenderer::new).defaultSpawnEgg(0x523c3e, 0x824b78).attributes(() -> EoraptorEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.EORAPTOR, 1, 2)).register();
	public static final EntityEntry<EustreptospondylusEntity> EUSTREPTOSPONDYLUS = REGISTRATE.entity("eustreptospondylus", EustreptospondylusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(1.5F, 1.0F)).renderer(() -> EustreptospondylusRenderer::new).defaultSpawnEgg(0x241d1a, 0xab5631).attributes(() -> EustreptospondylusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.EUSTREPTOSPONDYLUS, 1, 4)).register();
	public static final EntityEntry<FukuivenatorEntity> FUKUIVENATOR = REGISTRATE.entity("fukuivenator", FukuivenatorEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(0.5F, 0.5F)).renderer(() -> FukuivenatorRenderer::new).defaultSpawnEgg(0x52526f, 0x5757959).attributes(() -> FukuivenatorEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.FUKUIVENATOR, 2, 4)).register();
	public static final EntityEntry<GiganotosaurusEntity> GIGANOTOSAURUS = REGISTRATE.entity("giganotosaurus", GiganotosaurusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(4.0F, 2.5F)).renderer(() -> GiganotosaurusRenderer::new).defaultSpawnEgg(0x9f6b41, 0x943c24).attributes(() -> GiganotosaurusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.GIGANOTOSAURUS, 3, 8)).register();
	public static final EntityEntry<GorgonopsEntity> GORGONOPS = REGISTRATE.entity("gorgonops", GorgonopsEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(1.0F, 1.0F)).renderer(() -> GorgonopsRenderer::new).defaultSpawnEgg(0x443619, 0x3b3e2d).attributes(() -> GorgonopsEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.GORGONOPS, 1, 3)).register();
	public static final EntityEntry<GreatAukEntity> GREAT_AUK = REGISTRATE.entity("great_auk", GreatAukEntity::new, SEMI_AQUATIC_CREATURE).properties(properties -> properties.sized(0.75F, 1.5F)).renderer(() -> GreatAukRenderer::new).defaultSpawnEgg(0x000000, 0xFFFFFF).attributes(() -> GreatAukEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, GreatAukEntity::canGreatAukSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.GREAT_AUK, 1, 3)).register();
	public static final EntityEntry<KentrosaurusEntity> KENTROSAURUS = REGISTRATE.entity("kentrosaurus", KentrosaurusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(1.0F, 0.75F)).renderer(() -> KentrosaurusRenderer::new).defaultSpawnEgg(0xd99760, 0x612c00).attributes(() -> KentrosaurusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.KENTROSAURUS, 1, 4)).register();
	public static final EntityEntry<LiaoningosaurusEntity> LIAONINGOSAURUS = REGISTRATE.entity("liaoningosaurus", LiaoningosaurusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(1.0F, 0.75F)).renderer(() -> LiaoningosaurusRenderer::new).defaultSpawnEgg(0x712d0d, 0x7c8237).attributes(() -> LiaoningosaurusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.LIAONINGOSAURUS, 2, 4)).register();
	public static final EntityEntry<NautilusEntity> NAUTILUS = REGISTRATE.entity("nautilus", NautilusEntity::new, MobCategory.WATER_CREATURE).properties(properties -> properties.sized(0.5F, 0.5F)).renderer(() -> NautilusRenderer::new).defaultSpawnEgg(0xd4ccc3, 0xca7548).attributes(() -> NautilusEntity.createAttributes()).spawnPlacement(Type.IN_WATER, Types.OCEAN_FLOOR, NautilusEntity::canFishLikeSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.NAUTILUS, 2, 5)).register();
	public static final EntityEntry<OphthalmosaurusEntity> OPHTHALMOSAURUS = REGISTRATE.entity("ophthalmosaurus", OphthalmosaurusEntity::new, MobCategory.WATER_CREATURE).properties(properties -> properties.sized(2.0F, 2.0F)).renderer(() -> OphthalmosaurusRenderer::new).defaultSpawnEgg(0x858794, 0x0e131b).attributes(() -> OphthalmosaurusEntity.createAttributes()).spawnPlacement(Type.IN_WATER, Types.OCEAN_FLOOR, OphthalmosaurusEntity::canDolphinLikeSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.OPHTHALMOSAURUS, 1, 3)).register();
	public static final EntityEntry<OstromiaEntity> OSTROMIA = REGISTRATE.entity("ostromia", OstromiaEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(0.5F, 0.5F)).renderer(() -> OstromiaRenderer::new).defaultSpawnEgg(0x47a373, 0x2c4d86).attributes(() -> OstromiaEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.OSTROMIA, 1, 2)).register();
	public static final EntityEntry<OuranosaurusEntity> OURANOSAURUS = REGISTRATE.entity("ouranosaurus", OuranosaurusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(2.5F, 2.5F)).renderer(() -> OuranosaurusRenderer::new).defaultSpawnEgg(0x999554, 0x90bdb4).attributes(() -> OuranosaurusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.OURANOSAURUS, 2, 4)).register();
	public static final EntityEntry<ParksosaurusEntity> PARKSOSAURUS = REGISTRATE.entity("parksosaurus", ParksosaurusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(1.0F, 1.0F)).renderer(() -> ParksosaurusRenderer::new).defaultSpawnEgg(0xa98460, 0xe59a3c).attributes(() -> ParksosaurusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.PARKSOSAURUS, 1, 2)).register();
	public static final EntityEntry<PalaeoniscumEntity> PALAEONISCUM = REGISTRATE.entity("palaeoniscum", PalaeoniscumEntity::new, MobCategory.WATER_CREATURE).properties(properties -> properties.sized(0.5F, 0.5F)).renderer(() -> PalaeoniscumRenderer::new).defaultSpawnEgg(0x72797a, 0x2f3a3d).attributes(() -> PalaeoniscumEntity.createAttributes()).spawnPlacement(Type.IN_WATER, Types.OCEAN_FLOOR, PalaeoniscumEntity::canFishLikeSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.PALAEONISCUM, 1, 1)).register();
	public static final EntityEntry<ProcompsognathusEntity> PROCOMPSOGNATHUS = REGISTRATE.entity("procompsognathus", ProcompsognathusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(0.5F, 0.5F)).renderer(() -> ProcompsognathusRenderer::new).defaultSpawnEgg(0x445a2f, 0x404727).attributes(() -> ProcompsognathusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.PROCOMPSOGNATHUS, 0, 2)).register();
	public static final EntityEntry<ProtosuchusEntity> PROTOSUCHUS = REGISTRATE.entity("protosuchus", ProtosuchusEntity::new, MobCategory.WATER_CREATURE).properties(properties -> properties.sized(0.5F, 0.5F)).renderer(() -> ProtosuchusRenderer::new).defaultSpawnEgg(0x8e2317, 0xb0492e).attributes(() -> ProtosuchusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.PROTOSUCHUS, 1, 3)).register();
	public static final EntityEntry<PsittacosaurusEntity> PSITTACOSAURUS = REGISTRATE.entity("psittacosaurus", PsittacosaurusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(0.5F, 0.5F)).renderer(() -> PsittacosaurusRenderer::new).defaultSpawnEgg(0x4c2c21, 0x938639).attributes(() -> PsittacosaurusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.PSITTACOSAURUS, 0, 2)).register();
	public static final EntityEntry<RhinesuchusEntity> RHINESUCHUS = REGISTRATE.entity("rhinesuchus", RhinesuchusEntity::new, MobCategory.WATER_CREATURE).properties(properties -> properties.sized(0.5F, 0.5F)).renderer(() -> RhinesuchusRenderer::new).defaultSpawnEgg(0x576b54, 0xaf944a).attributes(() -> RhinesuchusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.RHINESUCHUS, 2, 4)).register();
	public static final EntityEntry<SuchomimusEntity> SUCHOMIMUS = REGISTRATE.entity("suchomimus", SuchomimusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(1.5F, 1.5F)).renderer(() -> SuchomimusRenderer::new).defaultSpawnEgg(0x57737b, 0xcd9528).attributes(() -> SuchomimusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.SUCHOMIMUS, 2, 5)).register();
	public static final EntityEntry<UtahraptorEntity> UTAHRAPTOR = REGISTRATE.entity("utahraptor", UtahraptorEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(1.5F, 1.0F)).renderer(() -> UtahraptorRenderer::new).defaultSpawnEgg(0x503524, 0x635f5e).attributes(() -> UtahraptorEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.UTAHRAPTOR, 1, 4)).register();
	public static final EntityEntry<ThanosEntity> THANOS = REGISTRATE.entity("thanos", ThanosEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(1.5F, 1.5F)).renderer(() -> ThanosRenderer::new).defaultSpawnEgg(0xca2018, 0xa5800b).attributes(() -> ThanosEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.THANOS, 1, 5)).register();
	public static final EntityEntry<TetraceratopsEntity> TETRACERATOPS = REGISTRATE.entity("tetraceratops", TetraceratopsEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(0.75F, 0.5F)).renderer(() -> TetraceratopsRenderer::new).defaultSpawnEgg(0x623015, 0x21369b).attributes(() -> TetraceratopsEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.TETRACERATOPS, 1, 3)).register();
	public static final EntityEntry<TyrannosaurusEntity> TYRANNOSAURUS = REGISTRATE.entity("tyrannosaurus", TyrannosaurusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(2.75F, 2.5F)).renderer(() -> TyrannosaurusRenderer::new).defaultSpawnEgg(0x503524, 0x635f5e).attributes(() -> TyrannosaurusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.TYRANNOSAURUS, 3, 8)).register();
	public static final EntityEntry<ZephyrosaurusEntity> ZEPHYROSAURUS = REGISTRATE.entity("zephyrosaurus", ZephyrosaurusEntity::new, MobCategory.CREATURE).properties(properties -> properties.sized(0.5F, 0.5F)).renderer(() -> ZephyrosaurusRenderer::new).defaultSpawnEgg(0x577476, 0x9ba3a3).attributes(() -> ZephyrosaurusEntity.createAttributes()).spawnPlacement(Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, PrehistoricEntity::canPrehistoricSpawn).tag(LostWorldsTags.ModEntityTypeTags.ANCIENT_CREATURES).loot(dinosaurDrop(DinoTypes.ZEPHYROSAURUS, 1, 3)).register();

	static {
		for (DinoTypes dinos : DinoTypes.values()) {
			if (dinos != DinoTypes.NAUTILUS && dinos != DinoTypes.PALAEONISCUM && dinos != DinoTypes.ANOMALOCARIS) {
				EntityEntry<DirtyFossilEntity> dirtyskull = REGISTRATE.<DirtyFossilEntity>entity("dirty_" + dinos.toString().toLowerCase() + "_skull", (entity, level) -> new DirtyFossilEntity(entity, level).setPick(dinos.getSkullItem().get().getDefaultInstance()), MobCategory.CREATURE).properties(properties -> properties.sized(1.0F, 1.0F)).renderer(() -> manager -> new CustomisableRenderer(manager, dinos.getId() + "_skull", dinos.getId(), 0.5F)).attributes(() -> FossilEntity.createAttributes()).loot((provider, entity) -> provider.add(entity, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(dinos.getPlasteredSkullItem().get()))))).register();
				dinos.setDirtySkull(() -> dirtyskull.get());
				EntityEntry<DirtyFossilEntity> dirtyarmbones = REGISTRATE.<DirtyFossilEntity>entity("dirty_" + dinos.toString().toLowerCase() + "_arm_bones", (entity, level) -> new DirtyFossilEntity(entity, level).setPick(dinos.getArmBonesItem().get().getDefaultInstance()), MobCategory.CREATURE).properties(properties -> properties.sized(1.0F, 1.0F)).renderer(() -> manager -> new CustomisableRenderer(manager, dinos.getId() + "_arm_bones", dinos.getId(), 0.5F)).attributes(() -> FossilEntity.createAttributes()).loot((provider, entity) -> provider.add(entity, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(dinos.getPlasteredArmBonesItem().get()))))).register();
				dinos.setDirtyArmBones(() -> dirtyarmbones.get());
				EntityEntry<DirtyFossilEntity> dirtylegbones = REGISTRATE.<DirtyFossilEntity>entity("dirty_" + dinos.toString().toLowerCase() + "_leg_bones", (entity, level) -> new DirtyFossilEntity(entity, level).setPick(dinos.getLegBonesItem().get().getDefaultInstance()), MobCategory.CREATURE).properties(properties -> properties.sized(1.0F, 1.0F)).renderer(() -> manager -> new CustomisableRenderer(manager, dinos.getId() + "_leg_bones", dinos.getId(), 0.5F)).attributes(() -> FossilEntity.createAttributes()).loot((provider, entity) -> provider.add(entity, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(dinos.getPlasteredLegBonesItem().get()))))).register();
				dinos.setDirtyLegBones(() -> dirtylegbones.get());
				EntityEntry<DirtyFossilEntity> dirtyribcage = REGISTRATE.<DirtyFossilEntity>entity("dirty_" + dinos.toString().toLowerCase() + "_rib_cage", (entity, level) -> new DirtyFossilEntity(entity, level).setPick(dinos.getRibCageItem().get().getDefaultInstance()), MobCategory.CREATURE).properties(properties -> properties.sized(1.0F, 1.0F)).renderer(() -> manager -> new CustomisableRenderer(manager, dinos.getId() + "_rib_cage", dinos.getId(), 0.5F)).attributes(() -> FossilEntity.createAttributes()).loot((provider, entity) -> provider.add(entity, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(dinos.getPlasteredRibCageBonesItem().get()))))).register();
				dinos.setDirtyRibCage(() -> dirtyribcage.get());
				EntityEntry<DirtyFossilEntity> dirtytail = REGISTRATE.<DirtyFossilEntity>entity("dirty_" + dinos.toString().toLowerCase() + "_tail", (entity, level) -> new DirtyFossilEntity(entity, level).setPick(dinos.getTailItem().get().getDefaultInstance()), MobCategory.CREATURE).properties(properties -> properties.sized(1.0F, 1.0F)).renderer(() -> manager -> new CustomisableRenderer(manager, dinos.getId() + "_tail", dinos.getId(), 0.5F)).attributes(() -> FossilEntity.createAttributes()).loot((provider, entity) -> provider.add(entity, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(dinos.getPlasteredTailBonesItem().get()))))).register();
	...
	public static <T extends LivingEntity> NonNullBiConsumer<RegistrateEntityLootTables, EntityType<T>> dinosaurDrop(DinoTypes type, int min, int max) {
		return (provider, entity) -> {
			...
			lootTable.withPool(LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add(LootItem.lootTableItem(type.getMeat().get()).apply(SetItemCountFunction.setCount(RandomValueBounds.between(min, max))).apply(SmeltItemFunction.smelted().when(LootItemEntityPropertyCondition.hasProperties(LootContext.EntityTarget.THIS, EntityPredicate.Builder.entity().flags(EntityFlagsPredicate.Builder.flags().setOnFire(true).build())))).apply(LootingEnchantFunction.lootingMultiplier(RandomValueBounds.between(0.0F, 1.0F)))));
			if (DinoTypes.feathered().contains(type)) {
				lootTable.withPool(LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add(LootItem.lootTableItem(type.getFeather().get()).apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 2.0F))).apply(LootingEnchantFunction.lootingMultiplier(RandomValueBounds.between(0.0F, 1.0F)))));
			}
			if (DinoTypes.createHide().contains(type)) {
				lootTable.withPool(LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add(LootItem.lootTableItem(type.getHide().get()).apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 2.0F))).apply(LootingEnchantFunction.lootingMultiplier(RandomValueBounds.between(0.0F, 1.0F)))));
			}
			if (type == DinoTypes.PALAEONISCUM) {
				lootTable.withPool(LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add(LootItem.lootTableItem(Items.BONE_MEAL)).when(LootItemRandomChanceCondition.randomChance(0.05F)));
			}

...
public class EntitySpawns {
	public static void init(BiomeLoadingEvent event) {
		...
		// Terrestrial
		ArrayList<ResourceLocation> carnotaurusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_ARAUCARIA_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_CONIFER_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_GINKGO_FOREST.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> fukuivenatorBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_ARAUCARIA_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_CONIFER_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_MOUNTAINS.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_ERRODED_MOUNTAINS.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> giganotosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_PLAINS.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_RED_DESERT.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_DESERT.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> ouranosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_PLAINS.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_RED_DESERT.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_SWAMP.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_BOG.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> parksosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_PLAINS.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_ARAUCARIA_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_SWAMP.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_BOG.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> psittacosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_PLAINS.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_ARAUCARIA_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_CONIFER_FOREST.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> suchomimusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_DESERT.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_SWAMP.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> thanosBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_DESERT.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_GAME_TRAIL.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_MEDOW.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> tyrannosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_ARCTIC.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_ARCTIC_SPIRES.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_GAME_TRAIL.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_MEDOW.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_PLAINS.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> utahraptorBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_ARCTIC.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_ARCTIC_SPIRES.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_FROZEN_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_GINKGO_FOREST.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> zephyrosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_PLAINS.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_MARSH.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_FROZEN_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_GINKGO_FOREST.getFirst().get().getRegistryName());
		...
		// Terrestrial
		ArrayList<ResourceLocation> allosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_ARAUCARIA_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_CONIFER_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_GINKGO_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_DESERT.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> chilesaurusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_PLAINS.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_FEN.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_BOG.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_DESERT.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> eustreptospondylusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_BOG.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_FEN.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_REDWOODS_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_MARSH.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_SWAMP.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> kentrosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_PLAINS.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_REDWOODS_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_ARAUCARIA_FOREST.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> liaoningosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_PLAINS.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_GINKGO_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_ARAUCARIA_FOREST.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> ostromiaBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_GINKGO_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_ARAUCARIA_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_REDWOODS_FOREST.getFirst().get().getRegistryName());
		...
		// Semi-Aquatic
		ArrayList<ResourceLocation> protosuchusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_RIVER.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_SHORE.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_SWAMP.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_BOG.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_MARSH.getFirst().get().getRegistryName());
		...
		// Aquatic
		ArrayList<ResourceLocation> ophthalmosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_RIVER.getFirst().get().getRegistryName(), LostWorldsBiomes.JURASSIC_OCEAN.getFirst().get().getRegistryName(), LostWorldsBiomes.WARM_JURASSIC_OCEAN.getFirst().get().getRegistryName());
		...
		// Terrestrial
		ArrayList<ResourceLocation> diictodonBiomes = Lists.newArrayList(LostWorldsBiomes.PERMIAN_DESERT.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> dimetrodonBiomes = Lists.newArrayList(LostWorldsBiomes.PERMIAN_DRIED_PLAINS.getFirst().get().getRegistryName(), LostWorldsBiomes.PERMIAN_CONIFER_FOREST.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> edaphosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.PERMIAN_DRIED_PLAINS.getFirst().get().getRegistryName(), LostWorldsBiomes.PERMIAN_CONIFER_FOREST.getFirst().get().getRegistryName(), LostWorldsBiomes.ARAUCARIA_FOREST.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> tetraceratopsBiomes = Lists.newArrayList(LostWorldsBiomes.PERMIAN_DESERT.getFirst().get().getRegistryName(), LostWorldsBiomes.PERMIAN_GINKGO_FOREST.getFirst().get().getRegistryName());
		...
		// Semi-Aquatic
		ArrayList<ResourceLocation> rhinesuchusBiomes = Lists.newArrayList(LostWorldsBiomes.PERMIAN_DESERT.getFirst().get().getRegistryName());
		...
		ArrayList<ResourceLocation> palaeoniscumBiomes = Lists.newArrayList(LostWorldsBiomes.PERMIAN_OCEAN.getFirst().get().getRegistryName(), LostWorldsBiomes.WARM_PERMIAN_OCEAN.getFirst().get().getRegistryName());

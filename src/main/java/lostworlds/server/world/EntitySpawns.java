...
public class EntitySpawns {
	public static void init(BiomeLoadingEvent event) {
		...
		// Terrestrial
		ArrayList<ResourceLocation> carnotaurusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_ARAUCARIA_FOREST.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_CONIFER_FOREST.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_GINKGO_FOREST.get().getRegistryName());
		...
		ArrayList<ResourceLocation> fukuivenatorBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_ARAUCARIA_FOREST.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_CONIFER_FOREST.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_MOUNTAINS.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_ERRODED_MOUNTAINS.get().getRegistryName());
		...
		ArrayList<ResourceLocation> giganotosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_PLAINS.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_RED_DESERT.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_DESERT.get().getRegistryName());
		...
		ArrayList<ResourceLocation> ouranosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_PLAINS.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_RED_DESERT.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_SWAMP.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_BOG.get().getRegistryName());
		...
		ArrayList<ResourceLocation> parksosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_PLAINS.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_ARAUCARIA_FOREST.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_SWAMP.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_BOG.get().getRegistryName());
		...
		ArrayList<ResourceLocation> psittacosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_PLAINS.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_ARAUCARIA_FOREST.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_CONIFER_FOREST.get().getRegistryName());
		...
		ArrayList<ResourceLocation> suchomimusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_DESERT.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_SWAMP.get().getRegistryName());
		...
		ArrayList<ResourceLocation> thanosBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_DESERT.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_GAME_TRAIL.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_MEDOW.get().getRegistryName());
		...
		ArrayList<ResourceLocation> tyrannosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_ARCTIC.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_ARCTIC_SPIRES.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_GAME_TRAIL.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_MEDOW.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_PLAINS.get().getRegistryName());
		...
		ArrayList<ResourceLocation> utahraptorBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_ARCTIC.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_ARCTIC_SPIRES.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_FROZEN_FOREST.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_GINKGO_FOREST.get().getRegistryName());
		...
		ArrayList<ResourceLocation> zephyrosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.CRETACEOUS_PLAINS.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_MARSH.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_FROZEN_FOREST.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_GINKGO_FOREST.get().getRegistryName());
		...
		// Terrestrial
		ArrayList<ResourceLocation> allosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_ARAUCARIA_FOREST.get().getRegistryName(), LostWorldsBiomes.JURASSIC_CONIFER_FOREST.get().getRegistryName(), LostWorldsBiomes.JURASSIC_GINKGO_FOREST.get().getRegistryName(), LostWorldsBiomes.JURASSIC_DESERT.get().getRegistryName());
		...
		ArrayList<ResourceLocation> chilesaurusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_PLAINS.get().getRegistryName(), LostWorldsBiomes.JURASSIC_FEN.get().getRegistryName(), LostWorldsBiomes.JURASSIC_BOG.get().getRegistryName(), LostWorldsBiomes.JURASSIC_DESERT.get().getRegistryName());
		...
		ArrayList<ResourceLocation> cryolophosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_WINDSWEPT_HILLS.get().getRegistryName(), LostWorldsBiomes.JURASSIC_ERRODED_WINDSWEPT_HILLS.get().getRegistryName());
		...
		ArrayList<ResourceLocation> dilophosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_WINDSWEPT_HILLS.get().getRegistryName(), LostWorldsBiomes.JURASSIC_ERRODED_WINDSWEPT_HILLS.get().getRegistryName(), LostWorldsBiomes.JURASSIC_REDWOODS_FOREST.get().getRegistryName(), LostWorldsBiomes.JURASSIC_CONIFER_FOREST.get().getRegistryName());
		...
		ArrayList<ResourceLocation> eustreptospondylusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_BOG.get().getRegistryName(), LostWorldsBiomes.JURASSIC_FEN.get().getRegistryName(), LostWorldsBiomes.JURASSIC_REDWOODS_FOREST.get().getRegistryName(), LostWorldsBiomes.CRETACEOUS_MARSH.get().getRegistryName(), LostWorldsBiomes.JURASSIC_SWAMP.get().getRegistryName());
		...
		ArrayList<ResourceLocation> kentrosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_PLAINS.get().getRegistryName(), LostWorldsBiomes.JURASSIC_REDWOODS_FOREST.get().getRegistryName(), LostWorldsBiomes.JURASSIC_ARAUCARIA_FOREST.get().getRegistryName());
		...
		ArrayList<ResourceLocation> liaoningosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_PLAINS.get().getRegistryName(), LostWorldsBiomes.JURASSIC_GINKGO_FOREST.get().getRegistryName(), LostWorldsBiomes.JURASSIC_ARAUCARIA_FOREST.get().getRegistryName());
		...
		ArrayList<ResourceLocation> ostromiaBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_GINKGO_FOREST.get().getRegistryName(), LostWorldsBiomes.JURASSIC_ARAUCARIA_FOREST.get().getRegistryName(), LostWorldsBiomes.JURASSIC_REDWOODS_FOREST.get().getRegistryName());
		...
		// Aquatic
		ArrayList<ResourceLocation> ophthalmosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_RIVER.get().getRegistryName(), LostWorldsBiomes.JURASSIC_OCEAN.get().getRegistryName(), LostWorldsBiomes.WARM_JURASSIC_OCEAN.get().getRegistryName());
		...
		// Terrestrial
		ArrayList<ResourceLocation> diictodonBiomes = Lists.newArrayList(LostWorldsBiomes.PERMIAN_DESERT.get().getRegistryName());
		...
		ArrayList<ResourceLocation> dimetrodonBiomes = Lists.newArrayList(LostWorldsBiomes.PERMIAN_DRIED_PLAINS.get().getRegistryName(), LostWorldsBiomes.PERMIAN_CONIFER_FOREST.get().getRegistryName());
		...
		ArrayList<ResourceLocation> edaphosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.PERMIAN_DRIED_PLAINS.get().getRegistryName(), LostWorldsBiomes.PERMIAN_CONIFER_FOREST.get().getRegistryName(), LostWorldsBiomes.ARAUCARIA_FOREST.get().getRegistryName());
		...
		ArrayList<ResourceLocation> gorgonopsBiomes = Lists.newArrayList(LostWorldsBiomes.PERMIAN_DESERT.get().getRegistryName(), LostWorldsBiomes.PERMIAN_WINDSWEPT_HILLS.get().getRegistryName());
		...
		ArrayList<ResourceLocation> tetraceratopsBiomes = Lists.newArrayList(LostWorldsBiomes.PERMIAN_DESERT.get().getRegistryName(), LostWorldsBiomes.PERMIAN_GINKGO_FOREST.get().getRegistryName());
		...
		// Semi-Aquatic
		ArrayList<ResourceLocation> rhinesuchusBiomes = Lists.newArrayList(LostWorldsBiomes.PERMIAN_DESERT.get().getRegistryName());
		...
		ArrayList<ResourceLocation> palaeoniscumBiomes = Lists.newArrayList(LostWorldsBiomes.PERMIAN_OCEAN.get().getRegistryName(), LostWorldsBiomes.WARM_PERMIAN_OCEAN.get().getRegistryName());

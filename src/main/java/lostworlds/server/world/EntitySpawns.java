...
public class EntitySpawns {
	public static void init(BiomeLoadingEvent event) {
		...
		if (carnotaurusBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.CARNOTAURUS.get(), LostWorldsConfig.COMMON_CONFIG.carnotaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.carnotaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.carnotaurusSpawnGroupMaximum.get());
		}
		...
		if (fukuivenatorBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.FUKUIVENATOR.get(), LostWorldsConfig.COMMON_CONFIG.fukuivenatorSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.fukuivenatorSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.fukuivenatorSpawnGroupMaximum.get());
		}
		...
		if (giganotosaurusBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.GIGANOTOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.giganotosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.giganotosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.giganotosaurusSpawnGroupMaximum.get());
		}
		...
		if (suchomimusBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.SUCHOMIMUS.get(), LostWorldsConfig.COMMON_CONFIG.suchomimusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.suchomimusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.suchomimusSpawnGroupMaximum.get());
		}
		...
		if (thanosBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.THANOS.get(), LostWorldsConfig.COMMON_CONFIG.thanosSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.thanosSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.thanosSpawnGroupMaximum.get());
		}
		...
		if (tyrannosaurusBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.TYRANNOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.tyrannosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.tyrannosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.tyrannosaurusSpawnGroupMaximum.get());
		}
		...
		if (utahraptorBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.UTAHRAPTOR.get(), LostWorldsConfig.COMMON_CONFIG.utahraptorSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.utahraptorSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.utahraptorSpawnGroupMaximum.get());
		}
		...
		if (allosaurusBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.ALLOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.allosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.allosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.allosaurusSpawnGroupMaximum.get());
		}
		...
		if (chilesaurusBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.CHILESAURUS.get(), LostWorldsConfig.COMMON_CONFIG.chilesaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.chilesaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.chilesaurusSpawnGroupMaximum.get());
		}
		...
		if (cryolophosaurusBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.CRYOLOPHOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.cryolophosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.cryolophosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.cryolophosaurusSpawnGroupMaximum.get());
		}
		...
		if (kentrosaurusBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.KENTROSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.kentrosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.kentrosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.kentrosaurusSpawnGroupMaximum.get());
		}
		...
		if (liaoningosaurusBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.LIAONINGOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.liaoningosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.liaoningosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.liaoningosaurusSpawnGroupMaximum.get());
		}
		...
		if (ostromiaBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.OSTROMIA.get(), LostWorldsConfig.COMMON_CONFIG.ostromiaSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.ostromiaSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.ostromiaSpawnGroupMaximum.get());
		}
		...
		if (protosuchusBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.PROTOSUCHUS.get(), LostWorldsConfig.COMMON_CONFIG.protosuchusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.protosuchusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.protosuchusSpawnGroupMaximum.get());
		}
		...
		if (ophthalmosaurusBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.OPHTHALMOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.ophthalmosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.ophthalmosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.ophthalmosaurusSpawnGroupMaximum.get());
		}
		...
		if (diictodonBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.DIICTODON.get(), LostWorldsConfig.COMMON_CONFIG.diictodonSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.diictodonSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.diictodonSpawnGroupMaximum.get());
		}
		...
		if (gorgonopsBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.GORGONOPS.get(), LostWorldsConfig.COMMON_CONFIG.gorgonopsSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.gorgonopsSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.gorgonopsSpawnGroupMaximum.get());
		}
		...
		if (tetraceratopsBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.TETRACERATOPS.get(), LostWorldsConfig.COMMON_CONFIG.tetraceratopsSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.tetraceratopsSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.tetraceratopsSpawnGroupMaximum.get());
		}
		...
		if (rhinesuchusBiomes.contains(event.getName())) {
			FeatureAdder.addSpawn(event, EntityClassification.CREATURE, LostWorldsEntities.RHINESUCHUS.get(), LostWorldsConfig.COMMON_CONFIG.rhinesuchusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.rhinesuchusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.rhinesuchusSpawnGroupMaximum.get());
		}

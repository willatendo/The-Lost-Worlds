	...
	public static void init(BiomeLoadingEvent event) {
		if (LostWorldsUtils.SERVER_CONFIG.livingFossils.get()) {
			...
			if (nautilusBiomes.contains(event.getName().toString())) {
				BiomeLoadingEventHelper.addSpawn(event, MobCategory.WATER_CREATURE, LostWorldsEntities.NAUTILUS.get(), LostWorldsUtils.SERVER_CONFIG.nautilusSpawnWeight.get(), LostWorldsUtils.SERVER_CONFIG.nautilusSpawnGroupMinimum.get(), LostWorldsUtils.SERVER_CONFIG.nautilusSpawnGroupMaximum.get());
			}
		}
		...
		if (carnotaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.CARNOTAURUS.get(), LostWorldsConfig.COMMON_CONFIG.carnotaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.carnotaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.carnotaurusSpawnGroupMaximum.get());
		}
		...
		if (fukuivenatorBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.FUKUIVENATOR.get(), LostWorldsConfig.COMMON_CONFIG.fukuivenatorSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.fukuivenatorSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.fukuivenatorSpawnGroupMaximum.get());
		}
		...
		if (giganotosaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.GIGANOTOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.giganotosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.giganotosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.giganotosaurusSpawnGroupMaximum.get());
		}
		...
		if (ouranosaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.OURANOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.ouranosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.ouranosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.ouranosaurusSpawnGroupMaximum.get());
		}
		...
		if (parksosaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.PARKSOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.parksosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.parksosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.parksosaurusSpawnGroupMaximum.get());
		}
		...
		if (psittacosaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.PSITTACOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.psittacosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.psittacosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.psittacosaurusSpawnGroupMaximum.get());
		}
		...
		if (suchomimusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.SUCHOMIMUS.get(), LostWorldsConfig.COMMON_CONFIG.suchomimusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.suchomimusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.suchomimusSpawnGroupMaximum.get());
		}
		...
		if (thanosBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.THANOS.get(), LostWorldsConfig.COMMON_CONFIG.thanosSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.thanosSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.thanosSpawnGroupMaximum.get());
		}
		...
		if (tyrannosaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.TYRANNOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.tyrannosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.tyrannosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.tyrannosaurusSpawnGroupMaximum.get());
		}
		...
		if (utahraptorBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.UTAHRAPTOR.get(), LostWorldsConfig.COMMON_CONFIG.utahraptorSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.utahraptorSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.utahraptorSpawnGroupMaximum.get());
		}
		...
		if (zephyrosaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.ZEPHYROSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.zephyrosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.zephyrosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.zephyrosaurusSpawnGroupMaximum.get());
		}
		...
		if (allosaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.ALLOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.allosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.allosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.allosaurusSpawnGroupMaximum.get());
		}
		...
		if (chilesaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.CHILESAURUS.get(), LostWorldsConfig.COMMON_CONFIG.chilesaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.chilesaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.chilesaurusSpawnGroupMaximum.get());
		}
		...
		if (cryolophosaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.CRYOLOPHOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.cryolophosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.cryolophosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.cryolophosaurusSpawnGroupMaximum.get());
		}
		...
		if (dilophosaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.DILOPHOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.dilophosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.dilophosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.dilophosaurusSpawnGroupMaximum.get());
		}
		...
		if (eustreptospondylusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.EUSTREPTOSPONDYLUS.get(), LostWorldsConfig.COMMON_CONFIG.eustreptospondylusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.eustreptospondylusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.eustreptospondylusSpawnGroupMaximum.get());
		}
		...
		if (kentrosaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.KENTROSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.kentrosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.kentrosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.kentrosaurusSpawnGroupMaximum.get());
		}
		...
		if (liaoningosaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.LIAONINGOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.liaoningosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.liaoningosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.liaoningosaurusSpawnGroupMaximum.get());
		}
		...
		if (ostromiaBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.OSTROMIA.get(), LostWorldsConfig.COMMON_CONFIG.ostromiaSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.ostromiaSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.ostromiaSpawnGroupMaximum.get());
		}
		...
		if (protosuchusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.PROTOSUCHUS.get(), LostWorldsConfig.COMMON_CONFIG.protosuchusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.protosuchusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.protosuchusSpawnGroupMaximum.get());
		}
		...
		if (ophthalmosaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.OPHTHALMOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.ophthalmosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.ophthalmosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.ophthalmosaurusSpawnGroupMaximum.get());
		}

		ArrayList<ResourceLocation> cryptoclidusBiomes = Lists.newArrayList(LostWorldsBiomes.JURASSIC_RIVER.getRegistryName(), LostWorldsBiomes.JURASSIC_OCEAN.getRegistryName(), LostWorldsBiomes.WARM_JURASSIC_OCEAN.getRegistryName());
		if (cryptoclidusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.CRYPTOCLIDUS.get(), LostWorldsConfig.COMMON_CONFIG.cryptoclidusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.cryptoclidusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.cryptoclidusSpawnGroupMaximum.get());
		}
		...
		if (dimetrodonBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.DIMETRODON.get(), LostWorldsConfig.COMMON_CONFIG.dimetrodonSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.dimetrodonSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.dimetrodonSpawnGroupMaximum.get());
		}
		...
		ArrayList<ResourceLocation> mesosaurusBiomes = Lists.newArrayList(LostWorldsBiomes.PERMIAN_RIVER.getRegistryName());
		if (mesosaurusBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.MESOSAURUS.get(), LostWorldsConfig.COMMON_CONFIG.mesosaurusSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.mesosaurusSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.mesosaurusSpawnGroupMaximum.get());
		}
		...
		if (palaeoniscumBiomes.contains(event.getName())) {
			BiomeLoadingEventHelper.addSpawn(event, MobCategory.CREATURE, LostWorldsEntities.PALAEONISCUM.get(), LostWorldsConfig.COMMON_CONFIG.palaeoniscumSpawnWeight.get(), LostWorldsConfig.COMMON_CONFIG.palaeoniscumSpawnGroupMinimum.get(), LostWorldsConfig.COMMON_CONFIG.palaeoniscumSpawnGroupMaximum.get());
		}

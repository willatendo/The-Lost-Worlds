...
public class LostWorldsStructureSets {
	...
	public static final Holder<StructureSet> TRACE_FOSSIL = register(TRACE_FOSSIL_KEY, LostWorldsConfiguredStructures.CONFIGURED_TRACE_FOSSIL, new RandomSpreadStructurePlacement(32, 8, RandomSpreadType.LINEAR, LostWorldsConfig.COMMON_CONFIG.traceFossilGenerationId.get()));

	...
	public static class Piece extends TemplateStructurePiece {
		...
		protected void handleDataMarker(String data, BlockPos pos, IServerWorld world, Random rand, MutableBoundingBox box) {
			if ("fossil_poacher_spawn".equals(data)) {
				...
				FossilPoacherEntity entity = LostWorldsEntities.FOSSIL_POACHER.create((World) world.getLevel());
			...
			if ("black_market_loot".equals(data)) {
				...
				if (tileentity instanceof BarrelTileEntity) {
					((BarrelTileEntity) tileentity).setLootTable(LostWorldsUtils.rL("chests/black_market_loot"), rand.nextLong());
				}
			}
		}

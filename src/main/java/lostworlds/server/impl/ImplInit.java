...
import lostworlds.server.impl.block.softdirt.AbsalomichthysFossilDirtFunction;
...
import lostworlds.server.impl.block.softstone.AbsalomichthysFossilStoneFunction;
...
public class ImplInit {
	public static void init() {
		// APISoftDirtFunction
		SOFT_DIRT_FUNCTIONS.add(new AbsalomichthysFossilDirtFunction());
		...
		SOFT_STONE_FUNCTIONS.add(new AbsalomichthysFossilStoneFunction());

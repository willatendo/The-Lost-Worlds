...
public class FossilGrinderCategory implements IRecipeCategory<FossilGrinderRecipe>
{
	...
	public FossilGrinderCategory(IGuiHelper helper) 
	{
		...
		this.icon = helper.createDrawableIngredient(new ItemStack(LostWorldsBlocks.FOSSIL_GRINDER));
	...
	{
		return LostWorldsUtils.tTC("jei", "fossil_grinder.title").getString();
	}
	...
	{
		TranslationTextComponent name = LostWorldsUtils.tTC("jei", "fossil_grinder.chance");

...
public class PaleontologyTableCategory implements IRecipeCategory<PaleontologyTableRecipe> {
	...
	public PaleontologyTableCategory(IGuiHelper helper) {
		...
		this.icon = helper.createDrawableIngredient(new ItemStack(LostWorldsBlocks.PALEONTOLOGY_TABLE));
	...
	public String getTitle() {
		return LostWorldsUtils.tTC("jei", "paleontology_table.title").getString();
	}
	...
	@Override
	public void setIngredients(PaleontologyTableRecipe recipe, IIngredients ingredients) {
		ingredients.setInputIngredients(recipe.getIngredients());
		ingredients.setOutputs(VanillaTypes.ITEM, recipe.getOutput());
	}

	@Override
	public void setRecipe(IRecipeLayout recipeLayout, PaleontologyTableRecipe recipe, IIngredients ingredients) {

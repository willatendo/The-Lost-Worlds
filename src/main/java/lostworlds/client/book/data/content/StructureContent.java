...
import lostworlds.client.book.screen.book.ArrowButton;
import lostworlds.client.book.screen.book.BookScreen;
import lostworlds.client.book.screen.book.element.AnimationToggleElement;
import lostworlds.client.book.screen.book.element.BookElement;
import lostworlds.client.book.screen.book.element.StructureElement;
...
public class StructureContent extends PageContent {
	public static final transient ResourceLocation ID = LostWorldsUtils.rL("structure");

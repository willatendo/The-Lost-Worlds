...
import lostworlds.client.books.tyrannibook.client.structure.StructureInfo;
import lostworlds.client.books.tyrannibook.client.structure.world.TemplateWorld;

...
@OnlyIn(Dist.CLIENT)
public class CultivatorScreen extends AbstractContainerScreen<CultivatorContainer> {
	private static final ResourceLocation TEXTURE = LostWorldsUtils.rL("textures/gui/machines/cultivator.png");

	public CultivatorScreen(CultivatorContainer container, Inventory playerInv, Component text) {

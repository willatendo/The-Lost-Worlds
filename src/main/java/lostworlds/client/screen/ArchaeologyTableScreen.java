...
@OnlyIn(Dist.CLIENT)
public class ArchaeologyTableScreen extends AbstractContainerScreen<ArchaeologyTableContainer> {
	private static final ResourceLocation TEXTURE = new ResourceLocation("textures/gui/container/crafting_table.png");

	public ArchaeologyTableScreen(ArchaeologyTableContainer container, Inventory playerInv, Component text) {

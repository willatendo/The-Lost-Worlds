...
public class ThanosRenderer extends GeoEntityRenderer<ThanosEntity> {
	...
	@Override
	public RenderType getRenderType(ThanosEntity animatable, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLight, ResourceLocation textureLocation) {

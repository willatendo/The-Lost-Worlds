...
public class DilophosaurusRenderer extends TyrannomationEntityRenderer<DilophosaurusEntity> {
	...
	@Override
	public RenderType getRenderType(DilophosaurusEntity animatable, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLight, ResourceLocation textureLocation) {

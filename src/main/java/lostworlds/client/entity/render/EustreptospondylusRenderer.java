...
public class EustreptospondylusRenderer extends GeoEntityRenderer<EustreptospondylusEntity> {
	...
	@Override
	public RenderType getRenderType(EustreptospondylusEntity animatable, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLight, ResourceLocation textureLocation) {

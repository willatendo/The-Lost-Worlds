...
public class VillagerProfessionInit {
	...
	// ModRegistry.register("paleobotanist", new VillagerProfession("paleobotanist",
	// PointOfInterestInit.PALEOBOTANY_TABLE, ImmutableSet.of(), ImmutableSet.of(),
	// SoundEvents.VILLAGER_WORK_TOOLSMITH));

	// Registry
	public static void init() {
		ModUtils.LOGGER.debug("Registering Mod Villager Professions");
	}
}

...
public class BlockInit {
	...
	public static final Block MUD = BlockUtils.create("mud", new Block(AbstractBlock.Properties.of(Material.CLAY, MaterialColor.COLOR_BROWN).harvestTool(ToolType.SHOVEL).strength(0.6F).sound(SoundType.GRAVEL)));
	...
	public static final Block VOLCANIC_ASH = BlockUtils.create("volcanic_ash", new VolcanicAshBlock());
	public static final Block VOLCANIC_ASH_LAYER = BlockUtils.create("volcanic_ash_layer", new VolcanicAshLayerBlock());
	...
	public static final Block PERMIAN_STONE_STAIRS = BlockUtils.create("permian_stone_stairs", new StairsBlock(() -> BlockInit.PERMIAN_STONE.defaultBlockState(), AbstractBlock.Properties.of(Material.STONE, MaterialColor.STONE).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	...
	public static final Block PERMIAN_COBBLESTONE_STAIRS = BlockUtils.create("permian_cobblestone_stairs", new StairsBlock(() -> BlockInit.PERMIAN_STONE.defaultBlockState(), AbstractBlock.Properties.of(Material.STONE, MaterialColor.STONE).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	...
	public static final Block PERMIAN_STONE_BRICK_STAIRS = BlockUtils.create("permian_stone_brick_stairs", new StairsBlock(() -> BlockInit.PERMIAN_STONE_BRICKS.defaultBlockState(), AbstractBlock.Properties.of(Material.STONE, MaterialColor.STONE).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	...
	public static final Block JURASSIC_STONE_STAIRS = BlockUtils.create("jurassic_stone_stairs", new StairsBlock(() -> BlockInit.JURASSIC_STONE.defaultBlockState(), AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(3.0F)));
	...
	public static final Block JURASSIC_COBBLESTONE_STAIRS = BlockUtils.create("jurassic_cobblestone_stairs", new StairsBlock(() -> BlockInit.JURASSIC_COBBLESTONE.defaultBlockState(), AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(3.0F)));
	...
	public static final Block LATERLITE_STAIRS = BlockUtils.create("laterlite_stairs", new StairsBlock(() -> BlockInit.LATERLITE.defaultBlockState(), AbstractBlock.Properties.of(Material.STONE, MaterialColor.DIRT).requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	...
	public static final Block POLISHED_LATERLITE_STAIRS = BlockUtils.create("polished_laterlite_stairs", new StairsBlock(() -> BlockInit.LATERLITE.defaultBlockState(), AbstractBlock.Properties.of(Material.STONE, MaterialColor.DIRT).requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	...
	public static final Block RAW_MARBLE_STAIRS = BlockUtils.create("raw_marble_stairs", new StairsBlock(() -> BlockInit.RAW_MARBLE.defaultBlockState(), AbstractBlock.Properties.of(Material.STONE, MaterialColor.DIRT).requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	...
	public static final Block MARBLE_STAIRS = BlockUtils.create("marble_stairs", new StairsBlock(() -> BlockInit.MARBLE.defaultBlockState(), AbstractBlock.Properties.of(Material.STONE, MaterialColor.DIRT).requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	...
	public static final Block LIMESTONE_STAIRS = BlockUtils.create("limestone_stairs", new StairsBlock(() -> BlockInit.LIMESTONE.defaultBlockState(), AbstractBlock.Properties.of(Material.STONE, MaterialColor.DIRT).requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	...
	public static final Block POLISHED_LIMESTONE_STAIRS = BlockUtils.create("polished_limestone_stairs", new StairsBlock(() -> BlockInit.POLISHED_LIMESTONE.defaultBlockState(), AbstractBlock.Properties.of(Material.STONE, MaterialColor.DIRT).requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	...
	public static final Block ARAUCARIA_STAIRS = BlockUtils.create("araucaria_stairs", new StairsBlock(() -> BlockInit.ARAUCARIA_PLANKS.defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final Block CALAMITES_STAIRS = BlockUtils.create("calamites_stairs", new StairsBlock(() -> BlockInit.CONIFER_PLANKS.defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final Block CONIFER_STAIRS = BlockUtils.create("conifer_stairs", new StairsBlock(() -> BlockInit.CONIFER_PLANKS.defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final Block CYPRESS_STAIRS = BlockUtils.create("cypress_stairs", new StairsBlock(() -> BlockInit.CYPRESS_PLANKS.defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final Block GINKGO_STAIRS = BlockUtils.create("ginkgo_stairs", new StairsBlock(() -> BlockInit.CONIFER_PLANKS.defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final Block SCORCHED_STAIRS = BlockUtils.create("scorched_stairs", new StairsBlock(() -> BlockInit.SCORCHED_PLANKS.defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final Block SEQUOIA_STAIRS = BlockUtils.create("sequoia_stairs", new StairsBlock(() -> BlockInit.CONIFER_PLANKS.defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_RED).harvestTool(ToolType.AXE).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final Block SPONGE_COLONY = BlockUtils.create("sponge_colony", new SpongeColonyBlock(AbstractBlock.Properties.of(Material.STONE, MaterialColor.STONE).requiresCorrectToolForDrops().noOcclusion().strength(1.5F, 6.0F).sound(SoundType.CORAL_BLOCK), () -> BlockInit.DEAD_SPONGE_COLONY));
	...
	public static final Block WOODEN_PLANKS_STAIRS = BlockUtils.create("wooden_planks_stairs", new StairsBlock(() -> BlockInit.WOODEN_PLANKS.defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).harvestTool(ToolType.AXE).harvestLevel(0).strength(1.2F, 0.5F).sound(SoundType.WOOD)));
	...
	public static final Block ACCENT_DARK_CONCRETE_STAIRS = BlockUtils.create("accent_dark_concrete_stairs", new StairsBlock(() -> BlockInit.DARK_CONCRETE.defaultBlockState(), AbstractBlock.Properties.of(Material.STONE, MaterialColor.STONE).harvestTool(ToolType.PICKAXE).harvestLevel(2).requiresCorrectToolForDrops().strength(8.5F, 10.5F).sound(SoundType.STONE)));
	...
	public static final Block TILE_STAIRS = BlockUtils.create("tile_stairs", new StairsBlock(() -> BlockInit.TILE.defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).harvestTool(ToolType.AXE).harvestLevel(0).strength(2.7F, 1.9F).sound(SoundType.WOOD)));
	...
	public static final Block PAVEMENT_SLOPE = BlockUtils.create("pavement_slope", new StairsBlock(() -> BlockInit.PAVEMENT.defaultBlockState(), AbstractBlock.Properties.of(Material.STONE, MaterialColor.TERRACOTTA_LIGHT_GRAY).harvestTool(ToolType.PICKAXE).harvestLevel(1).requiresCorrectToolForDrops().strength(3.0F).sound(SoundType.STONE)));
	...
	public static void init() {
		...
		for (DinoTypes types : DinoTypes.eggLaying()) {
			Block egg = BlockUtils.createEgg(types.getId() + "_egg", types.getEgg(types.getEntityType()), ModUtils.tTC("entity", types.name().toLowerCase()));
			types.setEgg(egg);
		}

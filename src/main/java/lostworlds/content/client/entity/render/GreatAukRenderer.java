...
import lostworlds.content.client.entity.model.GreatAukModel;
...
public class GreatAukRenderer extends TyrannomationEntityRenderer<GreatAukEntity>
{
	...
	@Override
	public void render(GreatAukEntity entity, float entityYaw, float partialTicks, MatrixStack stack, IRenderTypeBuffer bufferIn, int packedLightIn) 
	{
		if(entity.isBaby())
		{

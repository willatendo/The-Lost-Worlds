...
import lostworlds.content.client.entity.model.LiaoningosaurusModel;
...
@OnlyIn(Dist.CLIENT)
public class LiaoningosaurusRenderer extends TyrannomationEntityRenderer<LiaoningosaurusEntity> {
	...
	@Override
	public RenderType getRenderType(LiaoningosaurusEntity animatable, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLight, ResourceLocation textureLocation) {

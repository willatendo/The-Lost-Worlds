...
import lostworlds.content.client.entity.model.ProcompsognathusModel;
...
public class ProcompsognathusRenderer extends TyrannomationEntityRenderer<ProcompsognathusEntity> {
	...
	@Override
	public RenderType getRenderType(ProcompsognathusEntity animatable, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLight, ResourceLocation textureLocation) {

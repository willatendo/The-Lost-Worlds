...
import lostworlds.content.client.entity.model.SuchomimusModel;
...
@OnlyIn(Dist.CLIENT)
public class SuchomimusRenderer extends TyrannomationEntityRenderer<SuchomimusEntity>
{
	public SuchomimusRenderer(EntityRendererManager renderManager) 
	{

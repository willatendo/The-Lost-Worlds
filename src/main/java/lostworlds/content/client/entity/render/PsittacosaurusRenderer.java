...
import lostworlds.content.client.entity.model.PsittacosaurusModel;
...
@OnlyIn(Dist.CLIENT)
public class PsittacosaurusRenderer extends TyrannomationEntityRenderer<PsittacosaurusEntity> {

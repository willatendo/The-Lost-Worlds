...
import lostworlds.content.client.entity.model.RhinesuchusModel;
...
@OnlyIn(Dist.CLIENT)
public class RhinesuchusRenderer extends TyrannomationEntityRenderer<RhinesuchusEntity> {
	...
	@Override
	public RenderType getRenderType(RhinesuchusEntity animatable, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLight, ResourceLocation textureLocation) {

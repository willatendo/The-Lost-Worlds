...
import lostworlds.content.client.entity.model.DimetrodonModel;
...
public class DimetrodonRenderer extends TyrannomationEntityRenderer<DimetrodonEntity> {
	...
	@Override
	public RenderType getRenderType(DimetrodonEntity animatable, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLight, ResourceLocation textureLocation) {

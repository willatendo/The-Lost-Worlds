...
public class CryolophosaurusRenderer extends TyrannomationEntityRenderer<CryolophosaurusEntity> {
	...
	@Override
	public RenderType getRenderType(CryolophosaurusEntity animatable, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLight, ResourceLocation textureLocation) {

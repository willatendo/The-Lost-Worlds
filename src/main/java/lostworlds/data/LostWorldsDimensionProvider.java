...
public class LostWorldsDimensionProvider extends DimensionProvider {
	...
	public void makeDimensions(Consumer<DimensionBuilder> consumer) {
		...
		this.addDimension(new DimensionBuilder("jurassic", false, true, 1.0F, true, false, 0, false, true, false, false, 384, 384, -64, BlockTags.INFINIBURN_OVERWORLD, "lostworlds:jurassic"), consumer);
		this.addDimension(new DimensionBuilder("permian", false, true, 1.0F, true, false, 0, false, true, false, false, 384, 384, -64, BlockTags.INFINIBURN_OVERWORLD, "lostworlds:permian"), consumer);
	}
}

...
public class LostWorldsBookProvider extends BookProvider {
	...
	public void makeBooks(Consumer<BookBuilder> consumer) {
		consumer.accept(new BookBuilder("field_guide", "Field Guide", "By Willatendo", 4546862)
			.addSections(new SectionBuilder("modern", DinoTypes.GREAT_AUK.getSkeletonPick().get())
				.addPages(new TextPageBuilder("great_auk").addTitle("Pinguinus impennis - Great Auk")
						.addFirst("The Great Auk, a large auk from the Neogene to Holocene. This large auk spaned across the North Pacific ocean. It had the odd predators like Polar Bears and Humans.")
						.addNext("The Great Auk was 80 centimeters tall. It would've hunted fish. Humans traded thier parts all across North America and Europe."))
				.addPages(new TextPageBuilder("greak_auk_info")
						.addFirst("Danger: Minimal")
						.addNext("Diet: Piscivore").
						addNext("Range: Neogene - Late Holocene")
						.addNext("Order: Charadriiformes")
						.addNext("Family: Alcidae")
						.addNext("Genus: Pinguinus")))
			...
			.addSections(new SectionBuilder("jurassic", DinoTypes.ALLOSAURUS.getSkeletonPick().get())
				...
				.addPages(new TextPageBuilder("allosaurus_info")
						.addFirst("Danger: Large")
						.addNext("Diet: Carnivore")
						.addNext("Range: Jurassic - 155-145 mya")
						.addNext("Clade: Dinosauria")
						.addNext("Clade: Saurischia")
						.addNext("Clade: Theropoda")
						.addNext("Family: Allosauridae")
						.addNext("Subfamily: Allosaurinae")
						.addNext("Genus: Allosaurus"))
				/* Chilesaurus */
				.addPages(new TextPageBuilder("chilesaurus").addTitle("Chilesaurus diegosuarezi")
				...
				.addPages(new TextPageBuilder("chilesaurus_info")
						.addFirst("Danger: Passive")
						.addNext("Diet: Herbivore")
						.addNext("Range: Jurassic - 165 mya")
						.addNext("Clade: Dinosauria")
						.addNext("Genus: Chilesaurus"))
				/* Cryolophosaurus */
				.addPages(new TextPageBuilder("cryolophosaurus").addTitle("Cryolophosaurus ellioti")
				...
				.addPages(new TextPageBuilder("cryolophosaurus_info")
						.addFirst("Danger: Timid")
						.addNext("Diet: Carnivore")
						.addNext("Range: Jurassic - 190-186 mya")
						.addNext("Clade: Dinosauria")
						.addNext("Clade: Eusaurischia")
						.addNext("Clade: Theropoda")
						.addNext("Clade: Neotheropoda")
						.addNext("Genus: Cryolophosaurus"))
				/* Dilophosaurus */
				.addPages(new TextPageBuilder("dilophosaurus").addTitle("Dilophosaurus wetherilli")
						...
						.addNext("Dilophosaurus was 7 meters from nose to tail. It would've hunted down large game, and would be a mighty fow, thought it was solitary."))
				.addPages(new TextPageBuilder("dilophosaurus_info")
						.addFirst("Danger: Aggressive")
						.addNext("Diet: Carnivore")
						.addNext("Range: Jurassic - 193 mya")
						.addNext("Clade: Dinosauria")
						.addNext("Clade: Saurischia")
						.addNext("Clade: Theropoda")
						.addNext("Genus: Dilophosaurus"))
				/* Eustreptospondylus */
				.addPages(new TextPageBuilder("eustreptospondylus").addTitle("Eustreptospondylus oxoniensis")
						.addFirst("Eustreptospondylus, a medium theropod from England. This large dinosaur was fierce carnivore. First discovered in 1870, it was described in 1871 with no name util 1890, when it was labled a species of Megalosaurus.")
						.addNext("Eustreptospondylus was 6 meters from nose to tail."))
				.addPages(new TextPageBuilder("eustreptospondylus_info")
						.addFirst("Danger: Aggressive")
						.addNext("Diet: Carnivore")
						.addNext("Range: Jurassic - 163–154 mya")
						.addNext("Clade: Dinosauria")
						.addNext("Clade: Saurischia")
						.addNext("Clade: Theropoda")
						.addNext("Family: Megalosauridae")
						.addNext("Subfamily: Eustreptospondylinae")
						.addNext("Genus: Eustreptospondylus"))
				/* Kentrosaurus */
				.addPages(new TextPageBuilder("kentrosaurus").addTitle("Kentrosaurus aethiopicus")
						.addFirst("Kentrosaurus, a medium stegosaurid from Tanzania from the Tendaguru Formation. From stegosauridae, it's oftan thought to be a primitive stegosaur, but that is not the case, being closer related to Stegosaurus from the Morrison Formation. Discovered in 1909, described in 1915, it was a victim of WWII, with a lot of skeletons being destroyed.")
						.addNext("Kentrosaurus was 4.6 meters from nose to tail, around the size of a large tigon. It would've been a grazer much like its North American cousin, Stegosaurus."))
				.addPages(new TextPageBuilder("kentrosaurus_info")
						.addFirst("Danger: Timid")
						.addNext("Diet: Herbivore")
						.addNext("Range: Jurassic - 152 mya")
						.addNext("Clade: Dinosauria")
						.addNext("Order: Ornithischia")
						.addNext("Suborder: Stegosauria")
						.addNext("Family: Stegosauridae")
						.addNext("Genus: Kentrosaurus"))
				/* Liaoningosaurus */
				.addPages(new TextPageBuilder("liaoningosaurus").addTitle("Liaoningosaurus paradoxus")
						.addFirst("Liaoningosaurus, a small ankyolosaur from the Cretaceous. This small ankyolosaur is from the Yixian Formation in China. It wouldn't fear too much other than the larger carnivore that could break through it's strong back.")
						.addNext("The only studied Liaoningosaurus fossil was 34 centimeters, but proven to only be 1 year old. It would've lived a standard lifestyle, grazing on small plants"))
				.addPages(new TextPageBuilder("liaoningosaurus_info")
						.addFirst("Danger: None")
						.addNext("Diet: Herbivore")
						.addNext("Range: Cretaceous - 122 mya")
						.addNext("Clade: Dinosauria")
						.addNext("Order: Ornithischia")
						.addNext("Suborder: Ankylosauria")
						.addNext("Clade: Euankylosauria")
						.addNext("Family: Ankylosauridae")
						.addNext("Genus: Liaoningosaurus"))
				/* Ostromia */
				.addPages(new TextPageBuilder("ostromia").addTitle("Ostromia crassipes")
						.addFirst("Ostromia, a small anchiornithid from the Painten Formation of German. This dinosaur has a long history of identification. Discovered in 1855, it was orginally thought to have been a pterosaur, labeled Pterodactylus crassipes. In 1970, John Ostrom reexamined the bones and labled it as an Archaeopteryx. In 2017, it was identified much more like Anchiornis and was given the name Ostromia after Ostrom.")
						.addNext("Ostromia only has fragmentary remains and size cannot be determined."))
				.addPages(new TextPageBuilder("ostromia_info")
						.addFirst("Danger: None")
						.addNext("Diet: Carnivore")
						.addNext("Range: Jurassic - 150–145 mya")
						.addNext("Clade: Dinosauria")
						.addNext("Clade: Saurischia")
						.addNext("Clade: Theropoda")
						.addNext("Family: Anchiornithidae")
						.addNext("Genus: Ostromia"))
				/* Ophthalmosaurus */
				.addPages(new TextPageBuilder("ophthalmosaurus").addTitle("Ophthalmosaurus icenicus")
						.addFirst("Ophthalmosaurus, an ichthyosaur from the Jurassic, with fossils potentially from the Cretaceous. Ophthalmosaurus had famously large eyes, hence its name, and has been found in Eroupe and North America."))
				.addPages(new TextPageBuilder("ophthalmosaurus_info")
						.addFirst("Danger: None")
						.addNext("Diet: Piscivore")
						.addNext("Range: Jurassic - 165–157 mya")
						.addNext("Order: Ichthyosauria")
						.addNext("Family: Ophthalmosauridae")
						.addNext("Subfamily: Ophthalmosaurinae")
						.addNext("Genus: Ophthalmosaurus"))
				/* Protosuchus */
				.addPages(new TextPageBuilder("protosuchus_1").addTitle("Protosuchus richardsoni")
						.addFirst("Protosuchus, a crocodylomorph from Arazona, Nova Scotia, and South Africa. It was one meter long and weighed 40 kilograms."))
				.addPages(new TextPageBuilder("protosuchus_info")
						.addFirst("Danger: Low")
						.addNext("Diet: Carnivore")
						.addNext("Range: Jurassic")
						.addNext("Clade: Pseudosuchia")
						.addNext("Superorder: Crocodylomorpha")
						.addNext("Family: Protosuchidae")
						.addNext("Genus: Palaeoniscum")))
			...
			.addSections(new SectionBuilder("permian", DinoTypes.GORGONOPS.getSkeletonPick().get())
				...
				/* Dimetrodon */
				.addPages(new TextPageBuilder("dimetrodon_1").addTitle("Dimetrodon limbatus")
						.addFirst("Dimetrodon, a large synapsid from the United States. A large, apex predator of the Early Permian. Filling many niches as it grew, in adulthood, it would've eaten most things it could find, especially Edaphosaurus. It was described in the 1870s. Though often lumped in with dinosaurs, it was neither a dinosaur or a reptile, more closely related to us than any dinosaur.")
						.addNext("Dimetrodon was 4 meters from nose to tail. Eating anything that it could catch."))
				.addPages(new TextPageBuilder("dimetrodon_info")
						.addFirst("Danger: Timid")
						.addNext("Diet: Carnivore")
						.addNext("Range: Permian - 295-272 mya")
						.addNext("Clade: Synapsida")
						.addNext("Family: Sphenacodontidae")
						.addNext("Subfamily: Sphenacodontinae")
						.addNext("Genus: Dimetrodon"))
				/* Edaphosaurus */
				.addPages(new TextPageBuilder("edaphosaurus_1").addTitle("Edaphosaurus pogonias")
						.addFirst("Edaphosaurus, a medium synapsid from the North America and Europe. A medium herbivore, Edaphosaurus was discovered in described in 1912 and descrbed in 1931. Edaphosaurus was increably sucsessful, living from the mid Carboniferous to mid Permian.")
						.addNext("Edaphosaurus was about 3 meters from nose to tail. Eating small plants and shrubs, has many species, varying in size and length."))
				.addPages(new TextPageBuilder("edaphosaurus_info")
						.addFirst("Danger: Small")
						.addNext("Diet: Herbivore")
						.addNext("Range: Carboniferous - Permian - 303.4-272.5 mya")
						.addNext("Clade: Synapsida")
						.addNext("Clade: Sphenacomorpha")
						.addNext("Family: Edaphosauridae")
						.addNext("Genus: Edaphosaurus"))
				/* Gorgonops */
				.addPages(new TextPageBuilder("gorgonops_1").addTitle("Gorgonops torvus")
						.addFirst("Gorgonops, a small gorgonopsid from the Permian South Africa. This average gorgonopsid had little predators other than larger gorgonopsids that shared it's habitat and starvation. First discovered in 1876 and described in 1890. The first ever species of Gorgonops, Gorgonops torvus, was from an skull found in Fort Beaufort, South Africa.")
						.addNext("Gorgonops was 2 meters from nose to tail. It shared it's enviroment with a few other gorgonopsids, eating "))
				.addPages(new TextPageBuilder("gorgonops_info")
						.addFirst("Danger: Medium")
						.addNext("Diet: Carnivore")
						.addNext("Range: Permian - 260-254 mya")
						.addNext("Clade: Synapsida")
						.addNext("Clade: Therapsida")
						.addNext("Clade: Gorgonopsia")
						.addNext("Family: Gorgonopsidae")
						.addNext("Subfamily: Gorgonopsinae")
						.addNext("Genus: Gorgonops"))
				/* Palaeoniscum */
				.addPages(new TextPageBuilder("palaeoniscum_1").addTitle("Palaeoniscum freieslebeni")
						.addFirst("Palaeoniscum, a ray-fined fish from Permian Europe and Greenland. It was 30 centimeters long, and was discovered in 1818."))
				.addPages(new TextPageBuilder("palaeoniscum_info")
						.addFirst("Danger: None")
						.addNext("Diet: Carnivore")
						.addNext("Range: Permian")
						.addNext("Class: Actinopterygii")
						.addNext("Order: Palaeonisciformes")
						.addNext("Family: Palaeoniscidae")
						.addNext("Genus: Palaeoniscum"))
				/* Rhinesuchus */
				.addPages(new TextPageBuilder("rhinesuchus_1").addTitle("Rhinesuchus whaitsi")
						.addFirst("Rhinesuchus, a amphibian from the Permian South Africa. It was named after the Greek word for nose, though it is oftan thought it's named after the Rhine River."))
				.addPages(new TextPageBuilder("rhinesuchus_info")
						.addFirst("Danger: Low")
						.addNext("Diet: Carnivore")
						.addNext("Range: Permian")
						.addNext("Class: Amphibia")
						.addNext("Order: Temnospondyli")
						.addNext("Suborder: Stereospondyli")
						.addNext("Family: Rhinesuchidae")
						.addNext("Genus: Rhinesuchus")))
			.addSections(new SectionBuilder("cambrian", DinoTypes.ANOMALOCARIS.getSkeletonPick().get())
				/* Anomalocaris */
				...
				.addPages(new TextPageBuilder("anomalocaris_info")
						.addFirst("Danger: Low")
						.addNext("Diet: Carnivore")
						.addNext("Range: Cambrian - 520-499 mya")
						.addNext("Class: Dinocaridida")
						.addNext("Order: Radiodonta")
						.addNext("Family: Anomalocarididae")
						.addNext("Genus: Anomalocaris"))));
		consumer.accept(new BookBuilder("lost_worlds_lexicon", "Lexicon", "By Willatendo", 3304264)
				.addSections(new SectionBuilder("introduction", LostWorldsItems.LEATHER_BRUSH.get())
					.addPages(new TextPageBuilder("introduction").addTitle("Welcome to The Lost Worlds!")
							.addFirst("A Minecraft dinosaur mod!")
							.addNext("This Lexicon will tell you everything you need to know about the mod, from creating creatures to exploring ancient time eras.")
							.addNext("The Lexicon is split into 4 major parts, with each provides information on a particular branch of the mod. They are organised in order of importance of information."))
					.addPages(new TextPageBuilder("note")
							.addFirst("This book and mod are still not done! To ensure the quality and make everything the best it can be, we are a bit slow and want to ensure that everything is as quality and perfect as possible.")))
				.addSections(new SectionBuilder("world", LostWorldsBlocks.JURASSIC_COBBLESTONE.get())
					.addPages(new TextPageBuilder("overview")
							.addFirst("In the world section of the Lexicon, we will explore the paleontological and archaeological aspects of the world.")
							.addNext("This chapter is split into three parts, paleontogy, archaeology, and other parts of the world. To the right, you'll find a table with quick links to each of the sections."))
					.addPages(new TextPageBuilder("archaeology").addTitle("Archaeology:")
							.addFirst("IMPORTANT: ARCHAEOLOGY IS NOT DONE. COME BACK IN A FUTURE UPDATE FOR A COMPLETE GUIDE.")
							.addNext("Archaeology is one of the many braches you can explore in the mod. Archaeology includes a wide range of things to do. Exploring, you will likely find many new things, from structures to the ruins of ancient civilizations.")
							.addNext("Archaeology connects with the Time Traveling part of the mod."))
					.addPages(new TextPageBuilder("crystal_scarab_gems").addTitle("Crystal Scarab Gems:")
							.addFirst("One of the additions for Archaeology portion of the mod is the Crystal Scarab Gem. A powerful relic of lost empires, the crystal scarab gem has the power of many, many tonnes of tnt.")
							.addNext("They can be found in Fossil Poacher's homes, the black market. They can also be found in Bastion Reminent's tressure room. However, they will need to be reassembled as the years of being stolen and traded. They are found in six parts, four for their legs, one for the thorax, and one for the head."))
					.addPages(new ArchaeologyPageBuilder("crystal_scarab_gem", "crystal_scarab_gem"))
					.addPages(new TextPageBuilder("charge_crystal_scarab_gem").addTitle("Charged Crystal Scarab Gems:")
							.addFirst("In order to harness the full power of the gem, you'll need to strike it with lightning. A trident may be essental for creating one. This charges with gem with all the power it will need. According to the legends, anyway.")
							.addNext("Then, after getting the full power of the gem, you can then use it to create the most powerful tools. The tools, according to legends, cannot be reparied in anyway. However, they have the ability to take out mountains. They are all capable of instant-mine of any of their blocks.")))
				.addSections(new SectionBuilder("creature_creation", LostWorldsBlocks.CULTIVATOR.get())
					.addPages(new TextPageBuilder("where_to_start").addTitle("Creature Creation: Where to Start")
							.addFirst("Where do you start when creating a creature? Well, the best place to start is exploring the world for fossils. They can be found everywhere around the world and will provide the DNA samples we need to create a extinct creature. Additionally, amber is another way get dinosaur DNA. Amber spawns like diamonds, while fossils can spawn under and above ground.")
							.addNext("Before you head out, you'll need a few tools."))
					.addPages(new TextPageBuilder("paleontology_101").addTitle("Creature Creation: Paleontology")
							.addFirst("When attempting to collect fossils, you'll need some different tools. For the fossils we want, we'll need a hammer. They can be aquired from a Black Market. Then, to collect the fossil and safely transport it, we'll need some wet paper.")
							.addNext("Carefully, break the soft stone without fossil. You'll tell they are if they don't have a dark patch. You'll want to seperate the peaces with fossils to avoid the potental of them breaking others if they fall. Also, don't stand on them either."))
					.addPages(new TextPageBuilder("paleontology_102").addTitle("Creature Creation: Paleontology")
							.addFirst("Left click with wet paper on a fossil after breaking it out of the stone to plaster it. It will pop off and we are ready for the next stage."))
					.addPages(new RecipePageBuilder("wet_paper_recipe", "wet_paper"))
					.addPages(new TextPageBuilder("first_machines").addTitle("Creature Creation: First Machines")
							.addFirst("Depending on whether or not what you've got is amber or fossils, where you'll want to begin will differ.")
							.addNext("For obvious reasons, we'll start with fossils.")
							.addNext("To start, you'll need to make a fossil cleaner. They are fairly cheap, but maybe a bit expensive for new players."))
					.addPages(new RecipePageBuilder("fossil_cleaner_recipe", "fossil_cleaner").addTitle("Fossil Cleaner"))
					.addPages(new TextPageBuilder("fossil_cleaner").addTitle("Creature Creation: Fossil Cleaner")
							.addFirst("Your fossil cleaner will require water to function. One water bucket will clean 3.5 fossils and water bottles will clean 0.1 fossils.")
							.addNext("The fossil cleaner, like all machines, it will also require a redstone input. Redstone torches, redstone, blocks, and other power sources are recomended. However, of course, you'll also need a water source. Either a bucket or water bottle.")
							.addNext("Players may find the fossil cleaner a cheeper machine."))
					.addPages(new RecipePageBuilder("fossil_grinder_recipe", "fossil_grinder").addTitle("Fossil Grinder"))
					.addPages(new TextPageBuilder("fossil_grinder").addTitle("Creature Creation: Fossil Grinder")
							.addFirst("The next stage is the fossil grinder. This is where most of your fossils will be wasted as it's very rare to find soft tissues. However, the waste can be used as bonemeal.")
							.addNext("The fossil grinder just requires a redstone input. Once you have soft tissue, it's onto the next step.")
							.addNext("Once again, new players may find the fossil grinder expensive as it requires a diamond, however it should be easy enough."))
					.addPages(new RecipePageBuilder("dna_extractor_recipe", "dna_extractor").addTitle("DNA Extractor"))
					.addPages(new TextPageBuilder("dna_extractor").addTitle("Creature Creation: DNA Extractor")
							.addFirst("Half-way though, we find the DNA Extractor. In the input slots, place a vile and the previously acquired soft tissue. Then, you'll get DNA.")
							.addNext("The dna extractor requires a redstone input and a vile. Once you have dna, it's onto the fourth step.")
							.addNext("The DNA Extractor is the cheapest of the machines and should be easily aquired."))
					.addPages(new RecipePageBuilder("analyzer_recipe", "analyzer").addTitle("Analyzer"))
					.addPages(new TextPageBuilder("analyzer").addTitle("Creature Creation: Analyzer")
							.addFirst("The penultimate stage is the analyzer. It will take a while, but the analyzer will copy all the dna onto a provided disc that will have 5 uses.")
							.addNext("The analyser requires a redstone input and a disc. Once you have a dna disc, it's onto the last step.")
							.addNext("Players may find the analyzer a cheeper machine."))
					.addPages(new RecipePageBuilder("dna_injector_recipe", "dna_injector").addTitle("DNA Injector"))
					.addPages(new TextPageBuilder("dna_injector").addTitle("Creature Creation: DNA Injector")
							.addFirst("The last stage is the DNA injector. This will inject the genetic code of a dinosaur into a chicken egg. This is the last step, not counting hatching.")
							.addNext("The dna injector requires a redstone input and a chicken egg.")
							.addNext("The DNA Injector is a fiarly cheap machines and should be easily made."))
					.addPages(new TextPageBuilder("hatching_eggs").addTitle("Creature Creation: Hatching Eggs")
							.addFirst("The longest process is hatching an egg. It will take arround three days to hatch, like a turtle egg. Although it may take longer. All the while, the eggs are highly venerable to zombie attacks. It is imparative that you keep them safe.")
							.addNext("Deepending on the creature, they may stack differently. Large eggs stack to 3, medium 6, small 10, and tiny 19.")
							.addNext("They need to be placed on a nesting block."))
					.addPages(new TextPageBuilder("nesting_block").addTitle("Nesting Block")
							.addFirst("A block to keep your eggs in perfect state while they hatch. Infact, they won't hatch without one!"))
					.addPages(new RecipePageBuilder("nesting_block_recipe", "nesting_block").addTitle("Nesting Block"))
					.addPages(new PictureAndDescriptionPageBuilder("nest_example", "lostworlds:textures/gui/book/mountains_nest.png", 180, 87)
							.addFirst("A example of Kentrosaurus Eggs in a mountain biome. Depending on your config, they take on the biome colour unless choosen else."))
					.addPages(new TextPageBuilder("but_what_about_plants").addTitle("But What About Plants?")
							.addFirst("Don't worry, they're almost exactly the same! Of course, instead of dinosaur fossils, you use bark (can be collected from petrified wood via stripping it) and plant fossils. However, you'll skip the fossil cleaner stage and the dna injector one.")
							.addNext("Instead, you'll place it in the last machine, the cultivator. It will grow the DNA into either a sapling or seed! Of course, it just need a redstone signal."))
					.addPages(new RecipePageBuilder("cultivator_recipe", "cultivator").addTitle("Cultivator Recipe")))
				.addSections(new SectionBuilder("creature_care", Items.WHEAT))
				.addSections(new SectionBuilder("time_traveling", LostWorldsItems.JURASSIC_PERIOD_TIME_BOOK.get())));
	}
}

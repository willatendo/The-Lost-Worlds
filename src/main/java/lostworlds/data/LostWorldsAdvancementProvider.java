...
public class LostWorldsAdvancementProvider extends AdvancementProvider {
	...
	protected void registerAdvancements(Consumer<Advancement> consumer, ExistingFileHelper fileHelper) {
		...
		Advancement basicExplorer = this.addAdvancement(consumer, fileHelper, root, LostWorldsBlocks.CONIFER.getBlock(WoodTypes.LOG).get().get(), "basic_explorer", FrameType.GOAL, true, true, false, this.biomeCriteria(LostWorldsBiomeKeys.ARAUCARIA_FOREST), this.biomeCriteria(LostWorldsBiomeKeys.CONIFER_FOREST), this.biomeCriteria(LostWorldsBiomeKeys.GINKGO_FOREST), this.biomeCriteria(LostWorldsBiomeKeys.REDWOODS_FOREST), this.biomeCriteria(LostWorldsBiomeKeys.VOLCANO));
		...
		this.addAdvancement(consumer, fileHelper, theCretaceous, LostWorldsItems.CRETACEOUS_PERIOD_TIME_BOOK.get(), "cretaceous_explorer", FrameType.CHALLENGE, true, true, false, this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_ARAUCARIA_FOREST), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_CONIFER_FOREST), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_GINKGO_FOREST), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_GAME_TRAIL), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_MEDOW), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_PLAINS), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_FLOOD_BASALTS), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_ARCTIC), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_ARCTIC_SPIRES), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_FROZEN_FOREST), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_WINDSWEPT_HILLS), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_ERRODED_WINDSWEPT_HILLS), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_DESERT), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_RED_DESERT), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_MARSH), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_SWAMP), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_FEN), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_BOG), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_RIVER), this.biomeCriteria(LostWorldsBiomeKeys.COLD_CRETACEOUS_OCEAN), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_OCEAN), this.biomeCriteria(LostWorldsBiomeKeys.WARM_CRETACEOUS_OCEAN), this.biomeCriteria(LostWorldsBiomeKeys.CRETACEOUS_SHORE));
		...
		this.addAdvancement(consumer, fileHelper, theJurassic, LostWorldsItems.JURASSIC_PERIOD_TIME_BOOK.get(), "jurassic_explorer", FrameType.CHALLENGE, true, true, false, this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_ARAUCARIA_FOREST), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_CONIFER_FOREST), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_GINKGO_FOREST), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_REDWOODS_FOREST), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_PLAINS), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_WINDSWEPT_HILLS), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_ERRODED_WINDSWEPT_HILLS), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_VOLCANIC_RANGE), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_DESERT), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_MARSH), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_SWAMP), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_FEN), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_BOG), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_RIVER), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_OCEAN), this.biomeCriteria(LostWorldsBiomeKeys.WARM_JURASSIC_OCEAN), this.biomeCriteria(LostWorldsBiomeKeys.JURASSIC_SHORE));
		...
		this.addAdvancement(consumer, fileHelper, thePermian, LostWorldsItems.PERMIAN_PERIOD_TIME_BOOK.get(), "permian_explorer", FrameType.CHALLENGE, true, true, false, this.biomeCriteria(LostWorldsBiomeKeys.PERMIAN_CONIFER_FOREST), this.biomeCriteria(LostWorldsBiomeKeys.PERMIAN_GINKGO_FOREST), this.biomeCriteria(LostWorldsBiomeKeys.PERMIAN_PLAINS), this.biomeCriteria(LostWorldsBiomeKeys.PERMIAN_DRIED_PLAINS), this.biomeCriteria(LostWorldsBiomeKeys.PERMIAN_DESERT), this.biomeCriteria(LostWorldsBiomeKeys.PERMIAN_FLOOD_BASALTS), this.biomeCriteria(LostWorldsBiomeKeys.PERMIAN_ASHY_MEDOWS), this.biomeCriteria(LostWorldsBiomeKeys.PERMIAN_WINDSWEPT_HILLS), this.biomeCriteria(LostWorldsBiomeKeys.PERMIAN_MARSH), this.biomeCriteria(LostWorldsBiomeKeys.PERMIAN_RIVER), this.biomeCriteria(LostWorldsBiomeKeys.PERMIAN_OCEAN), this.biomeCriteria(LostWorldsBiomeKeys.WARM_PERMIAN_OCEAN), this.biomeCriteria(LostWorldsBiomeKeys.PERMIAN_SHORE), this.biomeCriteria(LostWorldsBiomeKeys.PERMIAN_DRIPSTONE_CAVES));
	}

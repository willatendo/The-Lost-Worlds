...
public class LostWorldsAdvancementProvider extends AdvancementProvider {
	...
	protected void registerAdvancements(Consumer<Advancement> consumer, ExistingFileHelper fileHelper) {
		...
		Advancement justARemnant = this.addAdvancement(consumer, fileHelper, root, LostWorldsBlocks.SOFT_STONE.get(), "just_a_remnant", FrameType.TASK, true, true, false, true, Pair.of(PositionTrigger.Instance.located(LocationPredicate.inFeature(LostWorldsStructures.SURFACE_FOSSIL)), "in_surface_fossil"), Pair.of(PositionTrigger.Instance.located(LocationPredicate.inFeature(LostWorldsStructures.SUBTERRANEAN_FOSSIL)), "in_subterranean_fossil"));
		Advancement justATrace = this.addAdvancement(consumer, fileHelper, fossils, DinoTypes.ALLOSAURUS.getSoftTissue().get(), "just_a_trace", FrameType.TASK, true, true, false, this.itemCriteria(LostWorldsTags.ModItemTags.SOFT_TISSUE));
		...
		Advancement dangerousRelic = this.addAdvancement(consumer, fileHelper, likeIndianaJones, LostWorldsItems.CRYSTAL_SCARAB_GEM.get(), "dangerous_relic", FrameType.TASK, true, true, false, this.itemCriteria(LostWorldsTags.ModItemTags.BROKEN_CRYSTAL_SCARAB_GEMS));
		...
		Advancement paleobotany = this.addAdvancement(consumer, fileHelper, fossils, Plants.ALETHOPTERIS.getDrop().get(), "paleobotany", FrameType.TASK, true, true, false, this.itemCriteria(LostWorldsTags.ModItemTags.PLANT_FOSSILS));
		Advancement petrifiedTrees = this.addAdvancement(consumer, fileHelper, fossils, LostWorldsBlocks.PETRIFIED_CONIFER_LOG.get(), "petrified_trees", FrameType.TASK, true, true, false, this.itemCriteria(LostWorldsTags.ModItemTags.PETRIFIED_LOGS));
		Advancement plantsAtLeastTheyDontKill = this.addAdvancement(consumer, fileHelper, paleobotany, Plants.ALETHOPTERIS.getSoftTissue().get(), "plants_at_least_they_dont_kill", FrameType.TASK, true, true, false, this.itemCriteria(LostWorldsTags.ModItemTags.PLANT_SOFT_TISSUE));
		this.addAdvancement(consumer, fileHelper, plantsAtLeastTheyDontKill, Plants.CYCAD.getSeed().get(), "ancient_seeds", FrameType.TASK, true, true, false, this.itemCriteria(LostWorldsTags.ModItemTags.ANCIENT_SEEDS));
		Advancement scratchingTrees = this.addAdvancement(consumer, fileHelper, petrifiedTrees, LostWorldsItems.CONIFER_BARK_SAMPLE.get(), "scratching_trees", FrameType.TASK, true, true, false, this.itemCriteria(LostWorldsTags.ModItemTags.BARK_SAMPLES));
		this.addAdvancement(consumer, fileHelper, scratchingTrees, LostWorldsBlocks.CONIFER_SAPLING.get(), "long_lost_trees", FrameType.TASK, true, true, false, this.itemCriteria(LostWorldsTags.ModItemTags.ANCIENT_SAPLINGS));
		Advancement theBrokenKTBoundry = this.addAdvancement(consumer, fileHelper, justATrace, DinoTypes.ALLOSAURUS.getDNA().get(), "the_broken_kt_boundry", FrameType.TASK, true, true, false, this.itemCriteria(LostWorldsTags.ModItemTags.DNA));
		Advancement digitalization = this.addAdvancement(consumer, fileHelper, theBrokenKTBoundry, DinoTypes.ALLOSAURUS.getDNADisc().get(), "digitalization", FrameType.TASK, true, true, false, this.itemCriteria(LostWorldsTags.ModItemTags.DNA_DISCS));
		this.addAdvancement(consumer, fileHelper, digitalization, DinoTypes.ALLOSAURUS.getEgg().get(), "dr_frankenstein", FrameType.CHALLENGE, true, true, false, this.itemCriteria(LostWorldsTags.ModItemTags.EGGS));
		...
		this.addAdvancement(consumer, fileHelper, theMuseum, Items.BONE, "for_the_masses", FrameType.TASK, true, true, false, this.itemCriteria(LostWorldsTags.ModItemTags.SKELETONS));
		Advancement theTimeTraveller = this.addAdvancement(consumer, fileHelper, basicExplorer, LostWorldsBlocks.TIME_MACHINE.get(), "the_time_traveller", FrameType.TASK, true, true, false, this.itemCriteria(LostWorldsTags.ModItemTags.TIME_BOOKS));
		...
		this.addAdvancement(consumer, fileHelper, root, LostWorldsBlocks.TIME_MACHINE.get(), "time_travelling", FrameType.TASK, true, true, false, this.itemCriteria(LostWorldsBlocks.TIME_MACHINE.get()));
	}

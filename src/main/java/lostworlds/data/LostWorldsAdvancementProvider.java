...
//		this.addAdvancement(consumer, fileHelper, basicExplorer, LostWorldsBlocks.TIME_MACHINE.get(), "the_time_traveller", FrameType.TASK, true, true, false, this.dimensionCriteria(LostWorldsDimensions.CRETACEOUS_WORLD), this.dimensionCriteria(LostWorldsDimensions.JURASSIC_WORLD), this.dimensionCriteria(LostWorldsDimensions.PERMIAN_WORLD));
		...
		this.addAdvancement(consumer, fileHelper, theJurassic, LostWorldsItems.JURASSIC_PERIOD_TIME_BOOK.get(), "jurassic_explorer", FrameType.CHALLENGE, true, true, false, this.biomeCriteria(LostWorldsBiomes.JURASSIC_ARAUCARIA_FOREST), this.biomeCriteria(LostWorldsBiomes.JURASSIC_CONIFER_FOREST), this.biomeCriteria(LostWorldsBiomes.JURASSIC_GINKGO_FOREST), this.biomeCriteria(LostWorldsBiomes.JURASSIC_REDWOODS_FOREST), this.biomeCriteria(LostWorldsBiomes.JURASSIC_PLAINS), this.biomeCriteria(LostWorldsBiomes.JURASSIC_WINDSWEPT_HILLS), this.biomeCriteria(LostWorldsBiomes.JURASSIC_ERRODED_WINDSWEPT_HILLS), this.biomeCriteria(LostWorldsBiomes.JURASSIC_VOLCANIC_RANGE), this.biomeCriteria(LostWorldsBiomes.JURASSIC_DESERT), this.biomeCriteria(LostWorldsBiomes.JURASSIC_MARSH), this.biomeCriteria(LostWorldsBiomes.JURASSIC_SWAMP), this.biomeCriteria(LostWorldsBiomes.JURASSIC_FEN), this.biomeCriteria(LostWorldsBiomes.JURASSIC_BOG), this.biomeCriteria(LostWorldsBiomes.JURASSIC_RIVER), this.biomeCriteria(LostWorldsBiomes.JURASSIC_OCEAN), this.biomeCriteria(LostWorldsBiomes.WARM_JURASSIC_OCEAN), this.biomeCriteria(LostWorldsBiomes.JURASSIC_SHORE));
		...
		this.addAdvancement(consumer, fileHelper, thePermian, LostWorldsItems.PERMIAN_PERIOD_TIME_BOOK.get(), "permian_explorer", FrameType.CHALLENGE, true, true, false, this.biomeCriteria(LostWorldsBiomes.PERMIAN_CONIFER_FOREST), this.biomeCriteria(LostWorldsBiomes.PERMIAN_GINKGO_FOREST), this.biomeCriteria(LostWorldsBiomes.PERMIAN_PLAINS), this.biomeCriteria(LostWorldsBiomes.PERMIAN_DRIED_PLAINS), this.biomeCriteria(LostWorldsBiomes.PERMIAN_DESERT), this.biomeCriteria(LostWorldsBiomes.PERMIAN_FLOOD_BASALTS), this.biomeCriteria(LostWorldsBiomes.PERMIAN_ASHY_MEDOWS), this.biomeCriteria(LostWorldsBiomes.PERMIAN_WINDSWEPT_HILLS), this.biomeCriteria(LostWorldsBiomes.PERMIAN_MARSH), this.biomeCriteria(LostWorldsBiomes.PERMIAN_RIVER), this.biomeCriteria(LostWorldsBiomes.PERMIAN_OCEAN), this.biomeCriteria(LostWorldsBiomes.WARM_PERMIAN_OCEAN), this.biomeCriteria(LostWorldsBiomes.PERMIAN_SHORE));
	}

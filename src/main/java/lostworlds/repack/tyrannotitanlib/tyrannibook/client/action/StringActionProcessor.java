package lostworlds.repack.tyrannotitanlib.tyrannibook.client.action;

import java.util.HashMap;

import javax.annotation.Nullable;

import lostworlds.repack.tyrannotitanlib.tyrannibook.client.action.protocol.ActionProtocol;

...
public static final ArrayList<ResourceLocation> locations = new ArrayList<>();
	...
	{
		locations.add(ModUtils.rL("fossil/trace_fossil_1"));
		locations.add(ModUtils.rL("fossil/trace_fossil_2"));
		locations.add(ModUtils.rL("fossil/trace_fossil_3"));
		locations.add(ModUtils.rL("fossil/trace_fossil_4"));
	...
	public static class Piece extends TemplateStructurePiece 
	{
		...
		{
			super(StructurePieceInit.TRACE_FOSSIL_PIECE, 0);
		...
		{
			super(StructurePieceInit.TRACE_FOSSIL_PIECE, nbt);

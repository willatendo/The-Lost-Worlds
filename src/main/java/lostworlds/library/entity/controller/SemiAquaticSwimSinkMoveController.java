...
public class SemiAquaticSwimSinkMoveController extends MovementController 
{
	...
	public SemiAquaticSwimSinkMoveController(CreatureEntity entity, float speedMulti, float ySpeedModifier) 
	{
        super(entity);
        this.entity = entity;
	...
	public SemiAquaticSwimSinkMoveController(CreatureEntity entity, float speedMulti, float ySpeedModifier, float yawLimit) 
	{
        super(entity);
        this.entity = entity;
        this.speedMulti = speedMulti;
		...
		if(this.operation == Action.MOVE_TO && !this.entity.getNavigation().isDone()) 
		{
			...
			else 
			{
				...
				if(this.entity.isInWater()) 
				{
					...
					{
						this.entity.setDeltaMovement(this.entity.getDeltaMovement().add(0.0D, (double) this.entity.getSpeed() * lvt_3_1_ * 0.6D * ySpeedModifier, 0.0D));
					}
					this.entity.setSpeed(lvt_10_1_ * 0.02F);
					float lvt_11_1_ = -((float) (MathHelper.atan2(lvt_3_1_,
							MathHelper.sqrt(lvt_1_1_ * lvt_1_1_ + lvt_5_1_ * lvt_5_1_)) * 57.2957763671875D));

...
public class SleepyLookAtGoal extends Goal 
{
	...
	public SleepyLookAtGoal(HerbivoreEntity entity, Class<? extends LivingEntity> lookAtEntity, float lookDistance) 
	{
		this(entity, lookAtEntity, lookDistance, 0.02F);
	}

	public SleepyLookAtGoal(HerbivoreEntity entity, Class<? extends LivingEntity> lookAtEntity, float lookDistance, float probability) 
	{
		this.entity = entity;

...
public class SleepyRandomWalkingGoal extends Goal 
{
	...
	public SleepyRandomWalkingGoal(HerbivoreEntity entity, double speedModifier) 
	{
		this(entity, speedModifier, 120);
	}

	public SleepyRandomWalkingGoal(HerbivoreEntity entity, double speedModifier, int interval) {
		this(entity, speedModifier, interval, true);
	}

	public SleepyRandomWalkingGoal(HerbivoreEntity entity, double speedModifier, int interval, boolean checkNoActionTime) 
	{
		this.entity = entity;

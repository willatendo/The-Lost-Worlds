...
public class SleepyTemptGoal extends Goal 
{
	...
	public SleepyTemptGoal(CarnivoreEntity entity, double speedModifier, Ingredient followIngredient, boolean canScare) 
	{
		this(entity, speedModifier, canScare, followIngredient);
	}

	public SleepyTemptGoal(CarnivoreEntity entity, double speedModifier, boolean canScare, Ingredient followIngredient) 
	{
		this.entity = entity;

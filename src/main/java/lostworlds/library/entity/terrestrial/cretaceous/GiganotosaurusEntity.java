...
public class GiganotosaurusEntity extends CarnivoreEntity
{
	...
	{
		return MonsterEntity.createMonsterAttributes().add(Attributes.MOVEMENT_SPEED, (double)0.35F).add(Attributes.MAX_HEALTH, LostWorldsConfig.COMMON_CONFIG.giganotosaurusHeath.get()).add(Attributes.ATTACK_DAMAGE, LostWorldsConfig.COMMON_CONFIG.giganotosaurusAttackDamage.get()).build();
	}
	...
	protected void registerGoals() 
	{
		...
		this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, TyrannosaurusEntity.class, false));
		this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, CarnotaurusEntity.class, false));
		this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, FukuivenatorEntity.class, false));
		this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, PsittacosaurusEntity.class, false));
		this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, ZephyrosaurusEntity.class, false));
	}
	...
	{
		return EntityInit.GIGANOTOSAURUS.create(world);
	}
}

...
public class GiganotosaurusEntity extends CarnivoreEntity implements IReasonableAngerable {
	...
	public static AttributeModifierMap createAttributes() {
		return MonsterEntity.createMonsterAttributes().add(Attributes.MOVEMENT_SPEED, (double) 0.35F).add(Attributes.MAX_HEALTH, LostWorldsConfig.SERVER_CONFIG.giganotosaurusHeath.get()).add(Attributes.ATTACK_DAMAGE, LostWorldsConfig.SERVER_CONFIG.giganotosaurusAttackDamage.get()).build();
	}

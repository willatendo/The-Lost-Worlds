...
public class CretaceousForestSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> 
{
	public CretaceousForestSurfaceBuilder(Codec<SurfaceBuilderConfig> codec) 
	{
		super(codec);
	}

...
public class ModConfiguredFeatures {
	// Plants
	public static final ConfiguredFeature<?, ?> ARCHAEFRUTUS_PATCH = register("archaefrutus_patch", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.ARCHAEFRUTUS.defaultBlockState()), new DoublePlantBlockPlacer())).tries(64).noProjection().build()).decorated(Features.Placements.ADD_32).decorated(Features.Placements.HEIGHTMAP_SQUARE).count(7));
	public static final ConfiguredFeature<?, ?> ALETHOPTERIS_PATCH = register("alethopteris_patch", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.ALETHOPTERIS.defaultBlockState()), new DoublePlantBlockPlacer())).tries(64).noProjection().build()).decorated(Features.Placements.ADD_32).decorated(Features.Placements.HEIGHTMAP_SQUARE).count(7));
	...
	public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> FROZEN_TREE = register("frozen_tree", FeatureInit.FROZEN_TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.CONIFER_LOG.defaultBlockState()), new SimpleBlockStateProvider(Blocks.SNOW_BLOCK.defaultBlockState()), new ConiferFoliagePlacer(FeatureSpread.of(2, 1), FeatureSpread.of(0, 2), FeatureSpread.of(1, 1)), new StraightTrunkPlacer(5, 2, 1), new TwoLayerFeature(2, 0, 2))).ignoreVines().build()));
	...
	public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> CYPRESS_TREE = register("cypress_tree", Feature.TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.CYPRESS_LOG.defaultBlockState()), new SimpleBlockStateProvider(BlockInit.CYPRESS_LEAVES.defaultBlockState()), new DarkOakFoliagePlacer(FeatureSpread.fixed(1), FeatureSpread.fixed(0)), new ForkyTrunkPlacer(6, 2, 1), new ThreeLayerFeature(1, 1, 0, 1, 2, OptionalInt.empty()))).maxWaterDepth(3).decorators(ImmutableList.of(TrunkVineTreeDecorator.INSTANCE, LeaveVineTreeDecorator.INSTANCE)).ignoreVines().build()));
	...
	public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> BABY_SEQUOIA_TREE = register("baby_sequoia_tree", Feature.TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.SEQUOIA_LOG.defaultBlockState()), new SimpleBlockStateProvider(BlockInit.SEQUOIA_LEAVES.defaultBlockState()), new ConiferFoliagePlacer(FeatureSpread.of(2, 1), FeatureSpread.of(0, 2), FeatureSpread.of(1, 1)), new StraightTrunkPlacer(10, 2, 4), new TwoLayerFeature(1, 1, 2))).build()));
	...
	public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> SEQUOIA_TREE = register("sequoia_tree", Feature.TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.SEQUOIA_LOG.defaultBlockState()), new SimpleBlockStateProvider(BlockInit.SEQUOIA_LEAVES.defaultBlockState()), new MegaPineFoliagePlacer(FeatureSpread.fixed(0), FeatureSpread.fixed(0), FeatureSpread.of(13, 4)), new GiantTrunkPlacer(32, 2, 14), new TwoLayerFeature(1, 1, 2))).build()));
	...
	public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> ARAUCARIA_TREE = register("araucaria_tree", Feature.TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.ARAUCARIA_LOG.defaultBlockState()), new SimpleBlockStateProvider(BlockInit.ARAUCARIA_LEAVES.defaultBlockState()), new ConiferFoliagePlacer(FeatureSpread.of(2, 1), FeatureSpread.of(0, 2), FeatureSpread.of(1, 1)), new StraightTrunkPlacer(5, 2, 1), new TwoLayerFeature(2, 0, 2))).ignoreVines().build()));
	...
	// Ores
	public static final ConfiguredFeature<?, ?> SILT_PATCH = register("silt_patch", Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockInit.SILT.defaultBlockState(), LostWorldsConfig.SERVER_CONFIG.siltVeinSize.get())).range(LostWorldsConfig.SERVER_CONFIG.siltRange.get()).squared().count(LostWorldsConfig.SERVER_CONFIG.siltCountPerChunk.get()));
	...
	public static final ConfiguredFeature<?, ?> PERMIAN_COPPER_ORE = register("permian_copper_ore", Feature.ORE.configured(new OreFeatureConfig(ModBlockFillerTypes.PERMIAN_STONE, BlockInit.PERMIAN_COPPER_ORE.defaultBlockState(), TyrannotitanConfig.SERVER_CONFIG.copperVeinSize.get())).range(TyrannotitanConfig.SERVER_CONFIG.copperRange.get()).squared().count(TyrannotitanConfig.SERVER_CONFIG.copperCountPerChunk.get()));
	...
	public static final ConfiguredFeature<?, ?> JURASSIC_COPPER_ORE = register("jurassic_copper_ore", Feature.ORE.configured(new OreFeatureConfig(ModBlockFillerTypes.JURASSIC_STONE, BlockInit.JURASSIC_COPPER_ORE.defaultBlockState(), TyrannotitanConfig.SERVER_CONFIG.copperVeinSize.get())).range(TyrannotitanConfig.SERVER_CONFIG.copperRange.get()).squared().count(TyrannotitanConfig.SERVER_CONFIG.copperCountPerChunk.get()));
	...
	// Rocks
	public static final ConfiguredFeature<?, ?> PERMIAN_ROCK = register("permian_rock", FeatureInit.ROCK.configured(new BlockStateFeatureConfig(BlockInit.PERMIAN_COBBLESTONE.defaultBlockState())).decorated(Features.Placements.HEIGHTMAP_SQUARE).countRandom(1));
	public static final ConfiguredFeature<?, ?> JURASSIC_ROCK = register("jurassic_rock", FeatureInit.ROCK.configured(new BlockStateFeatureConfig(BlockInit.JURASSIC_COBBLESTONE.defaultBlockState())).decorated(Features.Placements.HEIGHTMAP_SQUARE).countRandom(1));
	public static final ConfiguredFeature<?, ?> CRETACEOUS_ROCK = register("cretaceous_rock", FeatureInit.ROCK.configured(new BlockStateFeatureConfig(Blocks.COBBLESTONE.defaultBlockState())).decorated(Features.Placements.HEIGHTMAP_SQUARE).countRandom(1));
	...
	// Fossils
	public static final ConfiguredFeature<?, ?> OVERWORLD_AMBER_ORE = register("overworld_amber_ore", Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockInit.AMBER_ORE.defaultBlockState(), LostWorldsConfig.SERVER_CONFIG.amberVeinSize.get())).range(LostWorldsConfig.SERVER_CONFIG.amberRange.get()).squared().count(LostWorldsConfig.SERVER_CONFIG.amberCountPerChunk.get()));
	...
	static class ModBlockClusterFeatureConfig {
		...
		public static final BlockClusterFeatureConfig CYCAD_CONFIG = (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.CYCAD.defaultBlockState()), SimpleBlockPlacer.INSTANCE)).tries(16).build();
		public static final BlockClusterFeatureConfig DICKSONIA_CONFIG = (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.DICKSONIA.defaultBlockState()), SimpleBlockPlacer.INSTANCE)).tries(16).build();
		...
		public static final BlockClusterFeatureConfig OSMUNDA_CONFIG = (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.OSMUNDA.defaultBlockState()), SimpleBlockPlacer.INSTANCE)).tries(16).build();

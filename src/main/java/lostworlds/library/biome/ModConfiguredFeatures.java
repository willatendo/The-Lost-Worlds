...
public class ModConfiguredFeatures 
{
	...
	public static final ConfiguredFeature<?, ?> GINKGO_STICKS = register("ginkgo_sticks", Feature.RANDOM_PATCH.configured(ModBlockClusterFeatureConfig.GINKGO_STICKS).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE));

...
public class ModConfiguredFeatures 
{
	...
	//Fossils
	public static final ConfiguredFeature<?, ?> OVERWORLD_AMBER_ORE = register("overworld_amber_ore", Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockInit.AMBER_ORE.defaultBlockState(), LostWorldsConfig.COMMON_CONFIG.amberVeinSize.get())).range(LostWorldsConfig.COMMON_CONFIG.amberRange.get()).squared().count(LostWorldsConfig.COMMON_CONFIG.amberCountPerChunk.get()));

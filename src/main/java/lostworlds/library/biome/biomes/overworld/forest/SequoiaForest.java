...
public class SequoiaForest extends SimpleBiome
{
	...
	{
		return ModBiomeMaker.create(RainType.RAIN, Category.FOREST, 0.1F, 0.2F, 0.4F, 0.8F, 4159204, 329011, 12638463, calculateSkyColor(0.4F), MOB_SPAWNS.build(), GENERATION.build());
	}
	
	public static Biome create(float depth, float scale)
	{
		return ModBiomeMaker.create(RainType.RAIN, Category.FOREST, depth, scale, 0.4F, 0.8F, 4159204, 329011, 12638463, calculateSkyColor(0.4F), MOB_SPAWNS.build(), GENERATION.build());
	}
}

package lostworlds.library.biome.biomes.cretaceous.river;
...
public class CretaceousRiver extends TyrannoBiome
{
	...
	static
	{
		GENERATION.surfaceBuilder(ModSurfaceBuilders.CRETACEOUS_SHORE_BUILDER);
	...
	{
		super(BaseBiomes.biome(RainType.RAIN, Category.FOREST, -0.5F, 0.0F, 0.8F, 0.7F, AMBIENCE.build(), GENERATION.build(), MOB_SPAWNS.build()));
	}
}

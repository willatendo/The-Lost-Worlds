...
public class PaleontologyTableResultSlot extends Slot 
{
	...
	public ItemStack onTake(PlayerEntity player, ItemStack stack) 
	{
		...
		NonNullList<ItemStack> nonnulllist = player.level.getRecipeManager().getRemainingItemsFor(RecipeInit.PALEONTOLOGY_TABLE_RECIPE, this.craftSlots, player.level);

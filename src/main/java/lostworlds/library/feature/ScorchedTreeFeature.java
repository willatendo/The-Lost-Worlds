...
public class ScorchedTreeFeature extends Feature<BaseTreeFeatureConfig> 
{
	public ScorchedTreeFeature(Codec<BaseTreeFeatureConfig> config) 
	{
		super(config);
	}
	...
	private static boolean isValidPlacement(IWorldGenerationBaseReader reader, BlockPos pos) 
	{
		return reader.isStateAtPosition(pos, (blockstate) -> 
		{
			...
			return block == BlockInit.VOLCANIC_ASH;
		});
	}

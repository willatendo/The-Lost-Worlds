...
public class TinyPlasteredFossilizedEggBlock extends Block 
{
	...
	public TinyPlasteredFossilizedEggBlock(AbstractBlock.Properties properties) 
	{
		super(properties);
	...
	public ActionResultType use(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult result) 
	{
		...
		{
			world.setBlockAndUpdate(pos, BlockInit.TINY_FOSSILISED_EGG.defaultBlockState().setValue(EGGS, state.getValue(EGGS)));

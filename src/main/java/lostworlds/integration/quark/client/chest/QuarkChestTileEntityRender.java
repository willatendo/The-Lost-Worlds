...
import lostworlds.integration.quark.block.IChestBlock;
...
public class QuarkChestTileEntityRender<T extends TileEntity & IChestLid> extends TileEntityRenderer<T> 
{
	...
	public QuarkChestTileEntityRender(TileEntityRendererDispatcher rendererDispatcherIn) 
	{
